    ...
    <Swiper
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-1 w-full">
            <div class="text-center">
                <p class="text-xl sm:text-3xl text-white text-shadow-md">筆記</p>
        ...
        <!-- 個人資訊區塊 -->
        <div class="hidden md:block absolute bottom-0 z-10">
            <div class="flex items-center m-5">
                ...
                <div class="pl-4">
                    <h3 class="text-white text-2xl text-shadow-lg text-nowrap">Jack Huang</h3>
                    <ul class="mt-1">
                        <li class="mt-1">
                            <router-link
                                to="/about"
                                class="group relative overflow-hidden btn-fill-slide block text-sm bg-white text-center py-1 px-8 hover:text-white z-10">關於我
                            </router-link>
                        </li>
                        <li class="mt-1">
                            <router-link
                                to="/project"
                                class="group relative overflow-hidden btn-fill-slide block text-sm bg-white text-center py-1 px-8 hover:text-white z-10">作品集
                            </router-link>
                        </li>
                    </ul>
                </div>

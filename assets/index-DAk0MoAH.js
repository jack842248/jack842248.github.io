const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BlogPostViews-hLkMeV3U.js","assets/BlogPostViews-CSRUKxnt.css"])))=>i.map(i=>d[i]);
...
\`\`\`
\`當以上值都沒有就跑default\``,__vite_glob_0_4=Object.freeze(Object.defineProperty({__proto__:null,default:_20210202____if_else_switch},Symbol.toStringTag,{value:"Module"})),_20210203Javascript____DOM____=`---
title: Javascript原生抓取DOM元素方法
date: 2021-02-03
tags: ["javaScript"]
---
### 取得DOM元素方法
...
apple.textContent = "蘋果"; //<div id="apple">蘋果</div>
\`\`\`
或是寫\`document.querySelector('#apple');\`
...
console.log(typeof(apple)); //NodeList(類陣列物件)

apple[0].textContent = "蘋果"; //<div name="apple">蘋果</div>
\`\`\`
或是寫\`document.querySelector('[name="apple"]');\`
...
console.log(typeof(btn)); //HTMLCollection(即時更新的類陣列)

btn[0].textContent = "蘋果"; //<button type="button">蘋果</button>
\`\`\`
或是寫\`document.querySelectorAll('button');\`
...
\`\`\``,__vite_glob_0_5=Object.freeze(Object.defineProperty({__proto__:null,default:_20210203Javascript____DOM____},Symbol.toStringTag,{value:"Module"})),_20210204___DOM__=`---
title: 【JS】改變DOM元素
date: 2021-02-04
tags: ["javaScript"]
---

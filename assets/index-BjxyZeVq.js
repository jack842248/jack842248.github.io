...
`],...formatTraceEntry(f))}),a}function formatTraceEntry({vnode:e,recurseCount:a}){const f=a>0?`... (${a} recursive calls)`:"",_=e.component?e.component.parent==null:!1,x=` at <${formatComponentName(e.component,e.type,_)}`,w=">"+f;return e.props?[x,...formatProps(e.props),w]:[x+w]}function formatProps(e){const a=[],f=Object.keys(e);return f.slice(0,3).forEach(_=>{a.push(...formatProp(_,e[_]))}),f.length>3&&a.push(" ..."),a}function formatProp(e,a,f){return isString(a)?(a=JSON.stringify(a),f?a:[`${e}=${a}`]):typeof a=="number"||typeof a=="boolean"||a==null?f?a:[`${e}=${a}`]:isRef(a)?(a=formatProp(e,toRaw(a.value),!0),f?a:[`${e}=Ref<`,a,">"]):isFunction(a)?[`${e}=fn${a.name?`<${a.name}>`:""}`]:(a=toRaw(a),f?a:[`${e}=`,a])}function callWithErrorHandling(e,a,f,_){try{return _?e(..._):e()}catch(x){handleError(x,a,f)}}function callWithAsyncErrorHandling(e,a,f,_){if(isFunction(e)){const x=callWithErrorHandling(e,a,f,_);return x&&isPromise(x)&&x.catch(w=>{handleError(w,a,f)}),x}if(isArray$1(e)){const x=[];for(let w=0;w<e.length;w++)x.push(callWithAsyncErrorHandling(e[w],a,f,_));return x}}function handleError(e,a,f,_=!0){const x=a?a.vnode:null,{errorHandler:w,throwUnhandledErrorInProduction:C}=a&&a.appContext.config||EMPTY_OBJ;if(a){let P=a.parent;const E=a.proxy,D=`https://vuejs.org/error-reference/#runtime-${f}`;for(;P;){const B=P.ec;if(B){for(let z=0;z<B.length;z++)if(B[z](e,E,D)===!1)return}P=P.parent}if(w){pauseTracking(),callWithErrorHandling(w,null,10,[e,E,D]),resetTracking();return}}logError(e,f,x,_,C)}function logError(e,a,f,_=!0,x=!1){if(x)throw e;console.error(e)}const queue=[];let flushIndex=-1;const pendingPostFlushCbs=[];let activePostFlushCbs=null,postFlushIndex=0;const resolvedPromise=Promise.resolve();let currentFlushPromise=null;function nextTick$1(e){const a=currentFlushPromise||resolvedPromise;return e?a.then(this?e.bind(this):e):a}function findInsertionIndex$1(e){let a=flushIndex+1,f=queue.length;for(;a<f;){const _=a+f>>>1,x=queue[_],w=getId(x);w<e||w===e&&x.flags&2?a=_+1:f=_}return a}function queueJob(e){if(!(e.flags&1)){const a=getId(e),f=queue[queue.length-1];!f||!(e.flags&2)&&a>=getId(f)?queue.push(e):queue.splice(findInsertionIndex$1(a),0,e),e.flags|=1,queueFlush()}}function queueFlush(){currentFlushPromise||(currentFlushPromise=resolvedPromise.then(flushJobs))}function queuePostFlushCb(e){isArray$1(e)?pendingPostFlushCbs.push(...e):activePostFlushCbs&&e.id===-1?activePostFlushCbs.splice(postFlushIndex+1,0,e):e.flags&1||(pendingPostFlushCbs.push(e),e.flags|=1),queueFlush()}function flushPreFlushCbs(e,a,f=flushIndex+1){for(;f<queue.length;f++){const _=queue[f];if(_&&_.flags&2){if(e&&_.id!==e.uid)continue;queue.splice(f,1),f--,_.flags&4&&(_.flags&=-2),_(),_.flags&4||(_.flags&=-2)}}}function flushPostFlushCbs(e){if(pendingPostFlushCbs.length){const a=[...new Set(pendingPostFlushCbs)].sort((f,_)=>getId(f)-getId(_));if(pendingPostFlushCbs.length=0,activePostFlushCbs){activePostFlushCbs.push(...a);return}for(activePostFlushCbs=a,postFlushIndex=0;postFlushIndex<activePostFlushCbs.length;postFlushIndex++){const f=activePostFlushCbs[postFlushIndex];f.flags&4&&(f.flags&=-2),f.flags&8||f(),f.flags&=-2}activePostFlushCbs=null,postFlushIndex=0}}const getId=e=>e.id==null?e.flags&2?-1:1/0:e.id;function flushJobs(e){try{for(flushIndex=0;flushIndex<queue.length;flushIndex++){const a=queue[flushIndex];a&&!(a.flags&8)&&(a.flags&4&&(a.flags&=-2),callWithErrorHandling(a,a.i,a.i?15:14),a.flags&4||(a.flags&=-2))}}finally{for(;flushIndex<queue.length;flushIndex++){const a=queue[flushIndex];a&&(a.flags&=-2)}flushIndex=-1,queue.length=0,flushPostFlushCbs(),currentFlushPromise=null,(queue.length||pendingPostFlushCbs.length)&&flushJobs()}}let currentRenderingInstance=null,currentScopeId=null;function setCurrentRenderingInstance(e){const a=currentRenderingInstance;return currentRenderingInstance=e,currentScopeId=e&&e.type.__scopeId||null,a}function withCtx(e,a=currentRenderingInstance,f){if(!a||e._n)return e;const _=(...x)=>{_._d&&setBlockTracking(-1);const w=setCurrentRenderingInstance(a);let C;try{C=e(...x)}finally{setCurrentRenderingInstance(w),_._d&&setBlockTracking(1)}return C};return _._n=!0,_._c=!0,_._d=!0,_}function invokeDirectiveHook(e,a,f,_){const x=e.dirs,w=a&&a.dirs;for(let C=0;C<x.length;C++){const P=x[C];w&&(P.oldValue=w[C].value);let E=P.dir[_];E&&(pauseTracking(),callWithAsyncErrorHandling(E,f,8,[e.el,P,e,a]),resetTracking())}}function provide(e,a){if(currentInstance){let f=currentInstance.provides;const _=currentInstance.parent&&currentInstance.parent.provides;_===f&&(f=currentInstance.provides=Object.create(_)),f[e]=a}}function inject(e,a,f=!1){const _=getCurrentInstance();if(_||currentApp){let x=currentApp?currentApp._context.provides:_?_.parent==null||_.ce?_.vnode.appContext&&_.vnode.appContext.provides:_.parent.provides:void 0;if(x&&e in x)return x[e];if(arguments.length>1)return f&&isFunction(a)?a.call(_&&_.proxy):a}}function hasInjectionContext(){return!!(getCurrentInstance()||currentApp)}const ssrContextKey=Symbol.for("v-scx"),useSSRContext=()=>inject(ssrContextKey);function watchEffect(e,a){return doWatch(e,null,a)}function watch(e,a,f){return doWatch(e,a,f)}function doWatch(e,a,f=EMPTY_OBJ){const{immediate:_,deep:x,flush:w,once:C}=f,P=extend$3({},f),E=a&&_||!a&&w!=="post";let D;if(isInSSRComponentSetup){if(w==="sync"){const Y=useSSRContext();D=Y.__watcherHandles||(Y.__watcherHandles=[])}else if(!E){const Y=()=>{};return Y.stop=NOOP,Y.resume=NOOP,Y.pause=NOOP,Y}}const B=currentInstance;P.call=(Y,X,tn)=>callWithAsyncErrorHandling(Y,B,X,tn);let z=!1;w==="post"?P.scheduler=Y=>{queuePostRenderEffect(Y,B&&B.suspense)}:w!=="sync"&&(z=!0,P.scheduler=(Y,X)=>{X?Y():queueJob(Y)}),P.augmentJob=Y=>{a&&(Y.flags|=4),z&&(Y.flags|=2,B&&(Y.id=B.uid,Y.i=B))};const J=watch$1(e,a,P);return isInSSRComponentSetup&&(D?D.push(J):E&&J()),J}function instanceWatch(e,a,f){const _=this.proxy,x=isString(e)?e.includes(".")?createPathGetter(_,e):()=>_[e]:e.bind(_,_);let w;isFunction(a)?w=a:(w=a.handler,f=a);const C=setCurrentInstance(this),P=doWatch(x,w.bind(_),f);return C(),P}function createPathGetter(e,a){const f=a.split(".");return()=>{let _=e;for(let x=0;x<f.length&&_;x++)_=_[f[x]];return _}}const TeleportEndKey=Symbol("_vte"),isTeleport=e=>e.__isTeleport,leaveCbKey=Symbol("_leaveCb"),enterCbKey=Symbol("_enterCb");function useTransitionState(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return onMounted(()=>{e.isMounted=!0}),onBeforeUnmount(()=>{e.isUnmounting=!0}),e}const TransitionHookValidator=[Function,Array],BaseTransitionPropsValidators={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:TransitionHookValidator,onEnter:TransitionHookValidator,onAfterEnter:TransitionHookValidator,onEnterCancelled:TransitionHookValidator,onBeforeLeave:TransitionHookValidator,onLeave:TransitionHookValidator,onAfterLeave:TransitionHookValidator,onLeaveCancelled:TransitionHookValidator,onBeforeAppear:TransitionHookValidator,onAppear:TransitionHookValidator,onAfterAppear:TransitionHookValidator,onAppearCancelled:TransitionHookValidator},recursiveGetSubtree=e=>{const a=e.subTree;return a.component?recursiveGetSubtree(a.component):a},BaseTransitionImpl={name:"BaseTransition",props:BaseTransitionPropsValidators,setup(e,{slots:a}){const f=getCurrentInstance(),_=useTransitionState();return()=>{const x=a.default&&getTransitionRawChildren(a.default(),!0);if(!x||!x.length)return;const w=findNonCommentChild(x),C=toRaw(e),{mode:P}=C;if(_.isLeaving)return emptyPlaceholder(w);const E=getInnerChild$1(w);if(!E)return emptyPlaceholder(w);let D=resolveTransitionHooks(E,C,_,f,z=>D=z);E.type!==Comment$1&&setTransitionHooks(E,D);let B=f.subTree&&getInnerChild$1(f.subTree);if(B&&B.type!==Comment$1&&!isSameVNodeType(B,E)&&recursiveGetSubtree(f).type!==Comment$1){let z=resolveTransitionHooks(B,C,_,f);if(setTransitionHooks(B,z),P==="out-in"&&E.type!==Comment$1)return _.isLeaving=!0,z.afterLeave=()=>{_.isLeaving=!1,f.job.flags&8||f.update(),delete z.afterLeave,B=void 0},emptyPlaceholder(w);P==="in-out"&&E.type!==Comment$1?z.delayLeave=(J,Y,X)=>{const tn=getLeavingNodesForType(_,B);tn[String(B.key)]=B,J[leaveCbKey]=()=>{Y(),J[leaveCbKey]=void 0,delete D.delayedLeave,B=void 0},D.delayedLeave=()=>{X(),delete D.delayedLeave,B=void 0}}:B=void 0}else B&&(B=void 0);return w}}};function findNonCommentChild(e){let a=e[0];if(e.length>1){for(const f of e)if(f.type!==Comment$1){a=f;break}}return a}const BaseTransition=BaseTransitionImpl;function getLeavingNodesForType(e,a){const{leavingVNodes:f}=e;let _=f.get(a.type);return _||(_=Object.create(null),f.set(a.type,_)),_}function resolveTransitionHooks(e,a,f,_,x){const{appear:w,mode:C,persisted:P=!1,onBeforeEnter:E,onEnter:D,onAfterEnter:B,onEnterCancelled:z,onBeforeLeave:J,onLeave:Y,onAfterLeave:X,onLeaveCancelled:tn,onBeforeAppear:pn,onAppear:un,onAfterAppear:rn,onAppearCancelled:cn}=a,gn=String(e.key),dn=getLeavingNodesForType(f,e),Mn=(wn,En)=>{wn&&callWithAsyncErrorHandling(wn,_,9,En)},Tn=(wn,En)=>{const An=En[1];Mn(wn,En),isArray$1(wn)?wn.every(Sn=>Sn.length<=1)&&An():wn.length<=1&&An()},ln={mode:C,persisted:P,beforeEnter(wn){let En=E;if(!f.isMounted)if(w)En=pn||E;else return;wn[leaveCbKey]&&wn[leaveCbKey](!0);const An=dn[gn];An&&isSameVNodeType(e,An)&&An.el[leaveCbKey]&&An.el[leaveCbKey](),Mn(En,[wn])},enter(wn){let En=D,An=B,Sn=z;if(!f.isMounted)if(w)En=un||D,An=rn||B,Sn=cn||z;else return;let Bn=!1;const Fn=wn[enterCbKey]=Un=>{Bn||(Bn=!0,Un?Mn(Sn,[wn]):Mn(An,[wn]),ln.delayedLeave&&ln.delayedLeave(),wn[enterCbKey]=void 0)};En?Tn(En,[wn,Fn]):Fn()},leave(wn,En){const An=String(e.key);if(wn[enterCbKey]&&wn[enterCbKey](!0),f.isUnmounting)return En();Mn(J,[wn]);let Sn=!1;const Bn=wn[leaveCbKey]=Fn=>{Sn||(Sn=!0,En(),Fn?Mn(tn,[wn]):Mn(X,[wn]),wn[leaveCbKey]=void 0,dn[An]===e&&delete dn[An])};dn[An]=e,Y?Tn(Y,[wn,Bn]):Bn()},clone(wn){const En=resolveTransitionHooks(wn,a,f,_,x);return x&&x(En),En}};return ln}function emptyPlaceholder(e){if(isKeepAlive(e))return e=cloneVNode(e),e.children=null,e}function getInnerChild$1(e){if(!isKeepAlive(e))return isTeleport(e.type)&&e.children?findNonCommentChild(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:a,children:f}=e;if(f){if(a&16)return f[0];if(a&32&&isFunction(f.default))return f.default()}}function setTransitionHooks(e,a){e.shapeFlag&6&&e.component?(e.transition=a,setTransitionHooks(e.component.subTree,a)):e.shapeFlag&128?(e.ssContent.transition=a.clone(e.ssContent),e.ssFallback.transition=a.clone(e.ssFallback)):e.transition=a}function getTransitionRawChildren(e,a=!1,f){let _=[],x=0;for(let w=0;w<e.length;w++){let C=e[w];const P=f==null?C.key:String(f)+String(C.key!=null?C.key:w);C.type===Fragment?(C.patchFlag&128&&x++,_=_.concat(getTransitionRawChildren(C.children,a,P))):(a||C.type!==Comment$1)&&_.push(P!=null?cloneVNode(C,{key:P}):C)}if(x>1)for(let w=0;w<_.length;w++)_[w].patchFlag=-2;return _}function defineComponent(e,a){return isFunction(e)?extend$3({name:e.name},a,{setup:e}):e}function useId(){const e=getCurrentInstance();return e?(e.appContext.config.idPrefix||"v")+"-"+e.ids[0]+e.ids[1]++:""}function markAsyncBoundary(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}const pendingSetRefMap=new WeakMap;function setRef(e,a,f,_,x=!1){if(isArray$1(e)){e.forEach((X,tn)=>setRef(X,a&&(isArray$1(a)?a[tn]:a),f,_,x));return}if(isAsyncWrapper(_)&&!x){_.shapeFlag&512&&_.type.__asyncResolved&&_.component.subTree.component&&setRef(e,a,f,_.component.subTree);return}const w=_.shapeFlag&4?getComponentPublicInstance(_.component):_.el,C=x?null:w,{i:P,r:E}=e,D=a&&a.r,B=P.refs===EMPTY_OBJ?P.refs={}:P.refs,z=P.setupState,J=toRaw(z),Y=z===EMPTY_OBJ?NO:X=>hasOwn(J,X);if(D!=null&&D!==E){if(invalidatePendingSetRef(a),isString(D))B[D]=null,Y(D)&&(z[D]=null);else if(isRef(D)){D.value=null;const X=a;X.k&&(B[X.k]=null)}}if(isFunction(E))callWithErrorHandling(E,P,12,[C,B]);else{const X=isString(E),tn=isRef(E);if(X||tn){const pn=()=>{if(e.f){const un=X?Y(E)?z[E]:B[E]:E.value;if(x)isArray$1(un)&&remove(un,w);else if(isArray$1(un))un.includes(w)||un.push(w);else if(X)B[E]=[w],Y(E)&&(z[E]=B[E]);else{const rn=[w];E.value=rn,e.k&&(B[e.k]=rn)}}else X?(B[E]=C,Y(E)&&(z[E]=C)):tn&&(E.value=C,e.k&&(B[e.k]=C))};if(C){const un=()=>{pn(),pendingSetRefMap.delete(e)};un.id=-1,pendingSetRefMap.set(e,un),queuePostRenderEffect(un,f)}else invalidatePendingSetRef(e),pn()}}}function invalidatePendingSetRef(e){const a=pendingSetRefMap.get(e);a&&(a.flags|=8,pendingSetRefMap.delete(e))}getGlobalThis().requestIdleCallback;getGlobalThis().cancelIdleCallback;const isAsyncWrapper=e=>!!e.type.__asyncLoader,isKeepAlive=e=>e.type.__isKeepAlive;function onActivated(e,a){registerKeepAliveHook(e,"a",a)}function onDeactivated(e,a){registerKeepAliveHook(e,"da",a)}function registerKeepAliveHook(e,a,f=currentInstance){const _=e.__wdc||(e.__wdc=()=>{let x=f;for(;x;){if(x.isDeactivated)return;x=x.parent}return e()});if(injectHook(a,_,f),f){let x=f.parent;for(;x&&x.parent;)isKeepAlive(x.parent.vnode)&&injectToKeepAliveRoot(_,a,f,x),x=x.parent}}function injectToKeepAliveRoot(e,a,f,_){const x=injectHook(a,e,_,!0);onUnmounted(()=>{remove(_[a],x)},f)}function injectHook(e,a,f=currentInstance,_=!1){if(f){const x=f[e]||(f[e]=[]),w=a.__weh||(a.__weh=(...C)=>{pauseTracking();const P=setCurrentInstance(f),E=callWithAsyncErrorHandling(a,f,e,C);return P(),resetTracking(),E});return _?x.unshift(w):x.push(w),w}}const createHook=e=>(a,f=currentInstance)=>{(!isInSSRComponentSetup||e==="sp")&&injectHook(e,(..._)=>a(..._),f)},onBeforeMount=createHook("bm"),onMounted=createHook("m"),onBeforeUpdate=createHook("bu"),onUpdated=createHook("u"),onBeforeUnmount=createHook("bum"),onUnmounted=createHook("um"),onServerPrefetch=createHook("sp"),onRenderTriggered=createHook("rtg"),onRenderTracked=createHook("rtc");function onErrorCaptured(e,a=currentInstance){injectHook("ec",e,a)}const COMPONENTS="components";function resolveComponent(e,a){return resolveAsset(COMPONENTS,e,!0,a)||e}const NULL_DYNAMIC_COMPONENT=Symbol.for("v-ndc");function resolveAsset(e,a,f=!0,_=!1){const x=currentRenderingInstance||currentInstance;if(x){const w=x.type;{const P=getComponentName(w,!1);if(P&&(P===a||P===camelize(a)||P===capitalize(camelize(a))))return w}const C=resolve(x[e]||w[e],a)||resolve(x.appContext[e],a);return!C&&_?w:C}}function resolve(e,a){return e&&(e[a]||e[camelize(a)]||e[capitalize(camelize(a))])}function renderList(e,a,f,_){let x;const w=f,C=isArray$1(e);if(C||isString(e)){const P=C&&isReactive(e);let E=!1,D=!1;P&&(E=!isShallow(e),D=isReadonly(e),e=shallowReadArray(e)),x=new Array(e.length);for(let B=0,z=e.length;B<z;B++)x[B]=a(E?D?toReadonly(toReactive(e[B])):toReactive(e[B]):e[B],B,void 0,w)}else if(typeof e=="number"){x=new Array(e);for(let P=0;P<e;P++)x[P]=a(P+1,P,void 0,w)}else if(isObject$3(e))if(e[Symbol.iterator])x=Array.from(e,(P,E)=>a(P,E,void 0,w));else{const P=Object.keys(e);x=new Array(P.length);for(let E=0,D=P.length;E<D;E++){const B=P[E];x[E]=a(e[B],B,E,w)}}else x=[];return x}const getPublicInstance=e=>e?isStatefulComponent(e)?getComponentPublicInstance(e):getPublicInstance(e.parent):null,publicPropertiesMap=extend$3(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>getPublicInstance(e.parent),$root:e=>getPublicInstance(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>resolveMergedOptions(e),$forceUpdate:e=>e.f||(e.f=()=>{queueJob(e.update)}),$nextTick:e=>e.n||(e.n=nextTick$1.bind(e.proxy)),$watch:e=>instanceWatch.bind(e)}),hasSetupBinding=(e,a)=>e!==EMPTY_OBJ&&!e.__isScriptSetup&&hasOwn(e,a),PublicInstanceProxyHandlers={get({_:e},a){if(a==="__v_skip")return!0;const{ctx:f,setupState:_,data:x,props:w,accessCache:C,type:P,appContext:E}=e;if(a[0]!=="$"){const J=C[a];if(J!==void 0)switch(J){case 1:return _[a];case 2:return x[a];case 4:return f[a];case 3:return w[a]}else{if(hasSetupBinding(_,a))return C[a]=1,_[a];if(x!==EMPTY_OBJ&&hasOwn(x,a))return C[a]=2,x[a];if(hasOwn(w,a))return C[a]=3,w[a];if(f!==EMPTY_OBJ&&hasOwn(f,a))return C[a]=4,f[a];shouldCacheAccess&&(C[a]=0)}}const D=publicPropertiesMap[a];let B,z;if(D)return a==="$attrs"&&track(e.attrs,"get",""),D(e);if((B=P.__cssModules)&&(B=B[a]))return B;if(f!==EMPTY_OBJ&&hasOwn(f,a))return C[a]=4,f[a];if(z=E.config.globalProperties,hasOwn(z,a))return z[a]},set({_:e},a,f){const{data:_,setupState:x,ctx:w}=e;return hasSetupBinding(x,a)?(x[a]=f,!0):_!==EMPTY_OBJ&&hasOwn(_,a)?(_[a]=f,!0):hasOwn(e.props,a)||a[0]==="$"&&a.slice(1)in e?!1:(w[a]=f,!0)},has({_:{data:e,setupState:a,accessCache:f,ctx:_,appContext:x,props:w,type:C}},P){let E;return!!(f[P]||e!==EMPTY_OBJ&&P[0]!=="$"&&hasOwn(e,P)||hasSetupBinding(a,P)||hasOwn(w,P)||hasOwn(_,P)||hasOwn(publicPropertiesMap,P)||hasOwn(x.config.globalProperties,P)||(E=C.__cssModules)&&E[P])},defineProperty(e,a,f){return f.get!=null?e._.accessCache[a]=0:hasOwn(f,"value")&&this.set(e,a,f.value,null),Reflect.defineProperty(e,a,f)}};function normalizePropsOrEmits(e){return isArray$1(e)?e.reduce((a,f)=>(a[f]=null,a),{}):e}let shouldCacheAccess=!0;function applyOptions(e){const a=resolveMergedOptions(e),f=e.proxy,_=e.ctx;shouldCacheAccess=!1,a.beforeCreate&&callHook$1(a.beforeCreate,e,"bc");const{data:x,computed:w,methods:C,watch:P,provide:E,inject:D,created:B,beforeMount:z,mounted:J,beforeUpdate:Y,updated:X,activated:tn,deactivated:pn,beforeDestroy:un,beforeUnmount:rn,destroyed:cn,unmounted:gn,render:dn,renderTracked:Mn,renderTriggered:Tn,errorCaptured:ln,serverPrefetch:wn,expose:En,inheritAttrs:An,components:Sn,directives:Bn,filters:Fn}=a;if(D&&resolveInjections(D,_,null),C)for(const Pn in C){const hn=C[Pn];isFunction(hn)&&(_[Pn]=hn.bind(f))}if(x){const Pn=x.call(f,f);isObject$3(Pn)&&(e.data=reactive(Pn))}if(shouldCacheAccess=!0,w)for(const Pn in w){const hn=w[Pn],Gn=isFunction(hn)?hn.bind(f,f):isFunction(hn.get)?hn.get.bind(f,f):NOOP,Xn=!isFunction(hn)&&isFunction(hn.set)?hn.set.bind(f):NOOP,qn=computed({get:Gn,set:Xn});Object.defineProperty(_,Pn,{enumerable:!0,configurable:!0,get:()=>qn.value,set:Jn=>qn.value=Jn})}if(P)for(const Pn in P)createWatcher(P[Pn],_,f,Pn);if(E){const Pn=isFunction(E)?E.call(f):E;Reflect.ownKeys(Pn).forEach(hn=>{provide(hn,Pn[hn])})}B&&callHook$1(B,e,"c");function Wn(Pn,hn){isArray$1(hn)?hn.forEach(Gn=>Pn(Gn.bind(f))):hn&&Pn(hn.bind(f))}if(Wn(onBeforeMount,z),Wn(onMounted,J),Wn(onBeforeUpdate,Y),Wn(onUpdated,X),Wn(onActivated,tn),Wn(onDeactivated,pn),Wn(onErrorCaptured,ln),Wn(onRenderTracked,Mn),Wn(onRenderTriggered,Tn),Wn(onBeforeUnmount,rn),Wn(onUnmounted,gn),Wn(onServerPrefetch,wn),isArray$1(En))if(En.length){const Pn=e.exposed||(e.exposed={});En.forEach(hn=>{Object.defineProperty(Pn,hn,{get:()=>f[hn],set:Gn=>f[hn]=Gn,enumerable:!0})})}else e.exposed||(e.exposed={});dn&&e.render===NOOP&&(e.render=dn),An!=null&&(e.inheritAttrs=An),Sn&&(e.components=Sn),Bn&&(e.directives=Bn),wn&&markAsyncBoundary(e)}function resolveInjections(e,a,f=NOOP){isArray$1(e)&&(e=normalizeInject(e));for(const _ in e){const x=e[_];let w;isObject$3(x)?"default"in x?w=inject(x.from||_,x.default,!0):w=inject(x.from||_):w=inject(x),isRef(w)?Object.defineProperty(a,_,{enumerable:!0,configurable:!0,get:()=>w.value,set:C=>w.value=C}):a[_]=w}}function callHook$1(e,a,f){callWithAsyncErrorHandling(isArray$1(e)?e.map(_=>_.bind(a.proxy)):e.bind(a.proxy),a,f)}function createWatcher(e,a,f,_){let x=_.includes(".")?createPathGetter(f,_):()=>f[_];if(isString(e)){const w=a[e];isFunction(w)&&watch(x,w)}else if(isFunction(e))watch(x,e.bind(f));else if(isObject$3(e))if(isArray$1(e))e.forEach(w=>createWatcher(w,a,f,_));else{const w=isFunction(e.handler)?e.handler.bind(f):a[e.handler];isFunction(w)&&watch(x,w,e)}}function resolveMergedOptions(e){const a=e.type,{mixins:f,extends:_}=a,{mixins:x,optionsCache:w,config:{optionMergeStrategies:C}}=e.appContext,P=w.get(a);let E;return P?E=P:!x.length&&!f&&!_?E=a:(E={},x.length&&x.forEach(D=>mergeOptions$1(E,D,C,!0)),mergeOptions$1(E,a,C)),isObject$3(a)&&w.set(a,E),E}function mergeOptions$1(e,a,f,_=!1){const{mixins:x,extends:w}=a;w&&mergeOptions$1(e,w,f,!0),x&&x.forEach(C=>mergeOptions$1(e,C,f,!0));for(const C in a)if(!(_&&C==="expose")){const P=internalOptionMergeStrats[C]||f&&f[C];e[C]=P?P(e[C],a[C]):a[C]}return e}const internalOptionMergeStrats={data:mergeDataFn,props:mergeEmitsOrPropsOptions,emits:mergeEmitsOrPropsOptions,methods:mergeObjectOptions,computed:mergeObjectOptions,beforeCreate:mergeAsArray,created:mergeAsArray,beforeMount:mergeAsArray,mounted:mergeAsArray,beforeUpdate:mergeAsArray,updated:mergeAsArray,beforeDestroy:mergeAsArray,beforeUnmount:mergeAsArray,destroyed:mergeAsArray,unmounted:mergeAsArray,activated:mergeAsArray,deactivated:mergeAsArray,errorCaptured:mergeAsArray,serverPrefetch:mergeAsArray,components:mergeObjectOptions,directives:mergeObjectOptions,watch:mergeWatchOptions,provide:mergeDataFn,inject:mergeInject};function mergeDataFn(e,a){return a?e?function(){return extend$3(isFunction(e)?e.call(this,this):e,isFunction(a)?a.call(this,this):a)}:a:e}function mergeInject(e,a){return mergeObjectOptions(normalizeInject(e),normalizeInject(a))}function normalizeInject(e){if(isArray$1(e)){const a={};for(let f=0;f<e.length;f++)a[e[f]]=e[f];return a}return e}function mergeAsArray(e,a){return e?[...new Set([].concat(e,a))]:a}function mergeObjectOptions(e,a){return e?extend$3(Object.create(null),e,a):a}function mergeEmitsOrPropsOptions(e,a){return e?isArray$1(e)&&isArray$1(a)?[...new Set([...e,...a])]:extend$3(Object.create(null),normalizePropsOrEmits(e),normalizePropsOrEmits(a??{})):a}function mergeWatchOptions(e,a){if(!e)return a;if(!a)return e;const f=extend$3(Object.create(null),e);for(const _ in a)f[_]=mergeAsArray(e[_],a[_]);return f}function createAppContext(){return{app:null,config:{isNativeTag:NO,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let uid$1=0;function createAppAPI(e,a){return function(_,x=null){isFunction(_)||(_=extend$3({},_)),x!=null&&!isObject$3(x)&&(x=null);const w=createAppContext(),C=new WeakSet,P=[];let E=!1;const D=w.app={_uid:uid$1++,_component:_,_props:x,_container:null,_context:w,_instance:null,version,get config(){return w.config},set config(B){},use(B,...z){return C.has(B)||(B&&isFunction(B.install)?(C.add(B),B.install(D,...z)):isFunction(B)&&(C.add(B),B(D,...z))),D},mixin(B){return w.mixins.includes(B)||w.mixins.push(B),D},component(B,z){return z?(w.components[B]=z,D):w.components[B]},directive(B,z){return z?(w.directives[B]=z,D):w.directives[B]},mount(B,z,J){if(!E){const Y=D._ceVNode||createVNode(_,x);return Y.appContext=w,J===!0?J="svg":J===!1&&(J=void 0),e(Y,B,J),E=!0,D._container=B,B.__vue_app__=D,getComponentPublicInstance(Y.component)}},onUnmount(B){P.push(B)},unmount(){E&&(callWithAsyncErrorHandling(P,D._instance,16),e(null,D._container),delete D._container.__vue_app__)},provide(B,z){return w.provides[B]=z,D},runWithContext(B){const z=currentApp;currentApp=D;try{return B()}finally{currentApp=z}}};return D}}let currentApp=null;const getModelModifiers=(e,a)=>a==="modelValue"||a==="model-value"?e.modelModifiers:e[`${a}Modifiers`]||e[`${camelize(a)}Modifiers`]||e[`${hyphenate(a)}Modifiers`];function emit(e,a,...f){if(e.isUnmounted)return;const _=e.vnode.props||EMPTY_OBJ;let x=f;const w=a.startsWith("update:"),C=w&&getModelModifiers(_,a.slice(7));C&&(C.trim&&(x=f.map(B=>isString(B)?B.trim():B)),C.number&&(x=f.map(looseToNumber)));let P,E=_[P=toHandlerKey(a)]||_[P=toHandlerKey(camelize(a))];!E&&w&&(E=_[P=toHandlerKey(hyphenate(a))]),E&&callWithAsyncErrorHandling(E,e,6,x);const D=_[P+"Once"];if(D){if(!e.emitted)e.emitted={};else if(e.emitted[P])return;e.emitted[P]=!0,callWithAsyncErrorHandling(D,e,6,x)}}const mixinEmitsCache=new WeakMap;function normalizeEmitsOptions(e,a,f=!1){const _=f?mixinEmitsCache:a.emitsCache,x=_.get(e);if(x!==void 0)return x;const w=e.emits;let C={},P=!1;if(!isFunction(e)){const E=D=>{const B=normalizeEmitsOptions(D,a,!0);B&&(P=!0,extend$3(C,B))};!f&&a.mixins.length&&a.mixins.forEach(E),e.extends&&E(e.extends),e.mixins&&e.mixins.forEach(E)}return!w&&!P?(isObject$3(e)&&_.set(e,null),null):(isArray$1(w)?w.forEach(E=>C[E]=null):extend$3(C,w),isObject$3(e)&&_.set(e,C),C)}function isEmitListener(e,a){return!e||!isOn(a)?!1:(a=a.slice(2).replace(/Once$/,""),hasOwn(e,a[0].toLowerCase()+a.slice(1))||hasOwn(e,hyphenate(a))||hasOwn(e,a))}function markAttrsAccessed(){}function renderComponentRoot(e){const{type:a,vnode:f,proxy:_,withProxy:x,propsOptions:[w],slots:C,attrs:P,emit:E,render:D,renderCache:B,props:z,data:J,setupState:Y,ctx:X,inheritAttrs:tn}=e,pn=setCurrentRenderingInstance(e);let un,rn;try{if(f.shapeFlag&4){const gn=x||_,dn=gn;un=normalizeVNode(D.call(dn,gn,B,z,Y,J,X)),rn=P}else{const gn=a;un=normalizeVNode(gn.length>1?gn(z,{attrs:P,slots:C,emit:E}):gn(z,null)),rn=a.props?P:getFunctionalFallthrough(P)}}catch(gn){blockStack.length=0,handleError(gn,e,1),un=createVNode(Comment$1)}let cn=un;if(rn&&tn!==!1){const gn=Object.keys(rn),{shapeFlag:dn}=cn;gn.length&&dn&7&&(w&&gn.some(isModelListener)&&(rn=filterModelListeners(rn,w)),cn=cloneVNode(cn,rn,!1,!0))}return f.dirs&&(cn=cloneVNode(cn,null,!1,!0),cn.dirs=cn.dirs?cn.dirs.concat(f.dirs):f.dirs),f.transition&&setTransitionHooks(cn,f.transition),un=cn,setCurrentRenderingInstance(pn),un}const getFunctionalFallthrough=e=>{let a;for(const f in e)(f==="class"||f==="style"||isOn(f))&&((a||(a={}))[f]=e[f]);return a},filterModelListeners=(e,a)=>{const f={};for(const _ in e)(!isModelListener(_)||!(_.slice(9)in a))&&(f[_]=e[_]);return f};function shouldUpdateComponent(e,a,f){const{props:_,children:x,component:w}=e,{props:C,children:P,patchFlag:E}=a,D=w.emitsOptions;if(a.dirs||a.transition)return!0;if(f&&E>=0){if(E&1024)return!0;if(E&16)return _?hasPropsChanged(_,C,D):!!C;if(E&8){const B=a.dynamicProps;for(let z=0;z<B.length;z++){const J=B[z];if(C[J]!==_[J]&&!isEmitListener(D,J))return!0}}}else return(x||P)&&(!P||!P.$stable)?!0:_===C?!1:_?C?hasPropsChanged(_,C,D):!0:!!C;return!1}function hasPropsChanged(e,a,f){const _=Object.keys(a);if(_.length!==Object.keys(e).length)return!0;for(let x=0;x<_.length;x++){const w=_[x];if(a[w]!==e[w]&&!isEmitListener(f,w))return!0}return!1}function updateHOCHostEl({vnode:e,parent:a},f){for(;a;){const _=a.subTree;if(_.suspense&&_.suspense.activeBranch===e&&(_.el=e.el),_===e)(e=a.vnode).el=f,a=a.parent;else break}}const internalObjectProto={},createInternalObject=()=>Object.create(internalObjectProto),isInternalObject=e=>Object.getPrototypeOf(e)===internalObjectProto;function initProps(e,a,f,_=!1){const x={},w=createInternalObject();e.propsDefaults=Object.create(null),setFullProps(e,a,x,w);for(const C in e.propsOptions[0])C in x||(x[C]=void 0);f?e.props=_?x:shallowReactive(x):e.type.props?e.props=x:e.props=w,e.attrs=w}function updateProps(e,a,f,_){const{props:x,attrs:w,vnode:{patchFlag:C}}=e,P=toRaw(x),[E]=e.propsOptions;let D=!1;if((_||C>0)&&!(C&16)){if(C&8){const B=e.vnode.dynamicProps;for(let z=0;z<B.length;z++){let J=B[z];if(isEmitListener(e.emitsOptions,J))continue;const Y=a[J];if(E)if(hasOwn(w,J))Y!==w[J]&&(w[J]=Y,D=!0);else{const X=camelize(J);x[X]=resolvePropValue(E,P,X,Y,e,!1)}else Y!==w[J]&&(w[J]=Y,D=!0)}}}else{setFullProps(e,a,x,w)&&(D=!0);let B;for(const z in P)(!a||!hasOwn(a,z)&&((B=hyphenate(z))===z||!hasOwn(a,B)))&&(E?f&&(f[z]!==void 0||f[B]!==void 0)&&(x[z]=resolvePropValue(E,P,z,void 0,e,!0)):delete x[z]);if(w!==P)for(const z in w)(!a||!hasOwn(a,z))&&(delete w[z],D=!0)}D&&trigger(e.attrs,"set","")}function setFullProps(e,a,f,_){const[x,w]=e.propsOptions;let C=!1,P;if(a)for(let E in a){if(isReservedProp(E))continue;const D=a[E];let B;x&&hasOwn(x,B=camelize(E))?!w||!w.includes(B)?f[B]=D:(P||(P={}))[B]=D:isEmitListener(e.emitsOptions,E)||(!(E in _)||D!==_[E])&&(_[E]=D,C=!0)}if(w){const E=toRaw(f),D=P||EMPTY_OBJ;for(let B=0;B<w.length;B++){const z=w[B];f[z]=resolvePropValue(x,E,z,D[z],e,!hasOwn(D,z))}}return C}function resolvePropValue(e,a,f,_,x,w){const C=e[f];if(C!=null){const P=hasOwn(C,"default");if(P&&_===void 0){const E=C.default;if(C.type!==Function&&!C.skipFactory&&isFunction(E)){const{propsDefaults:D}=x;if(f in D)_=D[f];else{const B=setCurrentInstance(x);_=D[f]=E.call(null,a),B()}}else _=E;x.ce&&x.ce._setProp(f,_)}C[0]&&(w&&!P?_=!1:C[1]&&(_===""||_===hyphenate(f))&&(_=!0))}return _}const mixinPropsCache=new WeakMap;function normalizePropsOptions(e,a,f=!1){const _=f?mixinPropsCache:a.propsCache,x=_.get(e);if(x)return x;const w=e.props,C={},P=[];let E=!1;if(!isFunction(e)){const B=z=>{E=!0;const[J,Y]=normalizePropsOptions(z,a,!0);extend$3(C,J),Y&&P.push(...Y)};!f&&a.mixins.length&&a.mixins.forEach(B),e.extends&&B(e.extends),e.mixins&&e.mixins.forEach(B)}if(!w&&!E)return isObject$3(e)&&_.set(e,EMPTY_ARR),EMPTY_ARR;if(isArray$1(w))for(let B=0;B<w.length;B++){const z=camelize(w[B]);validatePropName(z)&&(C[z]=EMPTY_OBJ)}else if(w)for(const B in w){const z=camelize(B);if(validatePropName(z)){const J=w[B],Y=C[z]=isArray$1(J)||isFunction(J)?{type:J}:extend$3({},J),X=Y.type;let tn=!1,pn=!0;if(isArray$1(X))for(let un=0;un<X.length;++un){const rn=X[un],cn=isFunction(rn)&&rn.name;if(cn==="Boolean"){tn=!0;break}else cn==="String"&&(pn=!1)}else tn=isFunction(X)&&X.name==="Boolean";Y[0]=tn,Y[1]=pn,(tn||hasOwn(Y,"default"))&&P.push(z)}}const D=[C,P];return isObject$3(e)&&_.set(e,D),D}function validatePropName(e){return e[0]!=="$"&&!isReservedProp(e)}const isInternalKey=e=>e==="_"||e==="_ctx"||e==="$stable",normalizeSlotValue=e=>isArray$1(e)?e.map(normalizeVNode):[normalizeVNode(e)],normalizeSlot$1=(e,a,f)=>{if(a._n)return a;const _=withCtx((...x)=>normalizeSlotValue(a(...x)),f);return _._c=!1,_},normalizeObjectSlots=(e,a,f)=>{const _=e._ctx;for(const x in e){if(isInternalKey(x))continue;const w=e[x];if(isFunction(w))a[x]=normalizeSlot$1(x,w,_);else if(w!=null){const C=normalizeSlotValue(w);a[x]=()=>C}}},normalizeVNodeSlots=(e,a)=>{const f=normalizeSlotValue(a);e.slots.default=()=>f},assignSlots=(e,a,f)=>{for(const _ in a)(f||!isInternalKey(_))&&(e[_]=a[_])},initSlots=(e,a,f)=>{const _=e.slots=createInternalObject();if(e.vnode.shapeFlag&32){const x=a._;x?(assignSlots(_,a,f),f&&def(_,"_",x,!0)):normalizeObjectSlots(a,_)}else a&&normalizeVNodeSlots(e,a)},updateSlots=(e,a,f)=>{const{vnode:_,slots:x}=e;let w=!0,C=EMPTY_OBJ;if(_.shapeFlag&32){const P=a._;P?f&&P===1?w=!1:assignSlots(x,a,f):(w=!a.$stable,normalizeObjectSlots(a,x)),C=a}else a&&(normalizeVNodeSlots(e,a),C={default:1});if(w)for(const P in x)!isInternalKey(P)&&C[P]==null&&delete x[P]},queuePostRenderEffect=queueEffectWithSuspense;function createRenderer(e){return baseCreateRenderer(e)}function baseCreateRenderer(e,a){const f=getGlobalThis();f.__VUE__=!0;const{insert:_,remove:x,patchProp:w,createElement:C,createText:P,createComment:E,setText:D,setElementText:B,parentNode:z,nextSibling:J,setScopeId:Y=NOOP,insertStaticContent:X}=e,tn=(nn,on,an,bn=null,jn=null,xn=null,Rn=void 0,In=null,On=!!on.dynamicChildren)=>{if(nn===on)return;nn&&!isSameVNodeType(nn,on)&&(bn=yn(nn),Jn(nn,jn,xn,!0),nn=null),on.patchFlag===-2&&(On=!1,on.dynamicChildren=null);const{type:kn,ref:Ln,shapeFlag:$n}=on;switch(kn){case Text:pn(nn,on,an,bn);break;case Comment$1:un(nn,on,an,bn);break;case Static:nn==null&&rn(on,an,bn,Rn);break;case Fragment:Sn(nn,on,an,bn,jn,xn,Rn,In,On);break;default:$n&1?dn(nn,on,an,bn,jn,xn,Rn,In,On):$n&6?Bn(nn,on,an,bn,jn,xn,Rn,In,On):($n&64||$n&128)&&kn.process(nn,on,an,bn,jn,xn,Rn,In,On,Vn)}Ln!=null&&jn?setRef(Ln,nn&&nn.ref,xn,on||nn,!on):Ln==null&&nn&&nn.ref!=null&&setRef(nn.ref,null,xn,nn,!0)},pn=(nn,on,an,bn)=>{if(nn==null)_(on.el=P(on.children),an,bn);else{const jn=on.el=nn.el;on.children!==nn.children&&D(jn,on.children)}},un=(nn,on,an,bn)=>{nn==null?_(on.el=E(on.children||""),an,bn):on.el=nn.el},rn=(nn,on,an,bn)=>{[nn.el,nn.anchor]=X(nn.children,on,an,bn,nn.el,nn.anchor)},cn=({el:nn,anchor:on},an,bn)=>{let jn;for(;nn&&nn!==on;)jn=J(nn),_(nn,an,bn),nn=jn;_(on,an,bn)},gn=({el:nn,anchor:on})=>{let an;for(;nn&&nn!==on;)an=J(nn),x(nn),nn=an;x(on)},dn=(nn,on,an,bn,jn,xn,Rn,In,On)=>{if(on.type==="svg"?Rn="svg":on.type==="math"&&(Rn="mathml"),nn==null)Mn(on,an,bn,jn,xn,Rn,In,On);else{const kn=nn.el&&nn.el._isVueCE?nn.el:null;try{kn&&kn._beginPatch(),wn(nn,on,jn,xn,Rn,In,On)}finally{kn&&kn._endPatch()}}},Mn=(nn,on,an,bn,jn,xn,Rn,In)=>{let On,kn;const{props:Ln,shapeFlag:$n,transition:Hn,dirs:M}=nn;if(On=nn.el=C(nn.type,xn,Ln&&Ln.is,Ln),$n&8?B(On,nn.children):$n&16&&ln(nn.children,On,null,bn,jn,resolveChildrenNamespace(nn,xn),Rn,In),M&&invokeDirectiveHook(nn,null,bn,"created"),Tn(On,nn,nn.scopeId,Rn,bn),Ln){for(const G in Ln)G!=="value"&&!isReservedProp(G)&&w(On,G,null,Ln[G],xn,bn);"value"in Ln&&w(On,"value",null,Ln.value,xn),(kn=Ln.onVnodeBeforeMount)&&invokeVNodeHook(kn,bn,nn)}M&&invokeDirectiveHook(nn,null,bn,"beforeMount");const sn=needTransition(jn,Hn);sn&&Hn.beforeEnter(On),_(On,on,an),((kn=Ln&&Ln.onVnodeMounted)||sn||M)&&queuePostRenderEffect(()=>{kn&&invokeVNodeHook(kn,bn,nn),sn&&Hn.enter(On),M&&invokeDirectiveHook(nn,null,bn,"mounted")},jn)},Tn=(nn,on,an,bn,jn)=>{if(an&&Y(nn,an),bn)for(let xn=0;xn<bn.length;xn++)Y(nn,bn[xn]);if(jn){let xn=jn.subTree;if(on===xn||isSuspense(xn.type)&&(xn.ssContent===on||xn.ssFallback===on)){const Rn=jn.vnode;Tn(nn,Rn,Rn.scopeId,Rn.slotScopeIds,jn.parent)}}},ln=(nn,on,an,bn,jn,xn,Rn,In,On=0)=>{for(let kn=On;kn<nn.length;kn++){const Ln=nn[kn]=In?cloneIfMounted(nn[kn]):normalizeVNode(nn[kn]);tn(null,Ln,on,an,bn,jn,xn,Rn,In)}},wn=(nn,on,an,bn,jn,xn,Rn)=>{const In=on.el=nn.el;let{patchFlag:On,dynamicChildren:kn,dirs:Ln}=on;On|=nn.patchFlag&16;const $n=nn.props||EMPTY_OBJ,Hn=on.props||EMPTY_OBJ;let M;if(an&&toggleRecurse(an,!1),(M=Hn.onVnodeBeforeUpdate)&&invokeVNodeHook(M,an,on,nn),Ln&&invokeDirectiveHook(on,nn,an,"beforeUpdate"),an&&toggleRecurse(an,!0),($n.innerHTML&&Hn.innerHTML==null||$n.textContent&&Hn.textContent==null)&&B(In,""),kn?En(nn.dynamicChildren,kn,In,an,bn,resolveChildrenNamespace(on,jn),xn):Rn||hn(nn,on,In,null,an,bn,resolveChildrenNamespace(on,jn),xn,!1),On>0){if(On&16)An(In,$n,Hn,an,jn);else if(On&2&&$n.class!==Hn.class&&w(In,"class",null,Hn.class,jn),On&4&&w(In,"style",$n.style,Hn.style,jn),On&8){const sn=on.dynamicProps;for(let G=0;G<sn.length;G++){const I=sn[G],H=$n[I],q=Hn[I];(q!==H||I==="value")&&w(In,I,H,q,jn,an)}}On&1&&nn.children!==on.children&&B(In,on.children)}else!Rn&&kn==null&&An(In,$n,Hn,an,jn);((M=Hn.onVnodeUpdated)||Ln)&&queuePostRenderEffect(()=>{M&&invokeVNodeHook(M,an,on,nn),Ln&&invokeDirectiveHook(on,nn,an,"updated")},bn)},En=(nn,on,an,bn,jn,xn,Rn)=>{for(let In=0;In<on.length;In++){const On=nn[In],kn=on[In],Ln=On.el&&(On.type===Fragment||!isSameVNodeType(On,kn)||On.shapeFlag&198)?z(On.el):an;tn(On,kn,Ln,null,bn,jn,xn,Rn,!0)}},An=(nn,on,an,bn,jn)=>{if(on!==an){if(on!==EMPTY_OBJ)for(const xn in on)!isReservedProp(xn)&&!(xn in an)&&w(nn,xn,on[xn],null,jn,bn);for(const xn in an){if(isReservedProp(xn))continue;const Rn=an[xn],In=on[xn];Rn!==In&&xn!=="value"&&w(nn,xn,In,Rn,jn,bn)}"value"in an&&w(nn,"value",on.value,an.value,jn)}},Sn=(nn,on,an,bn,jn,xn,Rn,In,On)=>{const kn=on.el=nn?nn.el:P(""),Ln=on.anchor=nn?nn.anchor:P("");let{patchFlag:$n,dynamicChildren:Hn,slotScopeIds:M}=on;M&&(In=In?In.concat(M):M),nn==null?(_(kn,an,bn),_(Ln,an,bn),ln(on.children||[],an,Ln,jn,xn,Rn,In,On)):$n>0&&$n&64&&Hn&&nn.dynamicChildren&&nn.dynamicChildren.length===Hn.length?(En(nn.dynamicChildren,Hn,an,jn,xn,Rn,In),(on.key!=null||jn&&on===jn.subTree)&&traverseStaticChildren(nn,on,!0)):hn(nn,on,an,Ln,jn,xn,Rn,In,On)},Bn=(nn,on,an,bn,jn,xn,Rn,In,On)=>{on.slotScopeIds=In,nn==null?on.shapeFlag&512?jn.ctx.activate(on,an,bn,Rn,On):Fn(on,an,bn,jn,xn,Rn,On):Un(nn,on,On)},Fn=(nn,on,an,bn,jn,xn,Rn)=>{const In=nn.component=createComponentInstance(nn,bn,jn);if(isKeepAlive(nn)&&(In.ctx.renderer=Vn),setupComponent(In,!1,Rn),In.asyncDep){if(jn&&jn.registerDep(In,Wn,Rn),!nn.el){const On=In.subTree=createVNode(Comment$1);un(null,On,on,an),nn.placeholder=On.el}}else Wn(In,nn,on,an,jn,xn,Rn)},Un=(nn,on,an)=>{const bn=on.component=nn.component;if(shouldUpdateComponent(nn,on,an))if(bn.asyncDep&&!bn.asyncResolved){Pn(bn,on,an);return}else bn.next=on,bn.update();else on.el=nn.el,bn.vnode=on},Wn=(nn,on,an,bn,jn,xn,Rn)=>{const In=()=>{if(nn.isMounted){let{next:$n,bu:Hn,u:M,parent:sn,vnode:G}=nn;{const Z=locateNonHydratedAsyncRoot(nn);if(Z){$n&&($n.el=G.el,Pn(nn,$n,Rn)),Z.asyncDep.then(()=>{nn.isUnmounted||In()});return}}let I=$n,H;toggleRecurse(nn,!1),$n?($n.el=G.el,Pn(nn,$n,Rn)):$n=G,Hn&&invokeArrayFns(Hn),(H=$n.props&&$n.props.onVnodeBeforeUpdate)&&invokeVNodeHook(H,sn,$n,G),toggleRecurse(nn,!0);const q=renderComponentRoot(nn),K=nn.subTree;nn.subTree=q,tn(K,q,z(K.el),yn(K),nn,jn,xn),$n.el=q.el,I===null&&updateHOCHostEl(nn,q.el),M&&queuePostRenderEffect(M,jn),(H=$n.props&&$n.props.onVnodeUpdated)&&queuePostRenderEffect(()=>invokeVNodeHook(H,sn,$n,G),jn)}else{let $n;const{el:Hn,props:M}=on,{bm:sn,m:G,parent:I,root:H,type:q}=nn,K=isAsyncWrapper(on);toggleRecurse(nn,!1),sn&&invokeArrayFns(sn),!K&&($n=M&&M.onVnodeBeforeMount)&&invokeVNodeHook($n,I,on),toggleRecurse(nn,!0);{H.ce&&H.ce._def.shadowRoot!==!1&&H.ce._injectChildStyle(q);const Z=nn.subTree=renderComponentRoot(nn);tn(null,Z,an,bn,nn,jn,xn),on.el=Z.el}if(G&&queuePostRenderEffect(G,jn),!K&&($n=M&&M.onVnodeMounted)){const Z=on;queuePostRenderEffect(()=>invokeVNodeHook($n,I,Z),jn)}(on.shapeFlag&256||I&&isAsyncWrapper(I.vnode)&&I.vnode.shapeFlag&256)&&nn.a&&queuePostRenderEffect(nn.a,jn),nn.isMounted=!0,on=an=bn=null}};nn.scope.on();const On=nn.effect=new ReactiveEffect(In);nn.scope.off();const kn=nn.update=On.run.bind(On),Ln=nn.job=On.runIfDirty.bind(On);Ln.i=nn,Ln.id=nn.uid,On.scheduler=()=>queueJob(Ln),toggleRecurse(nn,!0),kn()},Pn=(nn,on,an)=>{on.component=nn;const bn=nn.vnode.props;nn.vnode=on,nn.next=null,updateProps(nn,on.props,bn,an),updateSlots(nn,on.children,an),pauseTracking(),flushPreFlushCbs(nn),resetTracking()},hn=(nn,on,an,bn,jn,xn,Rn,In,On=!1)=>{const kn=nn&&nn.children,Ln=nn?nn.shapeFlag:0,$n=on.children,{patchFlag:Hn,shapeFlag:M}=on;if(Hn>0){if(Hn&128){Xn(kn,$n,an,bn,jn,xn,Rn,In,On);return}else if(Hn&256){Gn(kn,$n,an,bn,jn,xn,Rn,In,On);return}}M&8?(Ln&16&&ee(kn,jn,xn),$n!==kn&&B(an,$n)):Ln&16?M&16?Xn(kn,$n,an,bn,jn,xn,Rn,In,On):ee(kn,jn,xn,!0):(Ln&8&&B(an,""),M&16&&ln($n,an,bn,jn,xn,Rn,In,On))},Gn=(nn,on,an,bn,jn,xn,Rn,In,On)=>{nn=nn||EMPTY_ARR,on=on||EMPTY_ARR;const kn=nn.length,Ln=on.length,$n=Math.min(kn,Ln);let Hn;for(Hn=0;Hn<$n;Hn++){const M=on[Hn]=On?cloneIfMounted(on[Hn]):normalizeVNode(on[Hn]);tn(nn[Hn],M,an,null,jn,xn,Rn,In,On)}kn>Ln?ee(nn,jn,xn,!0,!1,$n):ln(on,an,bn,jn,xn,Rn,In,On,$n)},Xn=(nn,on,an,bn,jn,xn,Rn,In,On)=>{let kn=0;const Ln=on.length;let $n=nn.length-1,Hn=Ln-1;for(;kn<=$n&&kn<=Hn;){const M=nn[kn],sn=on[kn]=On?cloneIfMounted(on[kn]):normalizeVNode(on[kn]);if(isSameVNodeType(M,sn))tn(M,sn,an,null,jn,xn,Rn,In,On);else break;kn++}for(;kn<=$n&&kn<=Hn;){const M=nn[$n],sn=on[Hn]=On?cloneIfMounted(on[Hn]):normalizeVNode(on[Hn]);if(isSameVNodeType(M,sn))tn(M,sn,an,null,jn,xn,Rn,In,On);else break;$n--,Hn--}if(kn>$n){if(kn<=Hn){const M=Hn+1,sn=M<Ln?on[M].el:bn;for(;kn<=Hn;)tn(null,on[kn]=On?cloneIfMounted(on[kn]):normalizeVNode(on[kn]),an,sn,jn,xn,Rn,In,On),kn++}}else if(kn>Hn)for(;kn<=$n;)Jn(nn[kn],jn,xn,!0),kn++;else{const M=kn,sn=kn,G=new Map;for(kn=sn;kn<=Hn;kn++){const _n=on[kn]=On?cloneIfMounted(on[kn]):normalizeVNode(on[kn]);_n.key!=null&&G.set(_n.key,kn)}let I,H=0;const q=Hn-sn+1;let K=!1,Z=0;const en=new Array(q);for(kn=0;kn<q;kn++)en[kn]=0;for(kn=M;kn<=$n;kn++){const _n=nn[kn];if(H>=q){Jn(_n,jn,xn,!0);continue}let fn;if(_n.key!=null)fn=G.get(_n.key);else for(I=sn;I<=Hn;I++)if(en[I-sn]===0&&isSameVNodeType(_n,on[I])){fn=I;break}fn===void 0?Jn(_n,jn,xn,!0):(en[fn-sn]=kn+1,fn>=Z?Z=fn:K=!0,tn(_n,on[fn],an,null,jn,xn,Rn,In,On),H++)}const mn=K?getSequence(en):EMPTY_ARR;for(I=mn.length-1,kn=q-1;kn>=0;kn--){const _n=sn+kn,fn=on[_n],Cn=on[_n+1],vn=_n+1<Ln?Cn.el||resolveAsyncComponentPlaceholder(Cn):bn;en[kn]===0?tn(null,fn,an,vn,jn,xn,Rn,In,On):K&&(I<0||kn!==mn[I]?qn(fn,an,vn,2):I--)}}},qn=(nn,on,an,bn,jn=null)=>{const{el:xn,type:Rn,transition:In,children:On,shapeFlag:kn}=nn;if(kn&6){qn(nn.component.subTree,on,an,bn);return}if(kn&128){nn.suspense.move(on,an,bn);return}if(kn&64){Rn.move(nn,on,an,Vn);return}if(Rn===Fragment){_(xn,on,an);for(let $n=0;$n<On.length;$n++)qn(On[$n],on,an,bn);_(nn.anchor,on,an);return}if(Rn===Static){cn(nn,on,an);return}if(bn!==2&&kn&1&&In)if(bn===0)In.beforeEnter(xn),_(xn,on,an),queuePostRenderEffect(()=>In.enter(xn),jn);else{const{leave:$n,delayLeave:Hn,afterLeave:M}=In,sn=()=>{nn.ctx.isUnmounted?x(xn):_(xn,on,an)},G=()=>{xn._isLeaving&&xn[leaveCbKey](!0),$n(xn,()=>{sn(),M&&M()})};Hn?Hn(xn,sn,G):G()}else _(xn,on,an)},Jn=(nn,on,an,bn=!1,jn=!1)=>{const{type:xn,props:Rn,ref:In,children:On,dynamicChildren:kn,shapeFlag:Ln,patchFlag:$n,dirs:Hn,cacheIndex:M}=nn;if($n===-2&&(jn=!1),In!=null&&(pauseTracking(),setRef(In,null,an,nn,!0),resetTracking()),M!=null&&(on.renderCache[M]=void 0),Ln&256){on.ctx.deactivate(nn);return}const sn=Ln&1&&Hn,G=!isAsyncWrapper(nn);let I;if(G&&(I=Rn&&Rn.onVnodeBeforeUnmount)&&invokeVNodeHook(I,on,nn),Ln&6)Qn(nn.component,an,bn);else{if(Ln&128){nn.suspense.unmount(an,bn);return}sn&&invokeDirectiveHook(nn,null,on,"beforeUnmount"),Ln&64?nn.type.remove(nn,on,an,Vn,bn):kn&&!kn.hasOnce&&(xn!==Fragment||$n>0&&$n&64)?ee(kn,on,an,!1,!0):(xn===Fragment&&$n&384||!jn&&Ln&16)&&ee(On,on,an),bn&&ne(nn)}(G&&(I=Rn&&Rn.onVnodeUnmounted)||sn)&&queuePostRenderEffect(()=>{I&&invokeVNodeHook(I,on,nn),sn&&invokeDirectiveHook(nn,null,on,"unmounted")},an)},ne=nn=>{const{type:on,el:an,anchor:bn,transition:jn}=nn;if(on===Fragment){te(an,bn);return}if(on===Static){gn(nn);return}const xn=()=>{x(an),jn&&!jn.persisted&&jn.afterLeave&&jn.afterLeave()};if(nn.shapeFlag&1&&jn&&!jn.persisted){const{leave:Rn,delayLeave:In}=jn,On=()=>Rn(an,xn);In?In(nn.el,xn,On):On()}else xn()},te=(nn,on)=>{let an;for(;nn!==on;)an=J(nn),x(nn),nn=an;x(on)},Qn=(nn,on,an)=>{const{bum:bn,scope:jn,job:xn,subTree:Rn,um:In,m:On,a:kn}=nn;invalidateMount(On),invalidateMount(kn),bn&&invokeArrayFns(bn),jn.stop(),xn&&(xn.flags|=8,Jn(Rn,nn,on,an)),In&&queuePostRenderEffect(In,on),queuePostRenderEffect(()=>{nn.isUnmounted=!0},on)},ee=(nn,on,an,bn=!1,jn=!1,xn=0)=>{for(let Rn=xn;Rn<nn.length;Rn++)Jn(nn[Rn],on,an,bn,jn)},yn=nn=>{if(nn.shapeFlag&6)return yn(nn.component.subTree);if(nn.shapeFlag&128)return nn.suspense.next();const on=J(nn.anchor||nn.el),an=on&&on[TeleportEndKey];return an?J(an):on};let Nn=!1;const Dn=(nn,on,an)=>{let bn;nn==null?on._vnode&&(Jn(on._vnode,null,null,!0),bn=on._vnode.component):tn(on._vnode||null,nn,on,null,null,null,an),on._vnode=nn,Nn||(Nn=!0,flushPreFlushCbs(bn),flushPostFlushCbs(),Nn=!1)},Vn={p:tn,um:Jn,m:qn,r:ne,mt:Fn,mc:ln,pc:hn,pbc:En,n:yn,o:e};return{render:Dn,hydrate:void 0,createApp:createAppAPI(Dn)}}function resolveChildrenNamespace({type:e,props:a},f){return f==="svg"&&e==="foreignObject"||f==="mathml"&&e==="annotation-xml"&&a&&a.encoding&&a.encoding.includes("html")?void 0:f}function toggleRecurse({effect:e,job:a},f){f?(e.flags|=32,a.flags|=4):(e.flags&=-33,a.flags&=-5)}function needTransition(e,a){return(!e||e&&!e.pendingBranch)&&a&&!a.persisted}function traverseStaticChildren(e,a,f=!1){const _=e.children,x=a.children;if(isArray$1(_)&&isArray$1(x))for(let w=0;w<_.length;w++){const C=_[w];let P=x[w];P.shapeFlag&1&&!P.dynamicChildren&&((P.patchFlag<=0||P.patchFlag===32)&&(P=x[w]=cloneIfMounted(x[w]),P.el=C.el),!f&&P.patchFlag!==-2&&traverseStaticChildren(C,P)),P.type===Text&&(P.patchFlag!==-1?P.el=C.el:P.__elIndex=w+(e.type===Fragment?1:0)),P.type===Comment$1&&!P.el&&(P.el=C.el)}}function getSequence(e){const a=e.slice(),f=[0];let _,x,w,C,P;const E=e.length;for(_=0;_<E;_++){const D=e[_];if(D!==0){if(x=f[f.length-1],e[x]<D){a[_]=x,f.push(_);continue}for(w=0,C=f.length-1;w<C;)P=w+C>>1,e[f[P]]<D?w=P+1:C=P;D<e[f[w]]&&(w>0&&(a[_]=f[w-1]),f[w]=_)}}for(w=f.length,C=f[w-1];w-- >0;)f[w]=C,C=a[C];return f}function locateNonHydratedAsyncRoot(e){const a=e.subTree.component;if(a)return a.asyncDep&&!a.asyncResolved?a:locateNonHydratedAsyncRoot(a)}function invalidateMount(e){if(e)for(let a=0;a<e.length;a++)e[a].flags|=8}function resolveAsyncComponentPlaceholder(e){if(e.placeholder)return e.placeholder;const a=e.component;return a?resolveAsyncComponentPlaceholder(a.subTree):null}const isSuspense=e=>e.__isSuspense;function queueEffectWithSuspense(e,a){a&&a.pendingBranch?isArray$1(e)?a.effects.push(...e):a.effects.push(e):queuePostFlushCb(e)}const Fragment=Symbol.for("v-fgt"),Text=Symbol.for("v-txt"),Comment$1=Symbol.for("v-cmt"),Static=Symbol.for("v-stc"),blockStack=[];let currentBlock=null;function openBlock(e=!1){blockStack.push(currentBlock=e?null:[])}function closeBlock(){blockStack.pop(),currentBlock=blockStack[blockStack.length-1]||null}let isBlockTreeEnabled=1;function setBlockTracking(e,a=!1){isBlockTreeEnabled+=e,e<0&&currentBlock&&a&&(currentBlock.hasOnce=!0)}function setupBlock(e){return e.dynamicChildren=isBlockTreeEnabled>0?currentBlock||EMPTY_ARR:null,closeBlock(),isBlockTreeEnabled>0&&currentBlock&&currentBlock.push(e),e}function createElementBlock(e,a,f,_,x,w){return setupBlock(createBaseVNode(e,a,f,_,x,w,!0))}function createBlock(e,a,f,_,x){return setupBlock(createVNode(e,a,f,_,x,!0))}function isVNode(e){return e?e.__v_isVNode===!0:!1}function isSameVNodeType(e,a){return e.type===a.type&&e.key===a.key}const normalizeKey=({key:e})=>e??null,normalizeRef=({ref:e,ref_key:a,ref_for:f})=>(typeof e=="number"&&(e=""+e),e!=null?isString(e)||isRef(e)||isFunction(e)?{i:currentRenderingInstance,r:e,k:a,f:!!f}:e:null);function createBaseVNode(e,a=null,f=null,_=0,x=null,w=e===Fragment?0:1,C=!1,P=!1){const E={__v_isVNode:!0,__v_skip:!0,type:e,props:a,key:a&&normalizeKey(a),ref:a&&normalizeRef(a),scopeId:currentScopeId,slotScopeIds:null,children:f,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:w,patchFlag:_,dynamicProps:x,dynamicChildren:null,appContext:null,ctx:currentRenderingInstance};return P?(normalizeChildren(E,f),w&128&&e.normalize(E)):f&&(E.shapeFlag|=isString(f)?8:16),isBlockTreeEnabled>0&&!C&&currentBlock&&(E.patchFlag>0||w&6)&&E.patchFlag!==32&&currentBlock.push(E),E}const createVNode=_createVNode;function _createVNode(e,a=null,f=null,_=0,x=null,w=!1){if((!e||e===NULL_DYNAMIC_COMPONENT)&&(e=Comment$1),isVNode(e)){const P=cloneVNode(e,a,!0);return f&&normalizeChildren(P,f),isBlockTreeEnabled>0&&!w&&currentBlock&&(P.shapeFlag&6?currentBlock[currentBlock.indexOf(e)]=P:currentBlock.push(P)),P.patchFlag=-2,P}if(isClassComponent(e)&&(e=e.__vccOpts),a){a=guardReactiveProps(a);let{class:P,style:E}=a;P&&!isString(P)&&(a.class=normalizeClass(P)),isObject$3(E)&&(isProxy(E)&&!isArray$1(E)&&(E=extend$3({},E)),a.style=normalizeStyle(E))}const C=isString(e)?1:isSuspense(e)?128:isTeleport(e)?64:isObject$3(e)?4:isFunction(e)?2:0;return createBaseVNode(e,a,f,_,x,C,w,!0)}function guardReactiveProps(e){return e?isProxy(e)||isInternalObject(e)?extend$3({},e):e:null}function cloneVNode(e,a,f=!1,_=!1){const{props:x,ref:w,patchFlag:C,children:P,transition:E}=e,D=a?mergeProps(x||{},a):x,B={__v_isVNode:!0,__v_skip:!0,type:e.type,props:D,key:D&&normalizeKey(D),ref:a&&a.ref?f&&w?isArray$1(w)?w.concat(normalizeRef(a)):[w,normalizeRef(a)]:normalizeRef(a):w,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:P,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:a&&e.type!==Fragment?C===-1?16:C|16:C,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:E,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&cloneVNode(e.ssContent),ssFallback:e.ssFallback&&cloneVNode(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return E&&_&&setTransitionHooks(B,E.clone(B)),B}function createTextVNode(e=" ",a=0){return createVNode(Text,null,e,a)}function createCommentVNode(e="",a=!1){return a?(openBlock(),createBlock(Comment$1,null,e)):createVNode(Comment$1,null,e)}function normalizeVNode(e){return e==null||typeof e=="boolean"?createVNode(Comment$1):isArray$1(e)?createVNode(Fragment,null,e.slice()):isVNode(e)?cloneIfMounted(e):createVNode(Text,null,String(e))}function cloneIfMounted(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:cloneVNode(e)}function normalizeChildren(e,a){let f=0;const{shapeFlag:_}=e;if(a==null)a=null;else if(isArray$1(a))f=16;else if(typeof a=="object")if(_&65){const x=a.default;x&&(x._c&&(x._d=!1),normalizeChildren(e,x()),x._c&&(x._d=!0));return}else{f=32;const x=a._;!x&&!isInternalObject(a)?a._ctx=currentRenderingInstance:x===3&&currentRenderingInstance&&(currentRenderingInstance.slots._===1?a._=1:(a._=2,e.patchFlag|=1024))}else isFunction(a)?(a={default:a,_ctx:currentRenderingInstance},f=32):(a=String(a),_&64?(f=16,a=[createTextVNode(a)]):f=8);e.children=a,e.shapeFlag|=f}function mergeProps(...e){const a={};for(let f=0;f<e.length;f++){const _=e[f];for(const x in _)if(x==="class")a.class!==_.class&&(a.class=normalizeClass([a.class,_.class]));else if(x==="style")a.style=normalizeStyle([a.style,_.style]);else if(isOn(x)){const w=a[x],C=_[x];C&&w!==C&&!(isArray$1(w)&&w.includes(C))&&(a[x]=w?[].concat(w,C):C)}else x!==""&&(a[x]=_[x])}return a}function invokeVNodeHook(e,a,f,_=null){callWithAsyncErrorHandling(e,a,7,[f,_])}const emptyAppContext=createAppContext();let uid=0;function createComponentInstance(e,a,f){const _=e.type,x=(a?a.appContext:e.appContext)||emptyAppContext,w={uid:uid++,vnode:e,type:_,parent:a,appContext:x,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new EffectScope(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:a?a.provides:Object.create(x.provides),ids:a?a.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:normalizePropsOptions(_,x),emitsOptions:normalizeEmitsOptions(_,x),emit:null,emitted:null,propsDefaults:EMPTY_OBJ,inheritAttrs:_.inheritAttrs,ctx:EMPTY_OBJ,data:EMPTY_OBJ,props:EMPTY_OBJ,attrs:EMPTY_OBJ,slots:EMPTY_OBJ,refs:EMPTY_OBJ,setupState:EMPTY_OBJ,setupContext:null,suspense:f,suspenseId:f?f.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return w.ctx={_:w},w.root=a?a.root:w,w.emit=emit.bind(null,w),e.ce&&e.ce(w),w}let currentInstance=null;const getCurrentInstance=()=>currentInstance||currentRenderingInstance;let internalSetCurrentInstance,setInSSRSetupState;{const e=getGlobalThis(),a=(f,_)=>{let x;return(x=e[f])||(x=e[f]=[]),x.push(_),w=>{x.length>1?x.forEach(C=>C(w)):x[0](w)}};internalSetCurrentInstance=a("__VUE_INSTANCE_SETTERS__",f=>currentInstance=f),setInSSRSetupState=a("__VUE_SSR_SETTERS__",f=>isInSSRComponentSetup=f)}const setCurrentInstance=e=>{const a=currentInstance;return internalSetCurrentInstance(e),e.scope.on(),()=>{e.scope.off(),internalSetCurrentInstance(a)}},unsetCurrentInstance=()=>{currentInstance&&currentInstance.scope.off(),internalSetCurrentInstance(null)};function isStatefulComponent(e){return e.vnode.shapeFlag&4}let isInSSRComponentSetup=!1;function setupComponent(e,a=!1,f=!1){a&&setInSSRSetupState(a);const{props:_,children:x}=e.vnode,w=isStatefulComponent(e);initProps(e,_,w,a),initSlots(e,x,f||a);const C=w?setupStatefulComponent(e,a):void 0;return a&&setInSSRSetupState(!1),C}function setupStatefulComponent(e,a){const f=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,PublicInstanceProxyHandlers);const{setup:_}=f;if(_){pauseTracking();const x=e.setupContext=_.length>1?createSetupContext(e):null,w=setCurrentInstance(e),C=callWithErrorHandling(_,e,0,[e.props,x]),P=isPromise(C);if(resetTracking(),w(),(P||e.sp)&&!isAsyncWrapper(e)&&markAsyncBoundary(e),P){if(C.then(unsetCurrentInstance,unsetCurrentInstance),a)return C.then(E=>{handleSetupResult(e,E)}).catch(E=>{handleError(E,e,0)});e.asyncDep=C}else handleSetupResult(e,C)}else finishComponentSetup(e)}function handleSetupResult(e,a,f){isFunction(a)?e.type.__ssrInlineRender?e.ssrRender=a:e.render=a:isObject$3(a)&&(e.setupState=proxyRefs(a)),finishComponentSetup(e)}function finishComponentSetup(e,a,f){const _=e.type;e.render||(e.render=_.render||NOOP);{const x=setCurrentInstance(e);pauseTracking();try{applyOptions(e)}finally{resetTracking(),x()}}}const attrsProxyHandlers={get(e,a){return track(e,"get",""),e[a]}};function createSetupContext(e){const a=f=>{e.exposed=f||{}};return{attrs:new Proxy(e.attrs,attrsProxyHandlers),slots:e.slots,emit:e.emit,expose:a}}function getComponentPublicInstance(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(proxyRefs(markRaw(e.exposed)),{get(a,f){if(f in a)return a[f];if(f in publicPropertiesMap)return publicPropertiesMap[f](e)},has(a,f){return f in a||f in publicPropertiesMap}})):e.proxy}const classifyRE=/(?:^|[-_])\w/g,classify=e=>e.replace(classifyRE,a=>a.toUpperCase()).replace(/[-_]/g,"");function getComponentName(e,a=!0){return isFunction(e)?e.displayName||e.name:e.name||a&&e.__name}function formatComponentName(e,a,f=!1){let _=getComponentName(a);if(!_&&a.__file){const x=a.__file.match(/([^/\\]+)\.\w+$/);x&&(_=x[1])}if(!_&&e){const x=w=>{for(const C in w)if(w[C]===a)return C};_=x(e.components)||e.parent&&x(e.parent.type.components)||x(e.appContext.components)}return _?classify(_):f?"App":"Anonymous"}function isClassComponent(e){return isFunction(e)&&"__vccOpts"in e}const computed=(e,a)=>computed$1(e,a,isInSSRComponentSetup);function h(e,a,f){try{setBlockTracking(-1);const _=arguments.length;return _===2?isObject$3(a)&&!isArray$1(a)?isVNode(a)?createVNode(e,null,[a]):createVNode(e,a):createVNode(e,null,a):(_>3?f=Array.prototype.slice.call(arguments,2):_===3&&isVNode(f)&&(f=[f]),createVNode(e,a,f))}finally{setBlockTracking(1)}}const version="3.5.26";let policy;const tt=typeof window<"u"&&window.trustedTypes;if(tt)try{policy=tt.createPolicy("vue",{createHTML:e=>e})}catch{}const unsafeToTrustedHTML=policy?e=>policy.createHTML(e):e=>e,svgNS="http://www.w3.org/2000/svg",mathmlNS="http://www.w3.org/1998/Math/MathML",doc=typeof document<"u"?document:null,templateContainer=doc&&doc.createElement("template"),nodeOps={insert:(e,a,f)=>{a.insertBefore(e,f||null)},remove:e=>{const a=e.parentNode;a&&a.removeChild(e)},createElement:(e,a,f,_)=>{const x=a==="svg"?doc.createElementNS(svgNS,e):a==="mathml"?doc.createElementNS(mathmlNS,e):f?doc.createElement(e,{is:f}):doc.createElement(e);return e==="select"&&_&&_.multiple!=null&&x.setAttribute("multiple",_.multiple),x},createText:e=>doc.createTextNode(e),createComment:e=>doc.createComment(e),setText:(e,a)=>{e.nodeValue=a},setElementText:(e,a)=>{e.textContent=a},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>doc.querySelector(e),setScopeId(e,a){e.setAttribute(a,"")},insertStaticContent(e,a,f,_,x,w){const C=f?f.previousSibling:a.lastChild;if(x&&(x===w||x.nextSibling))for(;a.insertBefore(x.cloneNode(!0),f),!(x===w||!(x=x.nextSibling)););else{templateContainer.innerHTML=unsafeToTrustedHTML(_==="svg"?`<svg>${e}</svg>`:_==="mathml"?`<math>${e}</math>`:e);const P=templateContainer.content;if(_==="svg"||_==="mathml"){const E=P.firstChild;for(;E.firstChild;)P.appendChild(E.firstChild);P.removeChild(E)}a.insertBefore(P,f)}return[C?C.nextSibling:a.firstChild,f?f.previousSibling:a.lastChild]}},TRANSITION="transition",ANIMATION="animation",vtcKey=Symbol("_vtc"),DOMTransitionPropsValidators={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},TransitionPropsValidators=extend$3({},BaseTransitionPropsValidators,DOMTransitionPropsValidators),decorate$1=e=>(e.displayName="Transition",e.props=TransitionPropsValidators,e),Transition=decorate$1((e,{slots:a})=>h(BaseTransition,resolveTransitionProps(e),a)),callHook=(e,a=[])=>{isArray$1(e)?e.forEach(f=>f(...a)):e&&e(...a)},hasExplicitCallback=e=>e?isArray$1(e)?e.some(a=>a.length>1):e.length>1:!1;function resolveTransitionProps(e){const a={};for(const Sn in e)Sn in DOMTransitionPropsValidators||(a[Sn]=e[Sn]);if(e.css===!1)return a;const{name:f="v",type:_,duration:x,enterFromClass:w=`${f}-enter-from`,enterActiveClass:C=`${f}-enter-active`,enterToClass:P=`${f}-enter-to`,appearFromClass:E=w,appearActiveClass:D=C,appearToClass:B=P,leaveFromClass:z=`${f}-leave-from`,leaveActiveClass:J=`${f}-leave-active`,leaveToClass:Y=`${f}-leave-to`}=e,X=normalizeDuration(x),tn=X&&X[0],pn=X&&X[1],{onBeforeEnter:un,onEnter:rn,onEnterCancelled:cn,onLeave:gn,onLeaveCancelled:dn,onBeforeAppear:Mn=un,onAppear:Tn=rn,onAppearCancelled:ln=cn}=a,wn=(Sn,Bn,Fn,Un)=>{Sn._enterCancelled=Un,removeTransitionClass(Sn,Bn?B:P),removeTransitionClass(Sn,Bn?D:C),Fn&&Fn()},En=(Sn,Bn)=>{Sn._isLeaving=!1,removeTransitionClass(Sn,z),removeTransitionClass(Sn,Y),removeTransitionClass(Sn,J),Bn&&Bn()},An=Sn=>(Bn,Fn)=>{const Un=Sn?Tn:rn,Wn=()=>wn(Bn,Sn,Fn);callHook(Un,[Bn,Wn]),nextFrame(()=>{removeTransitionClass(Bn,Sn?E:w),addTransitionClass(Bn,Sn?B:P),hasExplicitCallback(Un)||whenTransitionEnds(Bn,_,tn,Wn)})};return extend$3(a,{onBeforeEnter(Sn){callHook(un,[Sn]),addTransitionClass(Sn,w),addTransitionClass(Sn,C)},onBeforeAppear(Sn){callHook(Mn,[Sn]),addTransitionClass(Sn,E),addTransitionClass(Sn,D)},onEnter:An(!1),onAppear:An(!0),onLeave(Sn,Bn){Sn._isLeaving=!0;const Fn=()=>En(Sn,Bn);addTransitionClass(Sn,z),Sn._enterCancelled?(addTransitionClass(Sn,J),forceReflow(Sn)):(forceReflow(Sn),addTransitionClass(Sn,J)),nextFrame(()=>{Sn._isLeaving&&(removeTransitionClass(Sn,z),addTransitionClass(Sn,Y),hasExplicitCallback(gn)||whenTransitionEnds(Sn,_,pn,Fn))}),callHook(gn,[Sn,Fn])},onEnterCancelled(Sn){wn(Sn,!1,void 0,!0),callHook(cn,[Sn])},onAppearCancelled(Sn){wn(Sn,!0,void 0,!0),callHook(ln,[Sn])},onLeaveCancelled(Sn){En(Sn),callHook(dn,[Sn])}})}function normalizeDuration(e){if(e==null)return null;if(isObject$3(e))return[NumberOf(e.enter),NumberOf(e.leave)];{const a=NumberOf(e);return[a,a]}}function NumberOf(e){return toNumber(e)}function addTransitionClass(e,a){a.split(/\s+/).forEach(f=>f&&e.classList.add(f)),(e[vtcKey]||(e[vtcKey]=new Set)).add(a)}function removeTransitionClass(e,a){a.split(/\s+/).forEach(_=>_&&e.classList.remove(_));const f=e[vtcKey];f&&(f.delete(a),f.size||(e[vtcKey]=void 0))}function nextFrame(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let endId=0;function whenTransitionEnds(e,a,f,_){const x=e._endId=++endId,w=()=>{x===e._endId&&_()};if(f!=null)return setTimeout(w,f);const{type:C,timeout:P,propCount:E}=getTransitionInfo(e,a);if(!C)return _();const D=C+"end";let B=0;const z=()=>{e.removeEventListener(D,J),w()},J=Y=>{Y.target===e&&++B>=E&&z()};setTimeout(()=>{B<E&&z()},P+1),e.addEventListener(D,J)}function getTransitionInfo(e,a){const f=window.getComputedStyle(e),_=X=>(f[X]||"").split(", "),x=_(`${TRANSITION}Delay`),w=_(`${TRANSITION}Duration`),C=getTimeout(x,w),P=_(`${ANIMATION}Delay`),E=_(`${ANIMATION}Duration`),D=getTimeout(P,E);let B=null,z=0,J=0;a===TRANSITION?C>0&&(B=TRANSITION,z=C,J=w.length):a===ANIMATION?D>0&&(B=ANIMATION,z=D,J=E.length):(z=Math.max(C,D),B=z>0?C>D?TRANSITION:ANIMATION:null,J=B?B===TRANSITION?w.length:E.length:0);const Y=B===TRANSITION&&/\b(?:transform|all)(?:,|$)/.test(_(`${TRANSITION}Property`).toString());return{type:B,timeout:z,propCount:J,hasTransform:Y}}function getTimeout(e,a){for(;e.length<a.length;)e=e.concat(e);return Math.max(...a.map((f,_)=>toMs(f)+toMs(e[_])))}function toMs(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function forceReflow(e){return(e?e.ownerDocument:document).body.offsetHeight}function patchClass(e,a,f){const _=e[vtcKey];_&&(a=(a?[a,..._]:[..._]).join(" ")),a==null?e.removeAttribute("class"):f?e.setAttribute("class",a):e.className=a}const vShowOriginalDisplay=Symbol("_vod"),vShowHidden=Symbol("_vsh"),CSS_VAR_TEXT=Symbol(""),displayRE=/(?:^|;)\s*display\s*:/;function patchStyle(e,a,f){const _=e.style,x=isString(f);let w=!1;if(f&&!x){if(a)if(isString(a))for(const C of a.split(";")){const P=C.slice(0,C.indexOf(":")).trim();f[P]==null&&setStyle(_,P,"")}else for(const C in a)f[C]==null&&setStyle(_,C,"");for(const C in f)C==="display"&&(w=!0),setStyle(_,C,f[C])}else if(x){if(a!==f){const C=_[CSS_VAR_TEXT];C&&(f+=";"+C),_.cssText=f,w=displayRE.test(f)}}else a&&e.removeAttribute("style");vShowOriginalDisplay in e&&(e[vShowOriginalDisplay]=w?_.display:"",e[vShowHidden]&&(_.display="none"))}const importantRE=/\s*!important$/;function setStyle(e,a,f){if(isArray$1(f))f.forEach(_=>setStyle(e,a,_));else if(f==null&&(f=""),a.startsWith("--"))e.setProperty(a,f);else{const _=autoPrefix(e,a);importantRE.test(f)?e.setProperty(hyphenate(_),f.replace(importantRE,""),"important"):e[_]=f}}const prefixes=["Webkit","Moz","ms"],prefixCache={};function autoPrefix(e,a){const f=prefixCache[a];if(f)return f;let _=camelize(a);if(_!=="filter"&&_ in e)return prefixCache[a]=_;_=capitalize(_);for(let x=0;x<prefixes.length;x++){const w=prefixes[x]+_;if(w in e)return prefixCache[a]=w}return a}const xlinkNS="http://www.w3.org/1999/xlink";function patchAttr(e,a,f,_,x,w=isSpecialBooleanAttr(a)){_&&a.startsWith("xlink:")?f==null?e.removeAttributeNS(xlinkNS,a.slice(6,a.length)):e.setAttributeNS(xlinkNS,a,f):f==null||w&&!includeBooleanAttr(f)?e.removeAttribute(a):e.setAttribute(a,w?"":isSymbol(f)?String(f):f)}function patchDOMProp(e,a,f,_,x){if(a==="innerHTML"||a==="textContent"){f!=null&&(e[a]=a==="innerHTML"?unsafeToTrustedHTML(f):f);return}const w=e.tagName;if(a==="value"&&w!=="PROGRESS"&&!w.includes("-")){const P=w==="OPTION"?e.getAttribute("value")||"":e.value,E=f==null?e.type==="checkbox"?"on":"":String(f);(P!==E||!("_value"in e))&&(e.value=E),f==null&&e.removeAttribute(a),e._value=f;return}let C=!1;if(f===""||f==null){const P=typeof e[a];P==="boolean"?f=includeBooleanAttr(f):f==null&&P==="string"?(f="",C=!0):P==="number"&&(f=0,C=!0)}try{e[a]=f}catch{}C&&e.removeAttribute(x||a)}function addEventListener(e,a,f,_){e.addEventListener(a,f,_)}function removeEventListener(e,a,f,_){e.removeEventListener(a,f,_)}const veiKey=Symbol("_vei");function patchEvent(e,a,f,_,x=null){const w=e[veiKey]||(e[veiKey]={}),C=w[a];if(_&&C)C.value=_;else{const[P,E]=parseName(a);if(_){const D=w[a]=createInvoker(_,x);addEventListener(e,P,D,E)}else C&&(removeEventListener(e,P,C,E),w[a]=void 0)}}const optionsModifierRE=/(?:Once|Passive|Capture)$/;function parseName(e){let a;if(optionsModifierRE.test(e)){a={};let _;for(;_=e.match(optionsModifierRE);)e=e.slice(0,e.length-_[0].length),a[_[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):hyphenate(e.slice(2)),a]}let cachedNow=0;const p=Promise.resolve(),getNow=()=>cachedNow||(p.then(()=>cachedNow=0),cachedNow=Date.now());function createInvoker(e,a){const f=_=>{if(!_._vts)_._vts=Date.now();else if(_._vts<=f.attached)return;callWithAsyncErrorHandling(patchStopImmediatePropagation(_,f.value),a,5,[_])};return f.value=e,f.attached=getNow(),f}function patchStopImmediatePropagation(e,a){if(isArray$1(a)){const f=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{f.call(e),e._stopped=!0},a.map(_=>x=>!x._stopped&&_&&_(x))}else return a}const isNativeOn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,patchProp=(e,a,f,_,x,w)=>{const C=x==="svg";a==="class"?patchClass(e,_,C):a==="style"?patchStyle(e,f,_):isOn(a)?isModelListener(a)||patchEvent(e,a,f,_,w):(a[0]==="."?(a=a.slice(1),!0):a[0]==="^"?(a=a.slice(1),!1):shouldSetAsProp(e,a,_,C))?(patchDOMProp(e,a,_),!e.tagName.includes("-")&&(a==="value"||a==="checked"||a==="selected")&&patchAttr(e,a,_,C,w,a!=="value")):e._isVueCE&&(/[A-Z]/.test(a)||!isString(_))?patchDOMProp(e,camelize(a),_,w,a):(a==="true-value"?e._trueValue=_:a==="false-value"&&(e._falseValue=_),patchAttr(e,a,_,C))};function shouldSetAsProp(e,a,f,_){if(_)return!!(a==="innerHTML"||a==="textContent"||a in e&&isNativeOn(a)&&isFunction(f));if(a==="spellcheck"||a==="draggable"||a==="translate"||a==="autocorrect"||a==="sandbox"&&e.tagName==="IFRAME"||a==="form"||a==="list"&&e.tagName==="INPUT"||a==="type"&&e.tagName==="TEXTAREA")return!1;if(a==="width"||a==="height"){const x=e.tagName;if(x==="IMG"||x==="VIDEO"||x==="CANVAS"||x==="SOURCE")return!1}return isNativeOn(a)&&isString(f)?!1:a in e}const rendererOptions=extend$3({patchProp},nodeOps);let renderer;function ensureRenderer(){return renderer||(renderer=createRenderer(rendererOptions))}const createApp=((...e)=>{const a=ensureRenderer().createApp(...e),{mount:f}=a;return a.mount=_=>{const x=normalizeContainer(_);if(!x)return;const w=a._component;!isFunction(w)&&!w.render&&!w.template&&(w.template=x.innerHTML),x.nodeType===1&&(x.textContent="");const C=f(x,!1,resolveRootNamespace(x));return x instanceof Element&&(x.removeAttribute("v-cloak"),x.setAttribute("data-v-app","")),C},a});function resolveRootNamespace(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function normalizeContainer(e){return isString(e)?document.querySelector(e):e}let activePinia;const setActivePinia=e=>activePinia=e,piniaSymbol=Symbol();function isPlainObject(e){return e&&typeof e=="object"&&Object.prototype.toString.call(e)==="[object Object]"&&typeof e.toJSON!="function"}var MutationType;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(MutationType||(MutationType={}));function createPinia(){const e=effectScope(!0),a=e.run(()=>ref({}));let f=[],_=[];const x=markRaw({install(w){setActivePinia(x),x._a=w,w.provide(piniaSymbol,x),w.config.globalProperties.$pinia=x,_.forEach(C=>f.push(C)),_=[]},use(w){return this._a?f.push(w):_.push(w),this},_p:f,_a:null,_e:e,_s:new Map,state:a});return x}const noop$1=()=>{};function addSubscription(e,a,f,_=noop$1){e.add(a);const x=()=>{e.delete(a)&&_()};return!f&&getCurrentScope()&&onScopeDispose(x),x}function triggerSubscriptions(e,...a){e.forEach(f=>{f(...a)})}const fallbackRunWithContext=e=>e(),ACTION_MARKER=Symbol(),ACTION_NAME=Symbol();function mergeReactiveObjects(e,a){e instanceof Map&&a instanceof Map?a.forEach((f,_)=>e.set(_,f)):e instanceof Set&&a instanceof Set&&a.forEach(e.add,e);for(const f in a){if(!a.hasOwnProperty(f))continue;const _=a[f],x=e[f];isPlainObject(x)&&isPlainObject(_)&&e.hasOwnProperty(f)&&!isRef(_)&&!isReactive(_)?e[f]=mergeReactiveObjects(x,_):e[f]=_}return e}const skipHydrateSymbol=Symbol();function shouldHydrate(e){return!isPlainObject(e)||!Object.prototype.hasOwnProperty.call(e,skipHydrateSymbol)}const{assign:assign$1}=Object;function isComputed(e){return!!(isRef(e)&&e.effect)}function createOptionsStore(e,a,f,_){const{state:x,actions:w,getters:C}=a,P=f.state.value[e];let E;function D(){P||(f.state.value[e]=x?x():{});const B=toRefs(f.state.value[e]);return assign$1(B,w,Object.keys(C||{}).reduce((z,J)=>(z[J]=markRaw(computed(()=>{setActivePinia(f);const Y=f._s.get(e);return C[J].call(Y,Y)})),z),{}))}return E=createSetupStore(e,D,a,f,_,!0),E}function createSetupStore(e,a,f={},_,x,w){let C;const P=assign$1({actions:{}},f),E={deep:!0};let D,B,z=new Set,J=new Set,Y;const X=_.state.value[e];!w&&!X&&(_.state.value[e]={}),ref({});let tn;function pn(ln){let wn;D=B=!1,typeof ln=="function"?(ln(_.state.value[e]),wn={type:MutationType.patchFunction,storeId:e,events:Y}):(mergeReactiveObjects(_.state.value[e],ln),wn={type:MutationType.patchObject,payload:ln,storeId:e,events:Y});const En=tn=Symbol();nextTick$1().then(()=>{tn===En&&(D=!0)}),B=!0,triggerSubscriptions(z,wn,_.state.value[e])}const un=w?function(){const{state:wn}=f,En=wn?wn():{};this.$patch(An=>{assign$1(An,En)})}:noop$1;function rn(){C.stop(),z.clear(),J.clear(),_._s.delete(e)}const cn=(ln,wn="")=>{if(ACTION_MARKER in ln)return ln[ACTION_NAME]=wn,ln;const En=function(){setActivePinia(_);const An=Array.from(arguments),Sn=new Set,Bn=new Set;function Fn(Pn){Sn.add(Pn)}function Un(Pn){Bn.add(Pn)}triggerSubscriptions(J,{args:An,name:En[ACTION_NAME],store:dn,after:Fn,onError:Un});let Wn;try{Wn=ln.apply(this&&this.$id===e?this:dn,An)}catch(Pn){throw triggerSubscriptions(Bn,Pn),Pn}return Wn instanceof Promise?Wn.then(Pn=>(triggerSubscriptions(Sn,Pn),Pn)).catch(Pn=>(triggerSubscriptions(Bn,Pn),Promise.reject(Pn))):(triggerSubscriptions(Sn,Wn),Wn)};return En[ACTION_MARKER]=!0,En[ACTION_NAME]=wn,En},gn={_p:_,$id:e,$onAction:addSubscription.bind(null,J),$patch:pn,$reset:un,$subscribe(ln,wn={}){const En=addSubscription(z,ln,wn.detached,()=>An()),An=C.run(()=>watch(()=>_.state.value[e],Sn=>{(wn.flush==="sync"?B:D)&&ln({storeId:e,type:MutationType.direct,events:Y},Sn)},assign$1({},E,wn)));return En},$dispose:rn},dn=reactive(gn);_._s.set(e,dn);const Tn=(_._a&&_._a.runWithContext||fallbackRunWithContext)(()=>_._e.run(()=>(C=effectScope()).run(()=>a({action:cn}))));for(const ln in Tn){const wn=Tn[ln];if(isRef(wn)&&!isComputed(wn)||isReactive(wn))w||(X&&shouldHydrate(wn)&&(isRef(wn)?wn.value=X[ln]:mergeReactiveObjects(wn,X[ln])),_.state.value[e][ln]=wn);else if(typeof wn=="function"){const En=cn(wn,ln);Tn[ln]=En,P.actions[ln]=wn}}return assign$1(dn,Tn),assign$1(toRaw(dn),Tn),Object.defineProperty(dn,"$state",{get:()=>_.state.value[e],set:ln=>{pn(wn=>{assign$1(wn,ln)})}}),_._p.forEach(ln=>{assign$1(dn,C.run(()=>ln({store:dn,app:_._a,pinia:_,options:P})))}),X&&w&&f.hydrate&&f.hydrate(dn.$state,X),D=!0,B=!0,dn}function defineStore(e,a,f){let _;const x=typeof a=="function";_=x?f:a;function w(C,P){const E=hasInjectionContext();return C=C||(E?inject(piniaSymbol,null):null),C&&setActivePinia(C),C=activePinia,C._s.has(e)||(x?createSetupStore(e,a,_,C):createOptionsStore(e,_,C)),C._s.get(e)}return w.$id=e,w}function getDefaultExportFromCjs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function getAugmentedNamespace(e){if(Object.prototype.hasOwnProperty.call(e,"__esModule"))return e;var a=e.default;if(typeof a=="function"){var f=function _(){var x=!1;try{x=this instanceof _}catch{}return x?Reflect.construct(a,arguments,this.constructor):a.apply(this,arguments)};f.prototype=a.prototype}else f={};return Object.defineProperty(f,"__esModule",{value:!0}),Object.keys(e).forEach(function(_){var x=Object.getOwnPropertyDescriptor(e,_);Object.defineProperty(f,_,x.get?x:{enumerable:!0,get:function(){return e[_]}})}),f}var buffer={},base64Js={},hasRequiredBase64Js;function requireBase64Js(){if(hasRequiredBase64Js)return base64Js;hasRequiredBase64Js=1,base64Js.byteLength=P,base64Js.toByteArray=D,base64Js.fromByteArray=J;for(var e=[],a=[],f=typeof Uint8Array<"u"?Uint8Array:Array,_="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",x=0,w=_.length;x<w;++x)e[x]=_[x],a[_.charCodeAt(x)]=x;a[45]=62,a[95]=63;function C(Y){var X=Y.length;if(X%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var tn=Y.indexOf("=");tn===-1&&(tn=X);var pn=tn===X?0:4-tn%4;return[tn,pn]}function P(Y){var X=C(Y),tn=X[0],pn=X[1];return(tn+pn)*3/4-pn}function E(Y,X,tn){return(X+tn)*3/4-tn}function D(Y){var X,tn=C(Y),pn=tn[0],un=tn[1],rn=new f(E(Y,pn,un)),cn=0,gn=un>0?pn-4:pn,dn;for(dn=0;dn<gn;dn+=4)X=a[Y.charCodeAt(dn)]<<18|a[Y.charCodeAt(dn+1)]<<12|a[Y.charCodeAt(dn+2)]<<6|a[Y.charCodeAt(dn+3)],rn[cn++]=X>>16&255,rn[cn++]=X>>8&255,rn[cn++]=X&255;return un===2&&(X=a[Y.charCodeAt(dn)]<<2|a[Y.charCodeAt(dn+1)]>>4,rn[cn++]=X&255),un===1&&(X=a[Y.charCodeAt(dn)]<<10|a[Y.charCodeAt(dn+1)]<<4|a[Y.charCodeAt(dn+2)]>>2,rn[cn++]=X>>8&255,rn[cn++]=X&255),rn}function B(Y){return e[Y>>18&63]+e[Y>>12&63]+e[Y>>6&63]+e[Y&63]}function z(Y,X,tn){for(var pn,un=[],rn=X;rn<tn;rn+=3)pn=(Y[rn]<<16&16711680)+(Y[rn+1]<<8&65280)+(Y[rn+2]&255),un.push(B(pn));return un.join("")}function J(Y){for(var X,tn=Y.length,pn=tn%3,un=[],rn=16383,cn=0,gn=tn-pn;cn<gn;cn+=rn)un.push(z(Y,cn,cn+rn>gn?gn:cn+rn));return pn===1?(X=Y[tn-1],un.push(e[X>>2]+e[X<<4&63]+"==")):pn===2&&(X=(Y[tn-2]<<8)+Y[tn-1],un.push(e[X>>10]+e[X>>4&63]+e[X<<2&63]+"=")),un.join("")}return base64Js}var ieee754={};var hasRequiredIeee754;function requireIeee754(){return hasRequiredIeee754||(hasRequiredIeee754=1,ieee754.read=function(e,a,f,_,x){var w,C,P=x*8-_-1,E=(1<<P)-1,D=E>>1,B=-7,z=f?x-1:0,J=f?-1:1,Y=e[a+z];for(z+=J,w=Y&(1<<-B)-1,Y>>=-B,B+=P;B>0;w=w*256+e[a+z],z+=J,B-=8);for(C=w&(1<<-B)-1,w>>=-B,B+=_;B>0;C=C*256+e[a+z],z+=J,B-=8);if(w===0)w=1-D;else{if(w===E)return C?NaN:(Y?-1:1)*(1/0);C=C+Math.pow(2,_),w=w-D}return(Y?-1:1)*C*Math.pow(2,w-_)},ieee754.write=function(e,a,f,_,x,w){var C,P,E,D=w*8-x-1,B=(1<<D)-1,z=B>>1,J=x===23?Math.pow(2,-24)-Math.pow(2,-77):0,Y=_?0:w-1,X=_?1:-1,tn=a<0||a===0&&1/a<0?1:0;for(a=Math.abs(a),isNaN(a)||a===1/0?(P=isNaN(a)?1:0,C=B):(C=Math.floor(Math.log(a)/Math.LN2),a*(E=Math.pow(2,-C))<1&&(C--,E*=2),C+z>=1?a+=J/E:a+=J*Math.pow(2,1-z),a*E>=2&&(C++,E/=2),C+z>=B?(P=0,C=B):C+z>=1?(P=(a*E-1)*Math.pow(2,x),C=C+z):(P=a*Math.pow(2,z-1)*Math.pow(2,x),C=0));x>=8;e[f+Y]=P&255,Y+=X,P/=256,x-=8);for(C=C<<x|P,D+=x;D>0;e[f+Y]=C&255,Y+=X,C/=256,D-=8);e[f+Y-X]|=tn*128}),ieee754}var hasRequiredBuffer;function requireBuffer(){return hasRequiredBuffer||(hasRequiredBuffer=1,(function(e){const a=requireBase64Js(),f=requireIeee754(),_=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=P,e.SlowBuffer=rn,e.INSPECT_MAX_BYTES=50;const x=2147483647;e.kMaxLength=x,P.TYPED_ARRAY_SUPPORT=w(),!P.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function w(){try{const G=new Uint8Array(1),I={foo:function(){return 42}};return Object.setPrototypeOf(I,Uint8Array.prototype),Object.setPrototypeOf(G,I),G.foo()===42}catch{return!1}}Object.defineProperty(P.prototype,"parent",{enumerable:!0,get:function(){if(P.isBuffer(this))return this.buffer}}),Object.defineProperty(P.prototype,"offset",{enumerable:!0,get:function(){if(P.isBuffer(this))return this.byteOffset}});function C(G){if(G>x)throw new RangeError('The value "'+G+'" is invalid for option "size"');const I=new Uint8Array(G);return Object.setPrototypeOf(I,P.prototype),I}function P(G,I,H){if(typeof G=="number"){if(typeof I=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return z(G)}return E(G,I,H)}P.poolSize=8192;function E(G,I,H){if(typeof G=="string")return J(G,I);if(ArrayBuffer.isView(G))return X(G);if(G==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof G);if(Ln(G,ArrayBuffer)||G&&Ln(G.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(Ln(G,SharedArrayBuffer)||G&&Ln(G.buffer,SharedArrayBuffer)))return tn(G,I,H);if(typeof G=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const q=G.valueOf&&G.valueOf();if(q!=null&&q!==G)return P.from(q,I,H);const K=pn(G);if(K)return K;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof G[Symbol.toPrimitive]=="function")return P.from(G[Symbol.toPrimitive]("string"),I,H);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof G)}P.from=function(G,I,H){return E(G,I,H)},Object.setPrototypeOf(P.prototype,Uint8Array.prototype),Object.setPrototypeOf(P,Uint8Array);function D(G){if(typeof G!="number")throw new TypeError('"size" argument must be of type number');if(G<0)throw new RangeError('The value "'+G+'" is invalid for option "size"')}function B(G,I,H){return D(G),G<=0?C(G):I!==void 0?typeof H=="string"?C(G).fill(I,H):C(G).fill(I):C(G)}P.alloc=function(G,I,H){return B(G,I,H)};function z(G){return D(G),C(G<0?0:un(G)|0)}P.allocUnsafe=function(G){return z(G)},P.allocUnsafeSlow=function(G){return z(G)};function J(G,I){if((typeof I!="string"||I==="")&&(I="utf8"),!P.isEncoding(I))throw new TypeError("Unknown encoding: "+I);const H=cn(G,I)|0;let q=C(H);const K=q.write(G,I);return K!==H&&(q=q.slice(0,K)),q}function Y(G){const I=G.length<0?0:un(G.length)|0,H=C(I);for(let q=0;q<I;q+=1)H[q]=G[q]&255;return H}function X(G){if(Ln(G,Uint8Array)){const I=new Uint8Array(G);return tn(I.buffer,I.byteOffset,I.byteLength)}return Y(G)}function tn(G,I,H){if(I<0||G.byteLength<I)throw new RangeError('"offset" is outside of buffer bounds');if(G.byteLength<I+(H||0))throw new RangeError('"length" is outside of buffer bounds');let q;return I===void 0&&H===void 0?q=new Uint8Array(G):H===void 0?q=new Uint8Array(G,I):q=new Uint8Array(G,I,H),Object.setPrototypeOf(q,P.prototype),q}function pn(G){if(P.isBuffer(G)){const I=un(G.length)|0,H=C(I);return H.length===0||G.copy(H,0,0,I),H}if(G.length!==void 0)return typeof G.length!="number"||$n(G.length)?C(0):Y(G);if(G.type==="Buffer"&&Array.isArray(G.data))return Y(G.data)}function un(G){if(G>=x)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+x.toString(16)+" bytes");return G|0}function rn(G){return+G!=G&&(G=0),P.alloc(+G)}P.isBuffer=function(I){return I!=null&&I._isBuffer===!0&&I!==P.prototype},P.compare=function(I,H){if(Ln(I,Uint8Array)&&(I=P.from(I,I.offset,I.byteLength)),Ln(H,Uint8Array)&&(H=P.from(H,H.offset,H.byteLength)),!P.isBuffer(I)||!P.isBuffer(H))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(I===H)return 0;let q=I.length,K=H.length;for(let Z=0,en=Math.min(q,K);Z<en;++Z)if(I[Z]!==H[Z]){q=I[Z],K=H[Z];break}return q<K?-1:K<q?1:0},P.isEncoding=function(I){switch(String(I).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},P.concat=function(I,H){if(!Array.isArray(I))throw new TypeError('"list" argument must be an Array of Buffers');if(I.length===0)return P.alloc(0);let q;if(H===void 0)for(H=0,q=0;q<I.length;++q)H+=I[q].length;const K=P.allocUnsafe(H);let Z=0;for(q=0;q<I.length;++q){let en=I[q];if(Ln(en,Uint8Array))Z+en.length>K.length?(P.isBuffer(en)||(en=P.from(en)),en.copy(K,Z)):Uint8Array.prototype.set.call(K,en,Z);else if(P.isBuffer(en))en.copy(K,Z);else throw new TypeError('"list" argument must be an Array of Buffers');Z+=en.length}return K};function cn(G,I){if(P.isBuffer(G))return G.length;if(ArrayBuffer.isView(G)||Ln(G,ArrayBuffer))return G.byteLength;if(typeof G!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof G);const H=G.length,q=arguments.length>2&&arguments[2]===!0;if(!q&&H===0)return 0;let K=!1;for(;;)switch(I){case"ascii":case"latin1":case"binary":return H;case"utf8":case"utf-8":return xn(G).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return H*2;case"hex":return H>>>1;case"base64":return On(G).length;default:if(K)return q?-1:xn(G).length;I=(""+I).toLowerCase(),K=!0}}P.byteLength=cn;function gn(G,I,H){let q=!1;if((I===void 0||I<0)&&(I=0),I>this.length||((H===void 0||H>this.length)&&(H=this.length),H<=0)||(H>>>=0,I>>>=0,H<=I))return"";for(G||(G="utf8");;)switch(G){case"hex":return Gn(this,I,H);case"utf8":case"utf-8":return Fn(this,I,H);case"ascii":return Pn(this,I,H);case"latin1":case"binary":return hn(this,I,H);case"base64":return Bn(this,I,H);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Xn(this,I,H);default:if(q)throw new TypeError("Unknown encoding: "+G);G=(G+"").toLowerCase(),q=!0}}P.prototype._isBuffer=!0;function dn(G,I,H){const q=G[I];G[I]=G[H],G[H]=q}P.prototype.swap16=function(){const I=this.length;if(I%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let H=0;H<I;H+=2)dn(this,H,H+1);return this},P.prototype.swap32=function(){const I=this.length;if(I%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let H=0;H<I;H+=4)dn(this,H,H+3),dn(this,H+1,H+2);return this},P.prototype.swap64=function(){const I=this.length;if(I%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let H=0;H<I;H+=8)dn(this,H,H+7),dn(this,H+1,H+6),dn(this,H+2,H+5),dn(this,H+3,H+4);return this},P.prototype.toString=function(){const I=this.length;return I===0?"":arguments.length===0?Fn(this,0,I):gn.apply(this,arguments)},P.prototype.toLocaleString=P.prototype.toString,P.prototype.equals=function(I){if(!P.isBuffer(I))throw new TypeError("Argument must be a Buffer");return this===I?!0:P.compare(this,I)===0},P.prototype.inspect=function(){let I="";const H=e.INSPECT_MAX_BYTES;return I=this.toString("hex",0,H).replace(/(.{2})/g,"$1 ").trim(),this.length>H&&(I+=" ... "),"<Buffer "+I+">"},_&&(P.prototype[_]=P.prototype.inspect),P.prototype.compare=function(I,H,q,K,Z){if(Ln(I,Uint8Array)&&(I=P.from(I,I.offset,I.byteLength)),!P.isBuffer(I))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof I);if(H===void 0&&(H=0),q===void 0&&(q=I?I.length:0),K===void 0&&(K=0),Z===void 0&&(Z=this.length),H<0||q>I.length||K<0||Z>this.length)throw new RangeError("out of range index");if(K>=Z&&H>=q)return 0;if(K>=Z)return-1;if(H>=q)return 1;if(H>>>=0,q>>>=0,K>>>=0,Z>>>=0,this===I)return 0;let en=Z-K,mn=q-H;const _n=Math.min(en,mn),fn=this.slice(K,Z),Cn=I.slice(H,q);for(let vn=0;vn<_n;++vn)if(fn[vn]!==Cn[vn]){en=fn[vn],mn=Cn[vn];break}return en<mn?-1:mn<en?1:0};function Mn(G,I,H,q,K){if(G.length===0)return-1;if(typeof H=="string"?(q=H,H=0):H>2147483647?H=2147483647:H<-2147483648&&(H=-2147483648),H=+H,$n(H)&&(H=K?0:G.length-1),H<0&&(H=G.length+H),H>=G.length){if(K)return-1;H=G.length-1}else if(H<0)if(K)H=0;else return-1;if(typeof I=="string"&&(I=P.from(I,q)),P.isBuffer(I))return I.length===0?-1:Tn(G,I,H,q,K);if(typeof I=="number")return I=I&255,typeof Uint8Array.prototype.indexOf=="function"?K?Uint8Array.prototype.indexOf.call(G,I,H):Uint8Array.prototype.lastIndexOf.call(G,I,H):Tn(G,[I],H,q,K);throw new TypeError("val must be string, number or Buffer")}function Tn(G,I,H,q,K){let Z=1,en=G.length,mn=I.length;if(q!==void 0&&(q=String(q).toLowerCase(),q==="ucs2"||q==="ucs-2"||q==="utf16le"||q==="utf-16le")){if(G.length<2||I.length<2)return-1;Z=2,en/=2,mn/=2,H/=2}function _n(Cn,vn){return Z===1?Cn[vn]:Cn.readUInt16BE(vn*Z)}let fn;if(K){let Cn=-1;for(fn=H;fn<en;fn++)if(_n(G,fn)===_n(I,Cn===-1?0:fn-Cn)){if(Cn===-1&&(Cn=fn),fn-Cn+1===mn)return Cn*Z}else Cn!==-1&&(fn-=fn-Cn),Cn=-1}else for(H+mn>en&&(H=en-mn),fn=H;fn>=0;fn--){let Cn=!0;for(let vn=0;vn<mn;vn++)if(_n(G,fn+vn)!==_n(I,vn)){Cn=!1;break}if(Cn)return fn}return-1}P.prototype.includes=function(I,H,q){return this.indexOf(I,H,q)!==-1},P.prototype.indexOf=function(I,H,q){return Mn(this,I,H,q,!0)},P.prototype.lastIndexOf=function(I,H,q){return Mn(this,I,H,q,!1)};function ln(G,I,H,q){H=Number(H)||0;const K=G.length-H;q?(q=Number(q),q>K&&(q=K)):q=K;const Z=I.length;q>Z/2&&(q=Z/2);let en;for(en=0;en<q;++en){const mn=parseInt(I.substr(en*2,2),16);if($n(mn))return en;G[H+en]=mn}return en}function wn(G,I,H,q){return kn(xn(I,G.length-H),G,H,q)}function En(G,I,H,q){return kn(Rn(I),G,H,q)}function An(G,I,H,q){return kn(On(I),G,H,q)}function Sn(G,I,H,q){return kn(In(I,G.length-H),G,H,q)}P.prototype.write=function(I,H,q,K){if(H===void 0)K="utf8",q=this.length,H=0;else if(q===void 0&&typeof H=="string")K=H,q=this.length,H=0;else if(isFinite(H))H=H>>>0,isFinite(q)?(q=q>>>0,K===void 0&&(K="utf8")):(K=q,q=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const Z=this.length-H;if((q===void 0||q>Z)&&(q=Z),I.length>0&&(q<0||H<0)||H>this.length)throw new RangeError("Attempt to write outside buffer bounds");K||(K="utf8");let en=!1;for(;;)switch(K){case"hex":return ln(this,I,H,q);case"utf8":case"utf-8":return wn(this,I,H,q);case"ascii":case"latin1":case"binary":return En(this,I,H,q);case"base64":return An(this,I,H,q);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Sn(this,I,H,q);default:if(en)throw new TypeError("Unknown encoding: "+K);K=(""+K).toLowerCase(),en=!0}},P.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function Bn(G,I,H){return I===0&&H===G.length?a.fromByteArray(G):a.fromByteArray(G.slice(I,H))}function Fn(G,I,H){H=Math.min(G.length,H);const q=[];let K=I;for(;K<H;){const Z=G[K];let en=null,mn=Z>239?4:Z>223?3:Z>191?2:1;if(K+mn<=H){let _n,fn,Cn,vn;switch(mn){case 1:Z<128&&(en=Z);break;case 2:_n=G[K+1],(_n&192)===128&&(vn=(Z&31)<<6|_n&63,vn>127&&(en=vn));break;case 3:_n=G[K+1],fn=G[K+2],(_n&192)===128&&(fn&192)===128&&(vn=(Z&15)<<12|(_n&63)<<6|fn&63,vn>2047&&(vn<55296||vn>57343)&&(en=vn));break;case 4:_n=G[K+1],fn=G[K+2],Cn=G[K+3],(_n&192)===128&&(fn&192)===128&&(Cn&192)===128&&(vn=(Z&15)<<18|(_n&63)<<12|(fn&63)<<6|Cn&63,vn>65535&&vn<1114112&&(en=vn))}}en===null?(en=65533,mn=1):en>65535&&(en-=65536,q.push(en>>>10&1023|55296),en=56320|en&1023),q.push(en),K+=mn}return Wn(q)}const Un=4096;function Wn(G){const I=G.length;if(I<=Un)return String.fromCharCode.apply(String,G);let H="",q=0;for(;q<I;)H+=String.fromCharCode.apply(String,G.slice(q,q+=Un));return H}function Pn(G,I,H){let q="";H=Math.min(G.length,H);for(let K=I;K<H;++K)q+=String.fromCharCode(G[K]&127);return q}function hn(G,I,H){let q="";H=Math.min(G.length,H);for(let K=I;K<H;++K)q+=String.fromCharCode(G[K]);return q}function Gn(G,I,H){const q=G.length;(!I||I<0)&&(I=0),(!H||H<0||H>q)&&(H=q);let K="";for(let Z=I;Z<H;++Z)K+=Hn[G[Z]];return K}function Xn(G,I,H){const q=G.slice(I,H);let K="";for(let Z=0;Z<q.length-1;Z+=2)K+=String.fromCharCode(q[Z]+q[Z+1]*256);return K}P.prototype.slice=function(I,H){const q=this.length;I=~~I,H=H===void 0?q:~~H,I<0?(I+=q,I<0&&(I=0)):I>q&&(I=q),H<0?(H+=q,H<0&&(H=0)):H>q&&(H=q),H<I&&(H=I);const K=this.subarray(I,H);return Object.setPrototypeOf(K,P.prototype),K};function qn(G,I,H){if(G%1!==0||G<0)throw new RangeError("offset is not uint");if(G+I>H)throw new RangeError("Trying to access beyond buffer length")}P.prototype.readUintLE=P.prototype.readUIntLE=function(I,H,q){I=I>>>0,H=H>>>0,q||qn(I,H,this.length);let K=this[I],Z=1,en=0;for(;++en<H&&(Z*=256);)K+=this[I+en]*Z;return K},P.prototype.readUintBE=P.prototype.readUIntBE=function(I,H,q){I=I>>>0,H=H>>>0,q||qn(I,H,this.length);let K=this[I+--H],Z=1;for(;H>0&&(Z*=256);)K+=this[I+--H]*Z;return K},P.prototype.readUint8=P.prototype.readUInt8=function(I,H){return I=I>>>0,H||qn(I,1,this.length),this[I]},P.prototype.readUint16LE=P.prototype.readUInt16LE=function(I,H){return I=I>>>0,H||qn(I,2,this.length),this[I]|this[I+1]<<8},P.prototype.readUint16BE=P.prototype.readUInt16BE=function(I,H){return I=I>>>0,H||qn(I,2,this.length),this[I]<<8|this[I+1]},P.prototype.readUint32LE=P.prototype.readUInt32LE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),(this[I]|this[I+1]<<8|this[I+2]<<16)+this[I+3]*16777216},P.prototype.readUint32BE=P.prototype.readUInt32BE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),this[I]*16777216+(this[I+1]<<16|this[I+2]<<8|this[I+3])},P.prototype.readBigUInt64LE=M(function(I){I=I>>>0,on(I,"offset");const H=this[I],q=this[I+7];(H===void 0||q===void 0)&&an(I,this.length-8);const K=H+this[++I]*2**8+this[++I]*2**16+this[++I]*2**24,Z=this[++I]+this[++I]*2**8+this[++I]*2**16+q*2**24;return BigInt(K)+(BigInt(Z)<<BigInt(32))}),P.prototype.readBigUInt64BE=M(function(I){I=I>>>0,on(I,"offset");const H=this[I],q=this[I+7];(H===void 0||q===void 0)&&an(I,this.length-8);const K=H*2**24+this[++I]*2**16+this[++I]*2**8+this[++I],Z=this[++I]*2**24+this[++I]*2**16+this[++I]*2**8+q;return(BigInt(K)<<BigInt(32))+BigInt(Z)}),P.prototype.readIntLE=function(I,H,q){I=I>>>0,H=H>>>0,q||qn(I,H,this.length);let K=this[I],Z=1,en=0;for(;++en<H&&(Z*=256);)K+=this[I+en]*Z;return Z*=128,K>=Z&&(K-=Math.pow(2,8*H)),K},P.prototype.readIntBE=function(I,H,q){I=I>>>0,H=H>>>0,q||qn(I,H,this.length);let K=H,Z=1,en=this[I+--K];for(;K>0&&(Z*=256);)en+=this[I+--K]*Z;return Z*=128,en>=Z&&(en-=Math.pow(2,8*H)),en},P.prototype.readInt8=function(I,H){return I=I>>>0,H||qn(I,1,this.length),this[I]&128?(255-this[I]+1)*-1:this[I]},P.prototype.readInt16LE=function(I,H){I=I>>>0,H||qn(I,2,this.length);const q=this[I]|this[I+1]<<8;return q&32768?q|4294901760:q},P.prototype.readInt16BE=function(I,H){I=I>>>0,H||qn(I,2,this.length);const q=this[I+1]|this[I]<<8;return q&32768?q|4294901760:q},P.prototype.readInt32LE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),this[I]|this[I+1]<<8|this[I+2]<<16|this[I+3]<<24},P.prototype.readInt32BE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),this[I]<<24|this[I+1]<<16|this[I+2]<<8|this[I+3]},P.prototype.readBigInt64LE=M(function(I){I=I>>>0,on(I,"offset");const H=this[I],q=this[I+7];(H===void 0||q===void 0)&&an(I,this.length-8);const K=this[I+4]+this[I+5]*2**8+this[I+6]*2**16+(q<<24);return(BigInt(K)<<BigInt(32))+BigInt(H+this[++I]*2**8+this[++I]*2**16+this[++I]*2**24)}),P.prototype.readBigInt64BE=M(function(I){I=I>>>0,on(I,"offset");const H=this[I],q=this[I+7];(H===void 0||q===void 0)&&an(I,this.length-8);const K=(H<<24)+this[++I]*2**16+this[++I]*2**8+this[++I];return(BigInt(K)<<BigInt(32))+BigInt(this[++I]*2**24+this[++I]*2**16+this[++I]*2**8+q)}),P.prototype.readFloatLE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),f.read(this,I,!0,23,4)},P.prototype.readFloatBE=function(I,H){return I=I>>>0,H||qn(I,4,this.length),f.read(this,I,!1,23,4)},P.prototype.readDoubleLE=function(I,H){return I=I>>>0,H||qn(I,8,this.length),f.read(this,I,!0,52,8)},P.prototype.readDoubleBE=function(I,H){return I=I>>>0,H||qn(I,8,this.length),f.read(this,I,!1,52,8)};function Jn(G,I,H,q,K,Z){if(!P.isBuffer(G))throw new TypeError('"buffer" argument must be a Buffer instance');if(I>K||I<Z)throw new RangeError('"value" argument is out of bounds');if(H+q>G.length)throw new RangeError("Index out of range")}P.prototype.writeUintLE=P.prototype.writeUIntLE=function(I,H,q,K){if(I=+I,H=H>>>0,q=q>>>0,!K){const mn=Math.pow(2,8*q)-1;Jn(this,I,H,q,mn,0)}let Z=1,en=0;for(this[H]=I&255;++en<q&&(Z*=256);)this[H+en]=I/Z&255;return H+q},P.prototype.writeUintBE=P.prototype.writeUIntBE=function(I,H,q,K){if(I=+I,H=H>>>0,q=q>>>0,!K){const mn=Math.pow(2,8*q)-1;Jn(this,I,H,q,mn,0)}let Z=q-1,en=1;for(this[H+Z]=I&255;--Z>=0&&(en*=256);)this[H+Z]=I/en&255;return H+q},P.prototype.writeUint8=P.prototype.writeUInt8=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,1,255,0),this[H]=I&255,H+1},P.prototype.writeUint16LE=P.prototype.writeUInt16LE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,2,65535,0),this[H]=I&255,this[H+1]=I>>>8,H+2},P.prototype.writeUint16BE=P.prototype.writeUInt16BE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,2,65535,0),this[H]=I>>>8,this[H+1]=I&255,H+2},P.prototype.writeUint32LE=P.prototype.writeUInt32LE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,4,4294967295,0),this[H+3]=I>>>24,this[H+2]=I>>>16,this[H+1]=I>>>8,this[H]=I&255,H+4},P.prototype.writeUint32BE=P.prototype.writeUInt32BE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,4,4294967295,0),this[H]=I>>>24,this[H+1]=I>>>16,this[H+2]=I>>>8,this[H+3]=I&255,H+4};function ne(G,I,H,q,K){nn(I,q,K,G,H,7);let Z=Number(I&BigInt(4294967295));G[H++]=Z,Z=Z>>8,G[H++]=Z,Z=Z>>8,G[H++]=Z,Z=Z>>8,G[H++]=Z;let en=Number(I>>BigInt(32)&BigInt(4294967295));return G[H++]=en,en=en>>8,G[H++]=en,en=en>>8,G[H++]=en,en=en>>8,G[H++]=en,H}function te(G,I,H,q,K){nn(I,q,K,G,H,7);let Z=Number(I&BigInt(4294967295));G[H+7]=Z,Z=Z>>8,G[H+6]=Z,Z=Z>>8,G[H+5]=Z,Z=Z>>8,G[H+4]=Z;let en=Number(I>>BigInt(32)&BigInt(4294967295));return G[H+3]=en,en=en>>8,G[H+2]=en,en=en>>8,G[H+1]=en,en=en>>8,G[H]=en,H+8}P.prototype.writeBigUInt64LE=M(function(I,H=0){return ne(this,I,H,BigInt(0),BigInt("0xffffffffffffffff"))}),P.prototype.writeBigUInt64BE=M(function(I,H=0){return te(this,I,H,BigInt(0),BigInt("0xffffffffffffffff"))}),P.prototype.writeIntLE=function(I,H,q,K){if(I=+I,H=H>>>0,!K){const _n=Math.pow(2,8*q-1);Jn(this,I,H,q,_n-1,-_n)}let Z=0,en=1,mn=0;for(this[H]=I&255;++Z<q&&(en*=256);)I<0&&mn===0&&this[H+Z-1]!==0&&(mn=1),this[H+Z]=(I/en>>0)-mn&255;return H+q},P.prototype.writeIntBE=function(I,H,q,K){if(I=+I,H=H>>>0,!K){const _n=Math.pow(2,8*q-1);Jn(this,I,H,q,_n-1,-_n)}let Z=q-1,en=1,mn=0;for(this[H+Z]=I&255;--Z>=0&&(en*=256);)I<0&&mn===0&&this[H+Z+1]!==0&&(mn=1),this[H+Z]=(I/en>>0)-mn&255;return H+q},P.prototype.writeInt8=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,1,127,-128),I<0&&(I=255+I+1),this[H]=I&255,H+1},P.prototype.writeInt16LE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,2,32767,-32768),this[H]=I&255,this[H+1]=I>>>8,H+2},P.prototype.writeInt16BE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,2,32767,-32768),this[H]=I>>>8,this[H+1]=I&255,H+2},P.prototype.writeInt32LE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,4,2147483647,-2147483648),this[H]=I&255,this[H+1]=I>>>8,this[H+2]=I>>>16,this[H+3]=I>>>24,H+4},P.prototype.writeInt32BE=function(I,H,q){return I=+I,H=H>>>0,q||Jn(this,I,H,4,2147483647,-2147483648),I<0&&(I=4294967295+I+1),this[H]=I>>>24,this[H+1]=I>>>16,this[H+2]=I>>>8,this[H+3]=I&255,H+4},P.prototype.writeBigInt64LE=M(function(I,H=0){return ne(this,I,H,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),P.prototype.writeBigInt64BE=M(function(I,H=0){return te(this,I,H,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function Qn(G,I,H,q,K,Z){if(H+q>G.length)throw new RangeError("Index out of range");if(H<0)throw new RangeError("Index out of range")}function ee(G,I,H,q,K){return I=+I,H=H>>>0,K||Qn(G,I,H,4),f.write(G,I,H,q,23,4),H+4}P.prototype.writeFloatLE=function(I,H,q){return ee(this,I,H,!0,q)},P.prototype.writeFloatBE=function(I,H,q){return ee(this,I,H,!1,q)};function yn(G,I,H,q,K){return I=+I,H=H>>>0,K||Qn(G,I,H,8),f.write(G,I,H,q,52,8),H+8}P.prototype.writeDoubleLE=function(I,H,q){return yn(this,I,H,!0,q)},P.prototype.writeDoubleBE=function(I,H,q){return yn(this,I,H,!1,q)},P.prototype.copy=function(I,H,q,K){if(!P.isBuffer(I))throw new TypeError("argument should be a Buffer");if(q||(q=0),!K&&K!==0&&(K=this.length),H>=I.length&&(H=I.length),H||(H=0),K>0&&K<q&&(K=q),K===q||I.length===0||this.length===0)return 0;if(H<0)throw new RangeError("targetStart out of bounds");if(q<0||q>=this.length)throw new RangeError("Index out of range");if(K<0)throw new RangeError("sourceEnd out of bounds");K>this.length&&(K=this.length),I.length-H<K-q&&(K=I.length-H+q);const Z=K-q;return this===I&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(H,q,K):Uint8Array.prototype.set.call(I,this.subarray(q,K),H),Z},P.prototype.fill=function(I,H,q,K){if(typeof I=="string"){if(typeof H=="string"?(K=H,H=0,q=this.length):typeof q=="string"&&(K=q,q=this.length),K!==void 0&&typeof K!="string")throw new TypeError("encoding must be a string");if(typeof K=="string"&&!P.isEncoding(K))throw new TypeError("Unknown encoding: "+K);if(I.length===1){const en=I.charCodeAt(0);(K==="utf8"&&en<128||K==="latin1")&&(I=en)}}else typeof I=="number"?I=I&255:typeof I=="boolean"&&(I=Number(I));if(H<0||this.length<H||this.length<q)throw new RangeError("Out of range index");if(q<=H)return this;H=H>>>0,q=q===void 0?this.length:q>>>0,I||(I=0);let Z;if(typeof I=="number")for(Z=H;Z<q;++Z)this[Z]=I;else{const en=P.isBuffer(I)?I:P.from(I,K),mn=en.length;if(mn===0)throw new TypeError('The value "'+I+'" is invalid for argument "value"');for(Z=0;Z<q-H;++Z)this[Z+H]=en[Z%mn]}return this};const Nn={};function Dn(G,I,H){Nn[G]=class extends H{constructor(){super(),Object.defineProperty(this,"message",{value:I.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${G}]`,this.stack,delete this.name}get code(){return G}set code(K){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:K,writable:!0})}toString(){return`${this.name} [${G}]: ${this.message}`}}}Dn("ERR_BUFFER_OUT_OF_BOUNDS",function(G){return G?`${G} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Dn("ERR_INVALID_ARG_TYPE",function(G,I){return`The "${G}" argument must be of type number. Received type ${typeof I}`},TypeError),Dn("ERR_OUT_OF_RANGE",function(G,I,H){let q=`The value of "${G}" is out of range.`,K=H;return Number.isInteger(H)&&Math.abs(H)>2**32?K=Vn(String(H)):typeof H=="bigint"&&(K=String(H),(H>BigInt(2)**BigInt(32)||H<-(BigInt(2)**BigInt(32)))&&(K=Vn(K)),K+="n"),q+=` It must be ${I}. Received ${K}`,q},RangeError);function Vn(G){let I="",H=G.length;const q=G[0]==="-"?1:0;for(;H>=q+4;H-=3)I=`_${G.slice(H-3,H)}${I}`;return`${G.slice(0,H)}${I}`}function Yn(G,I,H){on(I,"offset"),(G[I]===void 0||G[I+H]===void 0)&&an(I,G.length-(H+1))}function nn(G,I,H,q,K,Z){if(G>H||G<I){const en=typeof I=="bigint"?"n":"";let mn;throw I===0||I===BigInt(0)?mn=`>= 0${en} and < 2${en} ** ${(Z+1)*8}${en}`:mn=`>= -(2${en} ** ${(Z+1)*8-1}${en}) and < 2 ** ${(Z+1)*8-1}${en}`,new Nn.ERR_OUT_OF_RANGE("value",mn,G)}Yn(q,K,Z)}function on(G,I){if(typeof G!="number")throw new Nn.ERR_INVALID_ARG_TYPE(I,"number",G)}function an(G,I,H){throw Math.floor(G)!==G?(on(G,H),new Nn.ERR_OUT_OF_RANGE("offset","an integer",G)):I<0?new Nn.ERR_BUFFER_OUT_OF_BOUNDS:new Nn.ERR_OUT_OF_RANGE("offset",`>= 0 and <= ${I}`,G)}const bn=/[^+/0-9A-Za-z-_]/g;function jn(G){if(G=G.split("=")[0],G=G.trim().replace(bn,""),G.length<2)return"";for(;G.length%4!==0;)G=G+"=";return G}function xn(G,I){I=I||1/0;let H;const q=G.length;let K=null;const Z=[];for(let en=0;en<q;++en){if(H=G.charCodeAt(en),H>55295&&H<57344){if(!K){if(H>56319){(I-=3)>-1&&Z.push(239,191,189);continue}else if(en+1===q){(I-=3)>-1&&Z.push(239,191,189);continue}K=H;continue}if(H<56320){(I-=3)>-1&&Z.push(239,191,189),K=H;continue}H=(K-55296<<10|H-56320)+65536}else K&&(I-=3)>-1&&Z.push(239,191,189);if(K=null,H<128){if((I-=1)<0)break;Z.push(H)}else if(H<2048){if((I-=2)<0)break;Z.push(H>>6|192,H&63|128)}else if(H<65536){if((I-=3)<0)break;Z.push(H>>12|224,H>>6&63|128,H&63|128)}else if(H<1114112){if((I-=4)<0)break;Z.push(H>>18|240,H>>12&63|128,H>>6&63|128,H&63|128)}else throw new Error("Invalid code point")}return Z}function Rn(G){const I=[];for(let H=0;H<G.length;++H)I.push(G.charCodeAt(H)&255);return I}function In(G,I){let H,q,K;const Z=[];for(let en=0;en<G.length&&!((I-=2)<0);++en)H=G.charCodeAt(en),q=H>>8,K=H%256,Z.push(K),Z.push(q);return Z}function On(G){return a.toByteArray(jn(G))}function kn(G,I,H,q){let K;for(K=0;K<q&&!(K+H>=I.length||K>=G.length);++K)I[K+H]=G[K];return K}function Ln(G,I){return G instanceof I||G!=null&&G.constructor!=null&&G.constructor.name!=null&&G.constructor.name===I.name}function $n(G){return G!==G}const Hn=(function(){const G="0123456789abcdef",I=new Array(256);for(let H=0;H<16;++H){const q=H*16;for(let K=0;K<16;++K)I[q+K]=G[H]+G[K]}return I})();function M(G){return typeof BigInt>"u"?sn:G}function sn(){throw new Error("BigInt not supported")}})(buffer)),buffer}var bufferExports=requireBuffer();const isBrowser=typeof document<"u";function isRouteComponent(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function isESModule(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&isRouteComponent(e.default)}const assign=Object.assign;function applyToParams(e,a){const f={};for(const _ in a){const x=a[_];f[_]=isArray(x)?x.map(e):e(x)}return f}const noop=()=>{},isArray=Array.isArray;function mergeOptions(e,a){const f={};for(const _ in e)f[_]=_ in a?a[_]:e[_];return f}const HASH_RE=/#/g,AMPERSAND_RE=/&/g,SLASH_RE=/\//g,EQUAL_RE=/=/g,IM_RE=/\?/g,PLUS_RE=/\+/g,ENC_BRACKET_OPEN_RE=/%5B/g,ENC_BRACKET_CLOSE_RE=/%5D/g,ENC_CARET_RE=/%5E/g,ENC_BACKTICK_RE=/%60/g,ENC_CURLY_OPEN_RE=/%7B/g,ENC_PIPE_RE=/%7C/g,ENC_CURLY_CLOSE_RE=/%7D/g,ENC_SPACE_RE=/%20/g;function commonEncode(e){return e==null?"":encodeURI(""+e).replace(ENC_PIPE_RE,"|").replace(ENC_BRACKET_OPEN_RE,"[").replace(ENC_BRACKET_CLOSE_RE,"]")}function encodeHash(e){return commonEncode(e).replace(ENC_CURLY_OPEN_RE,"{").replace(ENC_CURLY_CLOSE_RE,"}").replace(ENC_CARET_RE,"^")}function encodeQueryValue(e){return commonEncode(e).replace(PLUS_RE,"%2B").replace(ENC_SPACE_RE,"+").replace(HASH_RE,"%23").replace(AMPERSAND_RE,"%26").replace(ENC_BACKTICK_RE,"`").replace(ENC_CURLY_OPEN_RE,"{").replace(ENC_CURLY_CLOSE_RE,"}").replace(ENC_CARET_RE,"^")}function encodeQueryKey(e){return encodeQueryValue(e).replace(EQUAL_RE,"%3D")}function encodePath(e){return commonEncode(e).replace(HASH_RE,"%23").replace(IM_RE,"%3F")}function encodeParam(e){return encodePath(e).replace(SLASH_RE,"%2F")}function decode(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const TRAILING_SLASH_RE=/\/$/,removeTrailingSlash=e=>e.replace(TRAILING_SLASH_RE,"");function parseURL(e,a,f="/"){let _,x={},w="",C="";const P=a.indexOf("#");let E=a.indexOf("?");return E=P>=0&&E>P?-1:E,E>=0&&(_=a.slice(0,E),w=a.slice(E,P>0?P:a.length),x=e(w.slice(1))),P>=0&&(_=_||a.slice(0,P),C=a.slice(P,a.length)),_=resolveRelativePath(_??a,f),{fullPath:_+w+C,path:_,query:x,hash:decode(C)}}function stringifyURL(e,a){const f=a.query?e(a.query):"";return a.path+(f&&"?")+f+(a.hash||"")}function stripBase(e,a){return!a||!e.toLowerCase().startsWith(a.toLowerCase())?e:e.slice(a.length)||"/"}function isSameRouteLocation(e,a,f){const _=a.matched.length-1,x=f.matched.length-1;return _>-1&&_===x&&isSameRouteRecord(a.matched[_],f.matched[x])&&isSameRouteLocationParams(a.params,f.params)&&e(a.query)===e(f.query)&&a.hash===f.hash}function isSameRouteRecord(e,a){return(e.aliasOf||e)===(a.aliasOf||a)}function isSameRouteLocationParams(e,a){if(Object.keys(e).length!==Object.keys(a).length)return!1;for(var f in e)if(!isSameRouteLocationParamsValue(e[f],a[f]))return!1;return!0}function isSameRouteLocationParamsValue(e,a){return isArray(e)?isEquivalentArray(e,a):isArray(a)?isEquivalentArray(a,e):e?.valueOf()===a?.valueOf()}function isEquivalentArray(e,a){return isArray(a)?e.length===a.length&&e.every((f,_)=>f===a[_]):e.length===1&&e[0]===a}function resolveRelativePath(e,a){if(e.startsWith("/"))return e;if(!e)return a;const f=a.split("/"),_=e.split("/"),x=_[_.length-1];(x===".."||x===".")&&_.push("");let w=f.length-1,C,P;for(C=0;C<_.length;C++)if(P=_[C],P!==".")if(P==="..")w>1&&w--;else break;return f.slice(0,w).join("/")+"/"+_.slice(C).join("/")}const START_LOCATION_NORMALIZED={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let NavigationType=(function(e){return e.pop="pop",e.push="push",e})({}),NavigationDirection=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function normalizeBase(e){if(!e)if(isBrowser){const a=document.querySelector("base");e=a&&a.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),removeTrailingSlash(e)}const BEFORE_HASH_RE=/^[^#]+#/;function createHref(e,a){return e.replace(BEFORE_HASH_RE,"#")+a}function getElementPosition(e,a){const f=document.documentElement.getBoundingClientRect(),_=e.getBoundingClientRect();return{behavior:a.behavior,left:_.left-f.left-(a.left||0),top:_.top-f.top-(a.top||0)}}const computeScrollPosition=()=>({left:window.scrollX,top:window.scrollY});function scrollToPosition(e){let a;if("el"in e){const f=e.el,_=typeof f=="string"&&f.startsWith("#"),x=typeof f=="string"?_?document.getElementById(f.slice(1)):document.querySelector(f):f;if(!x)return;a=getElementPosition(x,e)}else a=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(a):window.scrollTo(a.left!=null?a.left:window.scrollX,a.top!=null?a.top:window.scrollY)}function getScrollKey(e,a){return(history.state?history.state.position-a:-1)+e}const scrollPositions=new Map;function saveScrollPosition(e,a){scrollPositions.set(e,a)}function getSavedScrollPosition(e){const a=scrollPositions.get(e);return scrollPositions.delete(e),a}function isRouteLocation(e){return typeof e=="string"||e&&typeof e=="object"}function isRouteName(e){return typeof e=="string"||typeof e=="symbol"}let ErrorTypes=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const NavigationFailureSymbol=Symbol("");ErrorTypes.MATCHER_NOT_FOUND+"",ErrorTypes.NAVIGATION_GUARD_REDIRECT+"",ErrorTypes.NAVIGATION_ABORTED+"",ErrorTypes.NAVIGATION_CANCELLED+"",ErrorTypes.NAVIGATION_DUPLICATED+"";function createRouterError(e,a){return assign(new Error,{type:e,[NavigationFailureSymbol]:!0},a)}function isNavigationFailure(e,a){return e instanceof Error&&NavigationFailureSymbol in e&&(a==null||!!(e.type&a))}const propertiesToLog=["params","query","hash"];function stringifyRoute(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const a={};for(const f of propertiesToLog)f in e&&(a[f]=e[f]);return JSON.stringify(a,null,2)}function parseQuery(e){const a={};if(e===""||e==="?")return a;const f=(e[0]==="?"?e.slice(1):e).split("&");for(let _=0;_<f.length;++_){const x=f[_].replace(PLUS_RE," "),w=x.indexOf("="),C=decode(w<0?x:x.slice(0,w)),P=w<0?null:decode(x.slice(w+1));if(C in a){let E=a[C];isArray(E)||(E=a[C]=[E]),E.push(P)}else a[C]=P}return a}function stringifyQuery(e){let a="";for(let f in e){const _=e[f];if(f=encodeQueryKey(f),_==null){_!==void 0&&(a+=(a.length?"&":"")+f);continue}(isArray(_)?_.map(x=>x&&encodeQueryValue(x)):[_&&encodeQueryValue(_)]).forEach(x=>{x!==void 0&&(a+=(a.length?"&":"")+f,x!=null&&(a+="="+x))})}return a}function normalizeQuery(e){const a={};for(const f in e){const _=e[f];_!==void 0&&(a[f]=isArray(_)?_.map(x=>x==null?null:""+x):_==null?_:""+_)}return a}const matchedRouteKey=Symbol(""),viewDepthKey=Symbol(""),routerKey=Symbol(""),routeLocationKey=Symbol(""),routerViewLocationKey=Symbol("");function useCallbacks(){let e=[];function a(_){return e.push(_),()=>{const x=e.indexOf(_);x>-1&&e.splice(x,1)}}function f(){e=[]}return{add:a,list:()=>e.slice(),reset:f}}function guardToPromiseFn(e,a,f,_,x,w=C=>C()){const C=_&&(_.enterCallbacks[x]=_.enterCallbacks[x]||[]);return()=>new Promise((P,E)=>{const D=J=>{J===!1?E(createRouterError(ErrorTypes.NAVIGATION_ABORTED,{from:f,to:a})):J instanceof Error?E(J):isRouteLocation(J)?E(createRouterError(ErrorTypes.NAVIGATION_GUARD_REDIRECT,{from:a,to:J})):(C&&_.enterCallbacks[x]===C&&typeof J=="function"&&C.push(J),P())},B=w(()=>e.call(_&&_.instances[x],a,f,D));let z=Promise.resolve(B);e.length<3&&(z=z.then(D)),z.catch(J=>E(J))})}function extractComponentsGuards(e,a,f,_,x=w=>w()){const w=[];for(const C of e)for(const P in C.components){let E=C.components[P];if(!(a!=="beforeRouteEnter"&&!C.instances[P]))if(isRouteComponent(E)){const D=(E.__vccOpts||E)[a];D&&w.push(guardToPromiseFn(D,f,_,C,P,x))}else{let D=E();w.push(()=>D.then(B=>{if(!B)throw new Error(`Couldn't resolve component "${P}" at "${C.path}"`);const z=isESModule(B)?B.default:B;C.mods[P]=B,C.components[P]=z;const J=(z.__vccOpts||z)[a];return J&&guardToPromiseFn(J,f,_,C,P,x)()}))}}return w}function extractChangingRecords(e,a){const f=[],_=[],x=[],w=Math.max(a.matched.length,e.matched.length);for(let C=0;C<w;C++){const P=a.matched[C];P&&(e.matched.find(D=>isSameRouteRecord(D,P))?_.push(P):f.push(P));const E=e.matched[C];E&&(a.matched.find(D=>isSameRouteRecord(D,E))||x.push(E))}return[f,_,x]}let createBaseLocation=()=>location.protocol+"//"+location.host;function createCurrentLocation(e,a){const{pathname:f,search:_,hash:x}=a,w=e.indexOf("#");if(w>-1){let C=x.includes(e.slice(w))?e.slice(w).length:1,P=x.slice(C);return P[0]!=="/"&&(P="/"+P),stripBase(P,"")}return stripBase(f,e)+_+x}function useHistoryListeners(e,a,f,_){let x=[],w=[],C=null;const P=({state:J})=>{const Y=createCurrentLocation(e,location),X=f.value,tn=a.value;let pn=0;if(J){if(f.value=Y,a.value=J,C&&C===X){C=null;return}pn=tn?J.position-tn.position:0}else _(Y);x.forEach(un=>{un(f.value,X,{delta:pn,type:NavigationType.pop,direction:pn?pn>0?NavigationDirection.forward:NavigationDirection.back:NavigationDirection.unknown})})};function E(){C=f.value}function D(J){x.push(J);const Y=()=>{const X=x.indexOf(J);X>-1&&x.splice(X,1)};return w.push(Y),Y}function B(){if(document.visibilityState==="hidden"){const{history:J}=window;if(!J.state)return;J.replaceState(assign({},J.state,{scroll:computeScrollPosition()}),"")}}function z(){for(const J of w)J();w=[],window.removeEventListener("popstate",P),window.removeEventListener("pagehide",B),document.removeEventListener("visibilitychange",B)}return window.addEventListener("popstate",P),window.addEventListener("pagehide",B),document.addEventListener("visibilitychange",B),{pauseListeners:E,listen:D,destroy:z}}function buildState(e,a,f,_=!1,x=!1){return{back:e,current:a,forward:f,replaced:_,position:window.history.length,scroll:x?computeScrollPosition():null}}function useHistoryStateNavigation(e){const{history:a,location:f}=window,_={value:createCurrentLocation(e,f)},x={value:a.state};x.value||w(_.value,{back:null,current:_.value,forward:null,position:a.length-1,replaced:!0,scroll:null},!0);function w(E,D,B){const z=e.indexOf("#"),J=z>-1?(f.host&&document.querySelector("base")?e:e.slice(z))+E:createBaseLocation()+e+E;try{a[B?"replaceState":"pushState"](D,"",J),x.value=D}catch(Y){console.error(Y),f[B?"replace":"assign"](J)}}function C(E,D){w(E,assign({},a.state,buildState(x.value.back,E,x.value.forward,!0),D,{position:x.value.position}),!0),_.value=E}function P(E,D){const B=assign({},x.value,a.state,{forward:E,scroll:computeScrollPosition()});w(B.current,B,!0),w(E,assign({},buildState(_.value,E,null),{position:B.position+1},D),!1),_.value=E}return{location:_,state:x,push:P,replace:C}}function createWebHistory(e){e=normalizeBase(e);const a=useHistoryStateNavigation(e),f=useHistoryListeners(e,a.state,a.location,a.replace);function _(w,C=!0){C||f.pauseListeners(),history.go(w)}const x=assign({location:"",base:e,go:_,createHref:createHref.bind(null,e)},a,f);return Object.defineProperty(x,"location",{enumerable:!0,get:()=>a.location.value}),Object.defineProperty(x,"state",{enumerable:!0,get:()=>a.state.value}),x}function createWebHashHistory(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),createWebHistory(e)}let TokenType=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var TokenizerState=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(TokenizerState||{});const ROOT_TOKEN={type:TokenType.Static,value:""},VALID_PARAM_RE=/[a-zA-Z0-9_]/;function tokenizePath(e){if(!e)return[[]];if(e==="/")return[[ROOT_TOKEN]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function a(Y){throw new Error(`ERR (${f})/"${D}": ${Y}`)}let f=TokenizerState.Static,_=f;const x=[];let w;function C(){w&&x.push(w),w=[]}let P=0,E,D="",B="";function z(){D&&(f===TokenizerState.Static?w.push({type:TokenType.Static,value:D}):f===TokenizerState.Param||f===TokenizerState.ParamRegExp||f===TokenizerState.ParamRegExpEnd?(w.length>1&&(E==="*"||E==="+")&&a(`A repeatable param (${D}) must be alone in its segment. eg: '/:ids+.`),w.push({type:TokenType.Param,value:D,regexp:B,repeatable:E==="*"||E==="+",optional:E==="*"||E==="?"})):a("Invalid state to consume buffer"),D="")}function J(){D+=E}for(;P<e.length;){if(E=e[P++],E==="\\"&&f!==TokenizerState.ParamRegExp){_=f,f=TokenizerState.EscapeNext;continue}switch(f){case TokenizerState.Static:E==="/"?(D&&z(),C()):E===":"?(z(),f=TokenizerState.Param):J();break;case TokenizerState.EscapeNext:J(),f=_;break;case TokenizerState.Param:E==="("?f=TokenizerState.ParamRegExp:VALID_PARAM_RE.test(E)?J():(z(),f=TokenizerState.Static,E!=="*"&&E!=="?"&&E!=="+"&&P--);break;case TokenizerState.ParamRegExp:E===")"?B[B.length-1]=="\\"?B=B.slice(0,-1)+E:f=TokenizerState.ParamRegExpEnd:B+=E;break;case TokenizerState.ParamRegExpEnd:z(),f=TokenizerState.Static,E!=="*"&&E!=="?"&&E!=="+"&&P--,B="";break;default:a("Unknown state");break}}return f===TokenizerState.ParamRegExp&&a(`Unfinished custom RegExp for param "${D}"`),z(),C(),x}const BASE_PARAM_PATTERN="[^/]+?",BASE_PATH_PARSER_OPTIONS={sensitive:!1,strict:!1,start:!0,end:!0};var PathScore=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(PathScore||{});const REGEX_CHARS_RE=/[.+*?^${}()[\]/\\]/g;function tokensToParser(e,a){const f=assign({},BASE_PATH_PARSER_OPTIONS,a),_=[];let x=f.start?"^":"";const w=[];for(const D of e){const B=D.length?[]:[PathScore.Root];f.strict&&!D.length&&(x+="/");for(let z=0;z<D.length;z++){const J=D[z];let Y=PathScore.Segment+(f.sensitive?PathScore.BonusCaseSensitive:0);if(J.type===TokenType.Static)z||(x+="/"),x+=J.value.replace(REGEX_CHARS_RE,"\\$&"),Y+=PathScore.Static;else if(J.type===TokenType.Param){const{value:X,repeatable:tn,optional:pn,regexp:un}=J;w.push({name:X,repeatable:tn,optional:pn});const rn=un||BASE_PARAM_PATTERN;if(rn!==BASE_PARAM_PATTERN){Y+=PathScore.BonusCustomRegExp;try{`${rn}`}catch(gn){throw new Error(`Invalid custom RegExp for param "${X}" (${rn}): `+gn.message)}}let cn=tn?`((?:${rn})(?:/(?:${rn}))*)`:`(${rn})`;z||(cn=pn&&D.length<2?`(?:/${cn})`:"/"+cn),pn&&(cn+="?"),x+=cn,Y+=PathScore.Dynamic,pn&&(Y+=PathScore.BonusOptional),tn&&(Y+=PathScore.BonusRepeatable),rn===".*"&&(Y+=PathScore.BonusWildcard)}B.push(Y)}_.push(B)}if(f.strict&&f.end){const D=_.length-1;_[D][_[D].length-1]+=PathScore.BonusStrict}f.strict||(x+="/?"),f.end?x+="$":f.strict&&!x.endsWith("/")&&(x+="(?:/|$)");const C=new RegExp(x,f.sensitive?"":"i");function P(D){const B=D.match(C),z={};if(!B)return null;for(let J=1;J<B.length;J++){const Y=B[J]||"",X=w[J-1];z[X.name]=Y&&X.repeatable?Y.split("/"):Y}return z}function E(D){let B="",z=!1;for(const J of e){(!z||!B.endsWith("/"))&&(B+="/"),z=!1;for(const Y of J)if(Y.type===TokenType.Static)B+=Y.value;else if(Y.type===TokenType.Param){const{value:X,repeatable:tn,optional:pn}=Y,un=X in D?D[X]:"";if(isArray(un)&&!tn)throw new Error(`Provided param "${X}" is an array but it is not repeatable (* or + modifiers)`);const rn=isArray(un)?un.join("/"):un;if(!rn)if(pn)J.length<2&&(B.endsWith("/")?B=B.slice(0,-1):z=!0);else throw new Error(`Missing required param "${X}"`);B+=rn}}return B||"/"}return{re:C,score:_,keys:w,parse:P,stringify:E}}function compareScoreArray(e,a){let f=0;for(;f<e.length&&f<a.length;){const _=a[f]-e[f];if(_)return _;f++}return e.length<a.length?e.length===1&&e[0]===PathScore.Static+PathScore.Segment?-1:1:e.length>a.length?a.length===1&&a[0]===PathScore.Static+PathScore.Segment?1:-1:0}function comparePathParserScore(e,a){let f=0;const _=e.score,x=a.score;for(;f<_.length&&f<x.length;){const w=compareScoreArray(_[f],x[f]);if(w)return w;f++}if(Math.abs(x.length-_.length)===1){if(isLastScoreNegative(_))return 1;if(isLastScoreNegative(x))return-1}return x.length-_.length}function isLastScoreNegative(e){const a=e[e.length-1];return e.length>0&&a[a.length-1]<0}const PATH_PARSER_OPTIONS_DEFAULTS={strict:!1,end:!0,sensitive:!1};function createRouteRecordMatcher(e,a,f){const _=tokensToParser(tokenizePath(e.path),f),x=assign(_,{record:e,parent:a,children:[],alias:[]});return a&&!x.record.aliasOf==!a.record.aliasOf&&a.children.push(x),x}function createRouterMatcher(e,a){const f=[],_=new Map;a=mergeOptions(PATH_PARSER_OPTIONS_DEFAULTS,a);function x(z){return _.get(z)}function w(z,J,Y){const X=!Y,tn=normalizeRouteRecord(z);tn.aliasOf=Y&&Y.record;const pn=mergeOptions(a,z),un=[tn];if("alias"in z){const gn=typeof z.alias=="string"?[z.alias]:z.alias;for(const dn of gn)un.push(normalizeRouteRecord(assign({},tn,{components:Y?Y.record.components:tn.components,path:dn,aliasOf:Y?Y.record:tn})))}let rn,cn;for(const gn of un){const{path:dn}=gn;if(J&&dn[0]!=="/"){const Mn=J.record.path,Tn=Mn[Mn.length-1]==="/"?"":"/";gn.path=J.record.path+(dn&&Tn+dn)}if(rn=createRouteRecordMatcher(gn,J,pn),Y?Y.alias.push(rn):(cn=cn||rn,cn!==rn&&cn.alias.push(rn),X&&z.name&&!isAliasRecord(rn)&&C(z.name)),isMatchable(rn)&&E(rn),tn.children){const Mn=tn.children;for(let Tn=0;Tn<Mn.length;Tn++)w(Mn[Tn],rn,Y&&Y.children[Tn])}Y=Y||rn}return cn?()=>{C(cn)}:noop}function C(z){if(isRouteName(z)){const J=_.get(z);J&&(_.delete(z),f.splice(f.indexOf(J),1),J.children.forEach(C),J.alias.forEach(C))}else{const J=f.indexOf(z);J>-1&&(f.splice(J,1),z.record.name&&_.delete(z.record.name),z.children.forEach(C),z.alias.forEach(C))}}function P(){return f}function E(z){const J=findInsertionIndex(z,f);f.splice(J,0,z),z.record.name&&!isAliasRecord(z)&&_.set(z.record.name,z)}function D(z,J){let Y,X={},tn,pn;if("name"in z&&z.name){if(Y=_.get(z.name),!Y)throw createRouterError(ErrorTypes.MATCHER_NOT_FOUND,{location:z});pn=Y.record.name,X=assign(pickParams(J.params,Y.keys.filter(cn=>!cn.optional).concat(Y.parent?Y.parent.keys.filter(cn=>cn.optional):[]).map(cn=>cn.name)),z.params&&pickParams(z.params,Y.keys.map(cn=>cn.name))),tn=Y.stringify(X)}else if(z.path!=null)tn=z.path,Y=f.find(cn=>cn.re.test(tn)),Y&&(X=Y.parse(tn),pn=Y.record.name);else{if(Y=J.name?_.get(J.name):f.find(cn=>cn.re.test(J.path)),!Y)throw createRouterError(ErrorTypes.MATCHER_NOT_FOUND,{location:z,currentLocation:J});pn=Y.record.name,X=assign({},J.params,z.params),tn=Y.stringify(X)}const un=[];let rn=Y;for(;rn;)un.unshift(rn.record),rn=rn.parent;return{name:pn,path:tn,params:X,matched:un,meta:mergeMetaFields(un)}}e.forEach(z=>w(z));function B(){f.length=0,_.clear()}return{addRoute:w,resolve:D,removeRoute:C,clearRoutes:B,getRoutes:P,getRecordMatcher:x}}function pickParams(e,a){const f={};for(const _ of a)_ in e&&(f[_]=e[_]);return f}function normalizeRouteRecord(e){const a={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:normalizeRecordProps(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(a,"mods",{value:{}}),a}function normalizeRecordProps(e){const a={},f=e.props||!1;if("component"in e)a.default=f;else for(const _ in e.components)a[_]=typeof f=="object"?f[_]:f;return a}function isAliasRecord(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function mergeMetaFields(e){return e.reduce((a,f)=>assign(a,f.meta),{})}function findInsertionIndex(e,a){let f=0,_=a.length;for(;f!==_;){const w=f+_>>1;comparePathParserScore(e,a[w])<0?_=w:f=w+1}const x=getInsertionAncestor(e);return x&&(_=a.lastIndexOf(x,_-1)),_}function getInsertionAncestor(e){let a=e;for(;a=a.parent;)if(isMatchable(a)&&comparePathParserScore(e,a)===0)return a}function isMatchable({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function useLink(e){const a=inject(routerKey),f=inject(routeLocationKey),_=computed(()=>{const E=unref(e.to);return a.resolve(E)}),x=computed(()=>{const{matched:E}=_.value,{length:D}=E,B=E[D-1],z=f.matched;if(!B||!z.length)return-1;const J=z.findIndex(isSameRouteRecord.bind(null,B));if(J>-1)return J;const Y=getOriginalPath(E[D-2]);return D>1&&getOriginalPath(B)===Y&&z[z.length-1].path!==Y?z.findIndex(isSameRouteRecord.bind(null,E[D-2])):J}),w=computed(()=>x.value>-1&&includesParams(f.params,_.value.params)),C=computed(()=>x.value>-1&&x.value===f.matched.length-1&&isSameRouteLocationParams(f.params,_.value.params));function P(E={}){if(guardEvent(E)){const D=a[unref(e.replace)?"replace":"push"](unref(e.to)).catch(noop);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>D),D}return Promise.resolve()}return{route:_,href:computed(()=>_.value.href),isActive:w,isExactActive:C,navigate:P}}function preferSingleVNode(e){return e.length===1?e[0]:e}const RouterLinkImpl=defineComponent({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink,setup(e,{slots:a}){const f=reactive(useLink(e)),{options:_}=inject(routerKey),x=computed(()=>({[getLinkClass(e.activeClass,_.linkActiveClass,"router-link-active")]:f.isActive,[getLinkClass(e.exactActiveClass,_.linkExactActiveClass,"router-link-exact-active")]:f.isExactActive}));return()=>{const w=a.default&&preferSingleVNode(a.default(f));return e.custom?w:h("a",{"aria-current":f.isExactActive?e.ariaCurrentValue:null,href:f.href,onClick:f.navigate,class:x.value},w)}}}),RouterLink=RouterLinkImpl;function guardEvent(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const a=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(a))return}return e.preventDefault&&e.preventDefault(),!0}}function includesParams(e,a){for(const f in a){const _=a[f],x=e[f];if(typeof _=="string"){if(_!==x)return!1}else if(!isArray(x)||x.length!==_.length||_.some((w,C)=>w.valueOf()!==x[C].valueOf()))return!1}return!0}function getOriginalPath(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const getLinkClass=(e,a,f)=>e??a??f,RouterViewImpl=defineComponent({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:a,slots:f}){const _=inject(routerViewLocationKey),x=computed(()=>e.route||_.value),w=inject(viewDepthKey,0),C=computed(()=>{let D=unref(w);const{matched:B}=x.value;let z;for(;(z=B[D])&&!z.components;)D++;return D}),P=computed(()=>x.value.matched[C.value]);provide(viewDepthKey,computed(()=>C.value+1)),provide(matchedRouteKey,P),provide(routerViewLocationKey,x);const E=ref();return watch(()=>[E.value,P.value,e.name],([D,B,z],[J,Y,X])=>{B&&(B.instances[z]=D,Y&&Y!==B&&D&&D===J&&(B.leaveGuards.size||(B.leaveGuards=Y.leaveGuards),B.updateGuards.size||(B.updateGuards=Y.updateGuards))),D&&B&&(!Y||!isSameRouteRecord(B,Y)||!J)&&(B.enterCallbacks[z]||[]).forEach(tn=>tn(D))},{flush:"post"}),()=>{const D=x.value,B=e.name,z=P.value,J=z&&z.components[B];if(!J)return normalizeSlot(f.default,{Component:J,route:D});const Y=z.props[B],X=Y?Y===!0?D.params:typeof Y=="function"?Y(D):Y:null,pn=h(J,assign({},X,a,{onVnodeUnmounted:un=>{un.component.isUnmounted&&(z.instances[B]=null)},ref:E}));return normalizeSlot(f.default,{Component:pn,route:D})||pn}}});function normalizeSlot(e,a){if(!e)return null;const f=e(a);return f.length===1?f[0]:f}const RouterView=RouterViewImpl;function createRouter(e){const a=createRouterMatcher(e.routes,e),f=e.parseQuery||parseQuery,_=e.stringifyQuery||stringifyQuery,x=e.history,w=useCallbacks(),C=useCallbacks(),P=useCallbacks(),E=shallowRef(START_LOCATION_NORMALIZED);let D=START_LOCATION_NORMALIZED;isBrowser&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const B=applyToParams.bind(null,yn=>""+yn),z=applyToParams.bind(null,encodeParam),J=applyToParams.bind(null,decode);function Y(yn,Nn){let Dn,Vn;return isRouteName(yn)?(Dn=a.getRecordMatcher(yn),Vn=Nn):Vn=yn,a.addRoute(Vn,Dn)}function X(yn){const Nn=a.getRecordMatcher(yn);Nn&&a.removeRoute(Nn)}function tn(){return a.getRoutes().map(yn=>yn.record)}function pn(yn){return!!a.getRecordMatcher(yn)}function un(yn,Nn){if(Nn=assign({},Nn||E.value),typeof yn=="string"){const an=parseURL(f,yn,Nn.path),bn=a.resolve({path:an.path},Nn),jn=x.createHref(an.fullPath);return assign(an,bn,{params:J(bn.params),hash:decode(an.hash),redirectedFrom:void 0,href:jn})}let Dn;if(yn.path!=null)Dn=assign({},yn,{path:parseURL(f,yn.path,Nn.path).path});else{const an=assign({},yn.params);for(const bn in an)an[bn]==null&&delete an[bn];Dn=assign({},yn,{params:z(an)}),Nn.params=z(Nn.params)}const Vn=a.resolve(Dn,Nn),Yn=yn.hash||"";Vn.params=B(J(Vn.params));const nn=stringifyURL(_,assign({},yn,{hash:encodeHash(Yn),path:Vn.path})),on=x.createHref(nn);return assign({fullPath:nn,hash:Yn,query:_===stringifyQuery?normalizeQuery(yn.query):yn.query||{}},Vn,{redirectedFrom:void 0,href:on})}function rn(yn){return typeof yn=="string"?parseURL(f,yn,E.value.path):assign({},yn)}function cn(yn,Nn){if(D!==yn)return createRouterError(ErrorTypes.NAVIGATION_CANCELLED,{from:Nn,to:yn})}function gn(yn){return Tn(yn)}function dn(yn){return gn(assign(rn(yn),{replace:!0}))}function Mn(yn,Nn){const Dn=yn.matched[yn.matched.length-1];if(Dn&&Dn.redirect){const{redirect:Vn}=Dn;let Yn=typeof Vn=="function"?Vn(yn,Nn):Vn;return typeof Yn=="string"&&(Yn=Yn.includes("?")||Yn.includes("#")?Yn=rn(Yn):{path:Yn},Yn.params={}),assign({query:yn.query,hash:yn.hash,params:Yn.path!=null?{}:yn.params},Yn)}}function Tn(yn,Nn){const Dn=D=un(yn),Vn=E.value,Yn=yn.state,nn=yn.force,on=yn.replace===!0,an=Mn(Dn,Vn);if(an)return Tn(assign(rn(an),{state:typeof an=="object"?assign({},Yn,an.state):Yn,force:nn,replace:on}),Nn||Dn);const bn=Dn;bn.redirectedFrom=Nn;let jn;return!nn&&isSameRouteLocation(_,Vn,Dn)&&(jn=createRouterError(ErrorTypes.NAVIGATION_DUPLICATED,{to:bn,from:Vn}),qn(Vn,Vn,!0,!1)),(jn?Promise.resolve(jn):En(bn,Vn)).catch(xn=>isNavigationFailure(xn)?isNavigationFailure(xn,ErrorTypes.NAVIGATION_GUARD_REDIRECT)?xn:Xn(xn):hn(xn,bn,Vn)).then(xn=>{if(xn){if(isNavigationFailure(xn,ErrorTypes.NAVIGATION_GUARD_REDIRECT))return Tn(assign({replace:on},rn(xn.to),{state:typeof xn.to=="object"?assign({},Yn,xn.to.state):Yn,force:nn}),Nn||bn)}else xn=Sn(bn,Vn,!0,on,Yn);return An(bn,Vn,xn),xn})}function ln(yn,Nn){const Dn=cn(yn,Nn);return Dn?Promise.reject(Dn):Promise.resolve()}function wn(yn){const Nn=te.values().next().value;return Nn&&typeof Nn.runWithContext=="function"?Nn.runWithContext(yn):yn()}function En(yn,Nn){let Dn;const[Vn,Yn,nn]=extractChangingRecords(yn,Nn);Dn=extractComponentsGuards(Vn.reverse(),"beforeRouteLeave",yn,Nn);for(const an of Vn)an.leaveGuards.forEach(bn=>{Dn.push(guardToPromiseFn(bn,yn,Nn))});const on=ln.bind(null,yn,Nn);return Dn.push(on),ee(Dn).then(()=>{Dn=[];for(const an of w.list())Dn.push(guardToPromiseFn(an,yn,Nn));return Dn.push(on),ee(Dn)}).then(()=>{Dn=extractComponentsGuards(Yn,"beforeRouteUpdate",yn,Nn);for(const an of Yn)an.updateGuards.forEach(bn=>{Dn.push(guardToPromiseFn(bn,yn,Nn))});return Dn.push(on),ee(Dn)}).then(()=>{Dn=[];for(const an of nn)if(an.beforeEnter)if(isArray(an.beforeEnter))for(const bn of an.beforeEnter)Dn.push(guardToPromiseFn(bn,yn,Nn));else Dn.push(guardToPromiseFn(an.beforeEnter,yn,Nn));return Dn.push(on),ee(Dn)}).then(()=>(yn.matched.forEach(an=>an.enterCallbacks={}),Dn=extractComponentsGuards(nn,"beforeRouteEnter",yn,Nn,wn),Dn.push(on),ee(Dn))).then(()=>{Dn=[];for(const an of C.list())Dn.push(guardToPromiseFn(an,yn,Nn));return Dn.push(on),ee(Dn)}).catch(an=>isNavigationFailure(an,ErrorTypes.NAVIGATION_CANCELLED)?an:Promise.reject(an))}function An(yn,Nn,Dn){P.list().forEach(Vn=>wn(()=>Vn(yn,Nn,Dn)))}function Sn(yn,Nn,Dn,Vn,Yn){const nn=cn(yn,Nn);if(nn)return nn;const on=Nn===START_LOCATION_NORMALIZED,an=isBrowser?history.state:{};Dn&&(Vn||on?x.replace(yn.fullPath,assign({scroll:on&&an&&an.scroll},Yn)):x.push(yn.fullPath,Yn)),E.value=yn,qn(yn,Nn,Dn,on),Xn()}let Bn;function Fn(){Bn||(Bn=x.listen((yn,Nn,Dn)=>{if(!Qn.listening)return;const Vn=un(yn),Yn=Mn(Vn,Qn.currentRoute.value);if(Yn){Tn(assign(Yn,{replace:!0,force:!0}),Vn).catch(noop);return}D=Vn;const nn=E.value;isBrowser&&saveScrollPosition(getScrollKey(nn.fullPath,Dn.delta),computeScrollPosition()),En(Vn,nn).catch(on=>isNavigationFailure(on,ErrorTypes.NAVIGATION_ABORTED|ErrorTypes.NAVIGATION_CANCELLED)?on:isNavigationFailure(on,ErrorTypes.NAVIGATION_GUARD_REDIRECT)?(Tn(assign(rn(on.to),{force:!0}),Vn).then(an=>{isNavigationFailure(an,ErrorTypes.NAVIGATION_ABORTED|ErrorTypes.NAVIGATION_DUPLICATED)&&!Dn.delta&&Dn.type===NavigationType.pop&&x.go(-1,!1)}).catch(noop),Promise.reject()):(Dn.delta&&x.go(-Dn.delta,!1),hn(on,Vn,nn))).then(on=>{on=on||Sn(Vn,nn,!1),on&&(Dn.delta&&!isNavigationFailure(on,ErrorTypes.NAVIGATION_CANCELLED)?x.go(-Dn.delta,!1):Dn.type===NavigationType.pop&&isNavigationFailure(on,ErrorTypes.NAVIGATION_ABORTED|ErrorTypes.NAVIGATION_DUPLICATED)&&x.go(-1,!1)),An(Vn,nn,on)}).catch(noop)}))}let Un=useCallbacks(),Wn=useCallbacks(),Pn;function hn(yn,Nn,Dn){Xn(yn);const Vn=Wn.list();return Vn.length?Vn.forEach(Yn=>Yn(yn,Nn,Dn)):console.error(yn),Promise.reject(yn)}function Gn(){return Pn&&E.value!==START_LOCATION_NORMALIZED?Promise.resolve():new Promise((yn,Nn)=>{Un.add([yn,Nn])})}function Xn(yn){return Pn||(Pn=!yn,Fn(),Un.list().forEach(([Nn,Dn])=>yn?Dn(yn):Nn()),Un.reset()),yn}function qn(yn,Nn,Dn,Vn){const{scrollBehavior:Yn}=e;if(!isBrowser||!Yn)return Promise.resolve();const nn=!Dn&&getSavedScrollPosition(getScrollKey(yn.fullPath,0))||(Vn||!Dn)&&history.state&&history.state.scroll||null;return nextTick$1().then(()=>Yn(yn,Nn,nn)).then(on=>on&&scrollToPosition(on)).catch(on=>hn(on,yn,Nn))}const Jn=yn=>x.go(yn);let ne;const te=new Set,Qn={currentRoute:E,listening:!0,addRoute:Y,removeRoute:X,clearRoutes:a.clearRoutes,hasRoute:pn,getRoutes:tn,resolve:un,options:e,push:gn,replace:dn,go:Jn,back:()=>Jn(-1),forward:()=>Jn(1),beforeEach:w.add,beforeResolve:C.add,afterEach:P.add,onError:Wn.add,isReady:Gn,install(yn){yn.component("RouterLink",RouterLink),yn.component("RouterView",RouterView),yn.config.globalProperties.$router=Qn,Object.defineProperty(yn.config.globalProperties,"$route",{enumerable:!0,get:()=>unref(E)}),isBrowser&&!ne&&E.value===START_LOCATION_NORMALIZED&&(ne=!0,gn(x.location).catch(Vn=>{}));const Nn={};for(const Vn in START_LOCATION_NORMALIZED)Object.defineProperty(Nn,Vn,{get:()=>E.value[Vn],enumerable:!0});yn.provide(routerKey,Qn),yn.provide(routeLocationKey,shallowReactive(Nn)),yn.provide(routerViewLocationKey,E);const Dn=yn.unmount;te.add(yn),yn.unmount=function(){te.delete(yn),te.size<1&&(D=START_LOCATION_NORMALIZED,Bn&&Bn(),Bn=null,E.value=START_LOCATION_NORMALIZED,ne=!1,Pn=!1),Dn()}}};function ee(yn){return yn.reduce((Nn,Dn)=>Nn.then(()=>wn(Dn)),Promise.resolve())}return Qn}function useRouter(){return inject(routerKey)}function useRoute(e){return inject(routeLocationKey)}function t$1(e){typeof queueMicrotask=="function"?queueMicrotask(e):Promise.resolve().then(e).catch(a=>setTimeout(()=>{throw a}))}function o$3(){let e=[],a={addEventListener(f,_,x,w){return f.addEventListener(_,x,w),a.add(()=>f.removeEventListener(_,x,w))},requestAnimationFrame(...f){let _=requestAnimationFrame(...f);a.add(()=>cancelAnimationFrame(_))},nextFrame(...f){a.requestAnimationFrame(()=>{a.requestAnimationFrame(...f)})},setTimeout(...f){let _=setTimeout(...f);a.add(()=>clearTimeout(_))},microTask(...f){let _={current:!0};return t$1(()=>{_.current&&f[0]()}),a.add(()=>{_.current=!1})},style(f,_,x){let w=f.style.getPropertyValue(_);return Object.assign(f.style,{[_]:x}),this.add(()=>{Object.assign(f.style,{[_]:w})})},group(f){let _=o$3();return f(_),this.add(()=>_.dispose())},add(f){return e.push(f),()=>{let _=e.indexOf(f);if(_>=0)for(let x of e.splice(_,1))x()}},dispose(){for(let f of e.splice(0))f()}};return a}var r$1;let n$2=Symbol("headlessui.useid"),o$2=0;const i$2=(r$1=useId)!=null?r$1:function(){return inject(n$2,()=>`${++o$2}`)()};function o$1(e){var a;if(e==null||e.value==null)return null;let f=(a=e.value.$el)!=null?a:e.value;return f instanceof Node?f:null}function u(e,a,...f){if(e in a){let x=a[e];return typeof x=="function"?x(...f):x}let _=new Error(`Tried to handle "${e}" but there is no handler defined. Only defined handlers are: ${Object.keys(a).map(x=>`"${x}"`).join(", ")}.`);throw Error.captureStackTrace&&Error.captureStackTrace(_,u),_}var i$1=Object.defineProperty,d$1=(e,a,f)=>a in e?i$1(e,a,{enumerable:!0,configurable:!0,writable:!0,value:f}):e[a]=f,n$1=(e,a,f)=>(d$1(e,typeof a!="symbol"?a+"":a,f),f);let s$2=class{constructor(){n$1(this,"current",this.detect()),n$1(this,"currentId",0)}set(a){this.current!==a&&(this.currentId=0,this.current=a)}reset(){this.set(this.detect())}nextId(){return++this.currentId}get isServer(){return this.current==="server"}get isClient(){return this.current==="client"}detect(){return typeof window>"u"||typeof document>"u"?"server":"client"}},c=new s$2;function r(e,a){if(e)return e;let f=a??"button";if(typeof f=="string"&&f.toLowerCase()==="button")return"button"}function s$1(e,a){let f=ref(r(e.value.type,e.value.as));return onMounted(()=>{f.value=r(e.value.type,e.value.as)}),watchEffect(()=>{var _;f.value||o$1(a)&&o$1(a)instanceof HTMLButtonElement&&!((_=o$1(a))!=null&&_.hasAttribute("type"))&&(f.value="button")}),f}var N$2=(e=>(e[e.None=0]="None",e[e.RenderStrategy=1]="RenderStrategy",e[e.Static=2]="Static",e))(N$2||{}),S=(e=>(e[e.Unmount=0]="Unmount",e[e.Hidden=1]="Hidden",e))(S||{});function A({visible:e=!0,features:a=0,ourProps:f,theirProps:_,...x}){var w;let C=j(_,f),P=Object.assign(x,{props:C});if(e||a&2&&C.static)return y(P);if(a&1){let E=(w=C.unmount)==null||w?0:1;return u(E,{0(){return null},1(){return y({...x,props:{...C,hidden:!0,style:{display:"none"}}})}})}return y(P)}function y({props:e,attrs:a,slots:f,slot:_,name:x}){var w,C;let{as:P,...E}=T$1(e,["unmount","static"]),D=(w=f.default)==null?void 0:w.call(f,_),B={};if(_){let z=!1,J=[];for(let[Y,X]of Object.entries(_))typeof X=="boolean"&&(z=!0),X===!0&&J.push(Y);z&&(B["data-headlessui-state"]=J.join(" "))}if(P==="template"){if(D=b(D??[]),Object.keys(E).length>0||Object.keys(a).length>0){let[z,...J]=D??[];if(!v(z)||J.length>0)throw new Error(['Passing props on "template"!',"",`The current component <${x} /> is rendering a "template".`,"However we need to passthrough the following props:",Object.keys(E).concat(Object.keys(a)).map(tn=>tn.trim()).filter((tn,pn,un)=>un.indexOf(tn)===pn).sort((tn,pn)=>tn.localeCompare(pn)).map(tn=>`  - ${tn}`).join(`
...
* 將斷點都隱藏。
* 若有錯誤則停止。
![圖片](./images/認識ChromeDevtools開發者工具/認識ChromeDevtools開發者工具-20.png)`,__vite_glob_0_2=Object.freeze(Object.defineProperty({__proto__:null,default:_20210124___ChromeDevtools_____},Symbol.toStringTag,{value:"Module"})),_20210201________=`---
title: 定義變數與函式
date: 2026-02-02
tags: ["JavaScript"]
---
...
![圖片](./images/驗證表單/驗證表單-4.png)`,__vite_glob_0_12=Object.freeze(Object.defineProperty({__proto__:null,default:_20210210_____},Symbol.toStringTag,{value:"Module"})),_20210221Google_Maps_API=`---
...
\`\`\``,__vite_glob_0_15=Object.freeze(Object.defineProperty({__proto__:null,default:_20210224___AJAX__},Symbol.toStringTag,{value:"Module"})),_20210301___JavaScript=`---
title: 認識JavaScript
date: 2021-03-01
tags: ["JavaScript"]
---
...
\`\`\``,__vite_glob_0_16=Object.freeze(Object.defineProperty({__proto__:null,default:_20210301___JavaScript},Symbol.toStringTag,{value:"Module"})),_20210302______=`---
title: 運算與型別
date: 2021-03-02
tags: ["JavaScript"]
---
...
![圖片](./images/VueDevtools安裝/VueDevtools安裝-5.png)`,__vite_glob_0_33=Object.freeze(Object.defineProperty({__proto__:null,default:_20210610VueDevtools__},Symbol.toStringTag,{value:"Module"})),_20220402HTML____=`---
title: HTML標籤大全
date: 2022-04-02
tags: ["HTML"]
---
...
-----------------------------------------------
10. 完成。
![圖片](./images/合成兩張不同的臉/合成兩張不同的臉-10.jpg)`,__vite_glob_0_43=Object.freeze(Object.defineProperty({__proto__:null,default:_20220418_________},Symbol.toStringTag,{value:"Module"})),_20220419__A_____B___=`---
title: 將A物件融入到B背景裡
date: 2022-04-19
tags: ["Photoshop"]
---
...
-----------------------------------------------
7. 完成。
![圖片](./images/將A物件融入到B背景裡/將A物件融入到B背景裡-7.jpg)`,__vite_glob_0_44=Object.freeze(Object.defineProperty({__proto__:null,default:_20220419__A_____B___},Symbol.toStringTag,{value:"Module"})),_20220420________=`---
title: 將透明玻璃去背
date: 2022-04-20
tags: ["Photoshop"]
---
...
-----------------------------------------------
14. 在白色圖層適度還原玻璃的反射效果
![圖片](./images/將透明玻璃去背/將透明玻璃去背-14.png)`,__vite_glob_0_45=Object.freeze(Object.defineProperty({__proto__:null,default:_20220420________},Symbol.toStringTag,{value:"Module"})),_20220421________=`---
title: 把色版調整回來
date: 2022-04-21
tags: ["Photoshop"]
---
...
-----------------------------------------------
4. 取消勾選後，色版恢復原本設定。
![圖片](./images/把色版調整回來/把色版調整回來-4.png)`,__vite_glob_0_46=Object.freeze(Object.defineProperty({__proto__:null,default:_20220421________},Symbol.toStringTag,{value:"Module"})),_20220422________=`---
title: 混合圖層的應用
date: 2022-04-22
tags: ["Photoshop"]
---
...
-----------------------------------------------
21. 分割
![圖片](./images/混合圖層的應用/混合圖層的應用-21.png)`,__vite_glob_0_47=Object.freeze(Object.defineProperty({__proto__:null,default:_20220422________},Symbol.toStringTag,{value:"Module"})),_20220608___Mac_______=`---
title: 解決Mac無法存取隨身碟
date: 2022-06-08
tags: ["Mac"]
---
...
|帆布施工費|5元|
|貼圖施工費|15元|
|17公分紙腳架|20元/個|`,__vite_glob_0_50=Object.freeze(Object.defineProperty({__proto__:null,default:_20230218___________},Symbol.toStringTag,{value:"Module"})),_20230310_________=`---
title: 網站架設基本概念
date: 2023-03-10
tags: ["Web"]
---
...
* SSH 就是讓你透過終端機：
    ...
    3. 部署網站
    4. 重啟服務
    5. 設定防火牆`,__vite_glob_0_51=Object.freeze(Object.defineProperty({__proto__:null,default:_20230310_________},Symbol.toStringTag,{value:"Module"})),_20230401___GitHub____=`---
title: 認識GitHub版本控制
date: 2023-04-01
tags: ["Hugo"]
---
...
![圖片](./images/認識GitHub版本控制/認識GitHub版本控制-10.png)`,__vite_glob_0_52=Object.freeze(Object.defineProperty({__proto__:null,default:_20230401___GitHub____},Symbol.toStringTag,{value:"Module"})),_20230402___Hugo___=`---
title: 建立Hugo部落格
date: 2023-04-02
tags: ["Hugo"]
---
...
5. 將運行成功網址，貼到瀏覽器即可看到網站成功運行`,__vite_glob_0_53=Object.freeze(Object.defineProperty({__proto__:null,default:_20230402___Hugo___},Symbol.toStringTag,{value:"Module"})),_20230403__Hugo___GitHub=`---
...
![圖片](./images/將Hugo上傳到GitHub/將Hugo上傳到GitHub-18.png)`,__vite_glob_0_54=Object.freeze(Object.defineProperty({__proto__:null,default:_20230403__Hugo___GitHub},Symbol.toStringTag,{value:"Module"})),_20230404__Hugo__Disqus____=`---
...
-----------------------------------------------
14. 點開評論即可開始留言
![圖片](./images/將Hugo添加Disqus評論功能/將Hugo添加Disqus評論功能-14.png)`,__vite_glob_0_55=Object.freeze(Object.defineProperty({__proto__:null,default:_20230404__Hugo__Disqus____},Symbol.toStringTag,{value:"Module"})),_20230405___GA4____GA4=`---
title: 從舊GA4升級為新GA4
date: 2023-04-05
tags: ["Web"]
---
...
![圖片](./images/從舊GA4升級為新GA4/從舊GA4升級為新GA4-11.png)`,__vite_glob_0_56=Object.freeze(Object.defineProperty({__proto__:null,default:_20230405___GA4____GA4},Symbol.toStringTag,{value:"Module"})),_20230406__Google___________=`---
...
![圖片](./images/讓Google搜尋引擎找到自己的網站/讓Google搜尋引擎找到自己的網站-11.png)`,__vite_glob_0_57=Object.freeze(Object.defineProperty({__proto__:null,default:_20230406__Google___________},Symbol.toStringTag,{value:"Module"})),_20230407Chrome____=`---
title: Chrome的小技巧
date: 2023-04-07
tags: ["Web"]
---
...
![圖片](./images/Chrome的小技巧/Chrome的小技巧-1.png)`,__vite_glob_0_58=Object.freeze(Object.defineProperty({__proto__:null,default:_20230407Chrome____},Symbol.toStringTag,{value:"Module"})),_20230408___Bluehost___=`---
title: 進入Bluehost的主機
date: 2023-04-08
tags: ["Web"]
---
...
`,__vite_glob_0_59=Object.freeze(Object.defineProperty({__proto__:null,default:_20230408___Bluehost___},Symbol.toStringTag,{value:"Module"})),_20230409__________=`---
title: 了解相機的基本操作
date: 2023-04-09
tags: ["Design"]
---
...
|M純手動模式|手動|手動|手動|所有數值自己掌控|`,__vite_glob_0_60=Object.freeze(Object.defineProperty({__proto__:null,default:_20230409__________},Symbol.toStringTag,{value:"Module"})),_20230422Lightbox2____=`---
title: Lightbox2燈箱效果
date: 2023-04-22
tags: ["JavaScript"]
---
...
\`\`\``,__vite_glob_0_61=Object.freeze(Object.defineProperty({__proto__:null,default:_20230422Lightbox2____},Symbol.toStringTag,{value:"Module"})),_20230423Swiper____=`---
title: Swiper輪播效果
date: 2023-04-23
tags: ["JavaScript"]
---
...
\`\`\``,__vite_glob_0_62=Object.freeze(Object.defineProperty({__proto__:null,default:_20230423Swiper____},Symbol.toStringTag,{value:"Module"})),_20230424UIUX____=`---
title: UIUX核心觀念
date: 2023-04-24
tags: ["Design"]
---
...
* 介面流程圖(UI flow)
  ...
  * 他們的目標是什麼
  * 怎樣到達目標
* 使用者旅程地圖`,__vite_glob_0_63=Object.freeze(Object.defineProperty({__proto__:null,default:_20230424UIUX____},Symbol.toStringTag,{value:"Module"})),_20230425Figma____=`---
title: Figma使用教學
date: 2023-04-25
tags: ["Design"]
---
...
3. 間距(8 point grids)
* input 文字跟輸入框上下12px 左右16px `,__vite_glob_0_64=Object.freeze(Object.defineProperty({__proto__:null,default:_20230425Figma____},Symbol.toStringTag,{value:"Module"})),_20230426Sass_________=`---
title: Sass快速編譯+變數使用
date: 2023-04-26
tags: ["CSS"]
---
...
\`\`\``,__vite_glob_0_65=Object.freeze(Object.defineProperty({__proto__:null,default:_20230426Sass_________},Symbol.toStringTag,{value:"Module"})),_20230810Mac________=`---
title: Mac網頁動態效果消失
date: 2023-08-10
tags: ["Mac"]
---
...
-----------------------------------------------
4. 將“減少動態效果”取消勾選，即完成
![圖片](./images/Mac網頁動態效果消失/Mac網頁動態效果消失-4.png)`,__vite_glob_0_66=Object.freeze(Object.defineProperty({__proto__:null,default:_20230810Mac________},Symbol.toStringTag,{value:"Module"})),_20230811Gulp_____bootstrap____=`---
...
\`\`\``,__vite_glob_0_67=Object.freeze(Object.defineProperty({__proto__:null,default:_20230811Gulp_____bootstrap____},Symbol.toStringTag,{value:"Module"})),_20230812Gulp_scss_____css=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_68=Object.freeze(Object.defineProperty({__proto__:null,default:_20230812Gulp_scss_____css},Symbol.toStringTag,{value:"Module"})),_20230813Gulp_javascript_______=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_69=Object.freeze(Object.defineProperty({__proto__:null,default:_20230813Gulp_javascript_______},Symbol.toStringTag,{value:"Module"})),_20230814Gulp_css______________=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_70=Object.freeze(Object.defineProperty({__proto__:null,default:_20230814Gulp_css______________},Symbol.toStringTag,{value:"Module"})),_20230815Gulp_____map______=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_71=Object.freeze(Object.defineProperty({__proto__:null,default:_20230815Gulp_____map______},Symbol.toStringTag,{value:"Module"})),_20230816Gulp____js_________=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_72=Object.freeze(Object.defineProperty({__proto__:null,default:_20230816Gulp____js_________},Symbol.toStringTag,{value:"Module"})),_20230817Gulp____________=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_73=Object.freeze(Object.defineProperty({__proto__:null,default:_20230817Gulp____________},Symbol.toStringTag,{value:"Module"})),_20230818Gulp____________=`---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_74=Object.freeze(Object.defineProperty({__proto__:null,default:_20230818Gulp____________},Symbol.toStringTag,{value:"Module"})),_20230819Gulp_______=`---
title: Gulp壓縮圖片並優化
date: 2023-08-19
tags: ["Gulp"]
---
...
\`\`\`bash
$ gulp
\`\`\``,__vite_glob_0_75=Object.freeze(Object.defineProperty({__proto__:null,default:_20230819Gulp_______},Symbol.toStringTag,{value:"Module"})),_20230820Gulp____Nunjucks=`---
...
撰寫的內容
{% endblock %}
\`\`\``,__vite_glob_0_76=Object.freeze(Object.defineProperty({__proto__:null,default:_20230820Gulp____Nunjucks},Symbol.toStringTag,{value:"Module"})),_20230821___gulp__final_=`---
title: Gulp完整final版
date: 2023-08-21
tags: ["Gulp"]
---
...
\`\`\``,__vite_glob_0_77=Object.freeze(Object.defineProperty({__proto__:null,default:_20230821___gulp__final_},Symbol.toStringTag,{value:"Module"})),_20240101___________=`---
title: Footer置底方法
date: 2024-01-01
tags: ["CSS"]
---
...
\`\`\``,__vite_glob_0_78=Object.freeze(Object.defineProperty({__proto__:null,default:_20240101___________},Symbol.toStringTag,{value:"Module"})),_20240102VScode_______=`---
title: VScode技巧+實用套件
date: 2024-01-02
tags: ["CSS"]
---
...
### indent-rainbow
* 說明：讓code縮排呈現彩虹`,__vite_glob_0_79=Object.freeze(Object.defineProperty({__proto__:null,default:_20240102VScode_______},Symbol.toStringTag,{value:"Module"})),_20240103Mac______=`---
title: Mac檔案加密方法
date: 2024-01-03
tags: ["Mac"]
---
...
6. 完成後，該資料夾就會出現加密 zip 檔`,__vite_glob_0_80=Object.freeze(Object.defineProperty({__proto__:null,default:_20240103Mac______},Symbol.toStringTag,{value:"Module"})),_20240104Chrome_____=`---
title: Chrome的截圖方法
date: 2024-01-04
tags: ["Web"]
---
...
![圖片](./images/Chrome的截圖方法/Chrome的截圖方法-3.png)`,__vite_glob_0_81=Object.freeze(Object.defineProperty({__proto__:null,default:_20240104Chrome_____},Symbol.toStringTag,{value:"Module"})),_20240105___Devtools__api__=`---
...
![圖片](./images/使用Devtools找出api資料/使用Devtools找出api資料-3.png)`,__vite_glob_0_82=Object.freeze(Object.defineProperty({__proto__:null,default:_20240105___Devtools__api__},Symbol.toStringTag,{value:"Module"})),_20240106___Google__=`---
title: 嵌入Google地圖
date: 2024-01-06
tags: ["HTML"]
---
...
|allowfullscreen|允許全螢幕播放(有添加就有這項功能，移除就無這項功能)|`,__vite_glob_0_83=Object.freeze(Object.defineProperty({__proto__:null,default:_20240106___Google__},Symbol.toStringTag,{value:"Module"})),_20240107___Youtube__=`---
title: 嵌入Youtube影片
date: 2024-01-07
tags: ["HTML"]
---
...
\`\`\``,__vite_glob_0_84=Object.freeze(Object.defineProperty({__proto__:null,default:_20240107___Youtube__},Symbol.toStringTag,{value:"Module"})),_20240108_______=`---
title: 嵌入字體方法
date: 2024-01-08
tags: ["CSS"]
---
...
\`\`\``,__vite_glob_0_85=Object.freeze(Object.defineProperty({__proto__:null,default:_20240108_______},Symbol.toStringTag,{value:"Module"})),_20240109___lozad_js________=`---
...
\`\`\``,__vite_glob_0_86=Object.freeze(Object.defineProperty({__proto__:null,default:_20240109___lozad_js________},Symbol.toStringTag,{value:"Module"})),_20240110Skrollr______=`---
title: Skrollr頁面滾動效果
date: 2024-01-10
tags: ["JavaScript"]
---
...
-----------------------------------------------
5. [更多用法可參考API](https://github.com/Prinzhorn/skrollr?tab=readme-ov-file)`,__vite_glob_0_87=Object.freeze(Object.defineProperty({__proto__:null,default:_20240110Skrollr______},Symbol.toStringTag,{value:"Module"})),_20240120JQuery_________=`---
...
\`\`\``,__vite_glob_0_88=Object.freeze(Object.defineProperty({__proto__:null,default:_20240120JQuery_________},Symbol.toStringTag,{value:"Module"})),_20240121JQuery__________=`---
...
\`\`\``,__vite_glob_0_89=Object.freeze(Object.defineProperty({__proto__:null,default:_20240121JQuery__________},Symbol.toStringTag,{value:"Module"})),_20240122JQuery_________=`---
...
\`\`\`js
$(".box").stop(false,true);
\`\`\``,__vite_glob_0_90=Object.freeze(Object.defineProperty({__proto__:null,default:_20240122JQuery_________},Symbol.toStringTag,{value:"Module"})),_20240123JQuery___________=`---
...
\`\`\``,__vite_glob_0_91=Object.freeze(Object.defineProperty({__proto__:null,default:_20240123JQuery___________},Symbol.toStringTag,{value:"Module"})),_20240124JQuery___________=`---
...
\`\`\``,__vite_glob_0_92=Object.freeze(Object.defineProperty({__proto__:null,default:_20240124JQuery___________},Symbol.toStringTag,{value:"Module"})),_20240125JQuery____________=`---
...
\`\`\`
\`.eq(0)會抓取第一個\``,__vite_glob_0_93=Object.freeze(Object.defineProperty({__proto__:null,default:_20240125JQuery____________},Symbol.toStringTag,{value:"Module"})),_20240126JQuery____________=`---
...
\`\`\``,__vite_glob_0_94=Object.freeze(Object.defineProperty({__proto__:null,default:_20240126JQuery____________},Symbol.toStringTag,{value:"Module"})),_20240201JQuery______=`---
title: jQuery抓取鍵盤事件
date: 2024-02-01
tags: ["jQuery"]
---
...
\`\`\`html
<p>Z</p>
\`\`\``,__vite_glob_0_95=Object.freeze(Object.defineProperty({__proto__:null,default:_20240201JQuery______},Symbol.toStringTag,{value:"Module"})),_20240202JQuery______=`---
title: jQuery抓取滑鼠事件
date: 2024-02-02
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_96=Object.freeze(Object.defineProperty({__proto__:null,default:_20240202JQuery______},Symbol.toStringTag,{value:"Module"})),_20240203JQuery____=`---
title: jQuery處理陣列
date: 2024-02-03
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_97=Object.freeze(Object.defineProperty({__proto__:null,default:_20240203JQuery____},Symbol.toStringTag,{value:"Module"})),_20240204JQuery_______=`---
title: jQuery處理物件與陣列
date: 2024-02-04
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_98=Object.freeze(Object.defineProperty({__proto__:null,default:_20240204JQuery_______},Symbol.toStringTag,{value:"Module"})),_20240205JQuery___=`---
title: jQuery判斷式
date: 2024-02-05
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_99=Object.freeze(Object.defineProperty({__proto__:null,default:_20240205JQuery___},Symbol.toStringTag,{value:"Module"})),_20240206JQuery_______=`---
title: jQuery實作數量選擇器
date: 2024-02-06
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_100=Object.freeze(Object.defineProperty({__proto__:null,default:_20240206JQuery_______},Symbol.toStringTag,{value:"Module"})),_20240207JQuery____________=`---
...
\`\`\``,__vite_glob_0_101=Object.freeze(Object.defineProperty({__proto__:null,default:_20240207JQuery____________},Symbol.toStringTag,{value:"Module"})),_20240208JQuery__________=`---
...
\`\`\``,__vite_glob_0_102=Object.freeze(Object.defineProperty({__proto__:null,default:_20240208JQuery__________},Symbol.toStringTag,{value:"Module"})),_20240209JQuery_JS_CSS______=`---
...
\`\`\``,__vite_glob_0_103=Object.freeze(Object.defineProperty({__proto__:null,default:_20240209JQuery_JS_CSS______},Symbol.toStringTag,{value:"Module"})),_20240301JQuery______=`---
title: jQuery加入聲音效果
date: 2024-03-01
tags: ["jQuery"]
---
...
\`\`\``,__vite_glob_0_104=Object.freeze(Object.defineProperty({__proto__:null,default:_20240301JQuery______},Symbol.toStringTag,{value:"Module"})),_20240430___nvm___node__=`---
...
|移除已安裝版本|nvm uninstall 18.20.4|nvm uni 18.20.4|`,__vite_glob_0_105=Object.freeze(Object.defineProperty({__proto__:null,default:_20240430___nvm___node__},Symbol.toStringTag,{value:"Module"})),_20240501Webpack____________=`---
...
├─── package.json
└─── webpack.config.js   
\`\`\``,__vite_glob_0_106=Object.freeze(Object.defineProperty({__proto__:null,default:_20240501Webpack____________},Symbol.toStringTag,{value:"Module"})),_20240502Webpack__SCSS______Bootstrap=`---
...
\`\`\`bash
$ npm i sass@1.77.6
\`\`\``,__vite_glob_0_107=Object.freeze(Object.defineProperty({__proto__:null,default:_20240502Webpack__SCSS______Bootstrap},Symbol.toStringTag,{value:"Module"})),_20240503Webpack__JS_____jQuery=`---
...
`,__vite_glob_0_108=Object.freeze(Object.defineProperty({__proto__:null,default:_20240503Webpack__JS_____jQuery},Symbol.toStringTag,{value:"Module"})),_20240504Webpack___________=`---
...
\`\`\`
\`此時images裡的檔案會成功的複製，並且經過壓縮處理\``,__vite_glob_0_109=Object.freeze(Object.defineProperty({__proto__:null,default:_20240504Webpack___________},Symbol.toStringTag,{value:"Module"})),_20240505Webpack_______SourceMap__=`---
...
\`\`\``,__vite_glob_0_110=Object.freeze(Object.defineProperty({__proto__:null,default:_20240505Webpack_______SourceMap__},Symbol.toStringTag,{value:"Module"})),_20240701___php__=`---
title: 將PHP專案運行起來
date: 2024-07-01
tags: ["PHP"]
---
...
* webpack.mix.js：webpack 設定文件，因為 Laravel 版本 5.4 後，全部使用 webpack 打包靜態資源`,__vite_glob_0_111=Object.freeze(Object.defineProperty({__proto__:null,default:_20240701___php__},Symbol.toStringTag,{value:"Module"})),_20241201JavaScript__=`---
title: JavaScript縮寫
date: 2024-12-01
tags: ["Vue3"]
---
...
\`\`\``,__vite_glob_0_112=Object.freeze(Object.defineProperty({__proto__:null,default:_20241201JavaScript__},Symbol.toStringTag,{value:"Module"})),_20241202This___=`---
title: this的指向
date: 2024-12-02
tags: ["Vue3"]
---
...
obj.sayApple(); //蘋果
\`\`\``,__vite_glob_0_113=Object.freeze(Object.defineProperty({__proto__:null,default:_20241202This___},Symbol.toStringTag,{value:"Module"})),_20241203________=`---
title: 關注點分離實作
date: 2024-12-03
tags: ["Vue3"]
---
...
component.initData();
\`\`\``,__vite_glob_0_114=Object.freeze(Object.defineProperty({__proto__:null,default:_20241203________},Symbol.toStringTag,{value:"Module"})),_20241204________=`---
title: 物件傳參考特性
date: 2024-12-04
tags: ["Vue3"]
---
...
console.log(fruits2.name); //香蕉
\`\`\`
\`當物件賦予到另一個物件時，就等於指向同一個物件\``,__vite_glob_0_115=Object.freeze(Object.defineProperty({__proto__:null,default:_20241204________},Symbol.toStringTag,{value:"Module"})),_20241205Promise_____=`---
title: promise非同步觀念
date: 2024-12-05
tags: ["Vue3"]
---
...
component.init();
\`\`\`
\`使用元件的初始化事件，將api資料載入到data\``,__vite_glob_0_116=Object.freeze(Object.defineProperty({__proto__:null,default:_20241205Promise_____},Symbol.toStringTag,{value:"Module"})),_20241206___axios__api=`---
title: 使用axios串接api
date: 2024-12-06
tags: ["Vue3"]
---
...
`,__vite_glob_0_117=Object.freeze(Object.defineProperty({__proto__:null,default:_20241206___axios__api},Symbol.toStringTag,{value:"Module"})),_20241207___ES__=`---
title: 運行ES模組
date: 2024-12-07
tags: ["Vue3"]
---
...
<\/script>
\`\`\``,__vite_glob_0_118=Object.freeze(Object.defineProperty({__proto__:null,default:_20241207___ES__},Symbol.toStringTag,{value:"Module"})),_20241208_____Vue3=`---
title: 開始使用Vue3
date: 2024-12-08
tags: ["Vue3"]
---
...
Vue.createApp(app).mount("#app");
\`\`\``,__vite_glob_0_119=Object.freeze(Object.defineProperty({__proto__:null,default:_20241208_____Vue3},Symbol.toStringTag,{value:"Module"})),_20241209__________=`---
title: 實作新增或編輯資料
date: 2024-12-09
tags: ["Vue3"]
---
...
\`\`\`
\`:key="唯一值"\`
`,__vite_glob_0_120=Object.freeze(Object.defineProperty({__proto__:null,default:_20241209__________},Symbol.toStringTag,{value:"Module"})),_20241210VText____=`---
...
\`\`\``,__vite_glob_0_121=Object.freeze(Object.defineProperty({__proto__:null,default:_20241210VText____},Symbol.toStringTag,{value:"Module"})),_20241211VFor______=`---
...
\`\`\`
\`<template>可用來包覆需要重複的標籤\``,__vite_glob_0_122=Object.freeze(Object.defineProperty({__proto__:null,default:_20241211VFor______},Symbol.toStringTag,{value:"Module"})),_20241212VIf_____=`---
title: Vue3v-if選擇性顯示
date: 2024-12-12
tags: ["Vue3"]
---
...
\`\`\`
\`v-for和v-if官方不建議使用在同一個標籤上，因此可以使用template來拆開\``,__vite_glob_0_123=Object.freeze(Object.defineProperty({__proto__:null,default:_20241212VIf_____},Symbol.toStringTag,{value:"Module"})),_20241213VBind____=`---
...
\`\`\``,__vite_glob_0_124=Object.freeze(Object.defineProperty({__proto__:null,default:_20241213VBind____},Symbol.toStringTag,{value:"Module"})),_20241214Html____=`---
title: html樣式綁定
date: 2024-12-14
tags: ["Vue3"]
---
...
\`\`\``,__vite_glob_0_125=Object.freeze(Object.defineProperty({__proto__:null,default:_20241214Html____},Symbol.toStringTag,{value:"Module"})),_20241215VModel____=`---
title: v-model雙向綁定
date: 2024-12-15
tags: ["Vue3"]
---
...
\`\`\``,__vite_glob_0_126=Object.freeze(Object.defineProperty({__proto__:null,default:_20241215VModel____},Symbol.toStringTag,{value:"Module"})),_20241216VModel___=`---
title: v-model修飾符
date: 2024-12-16
tags: ["Vue3"]
---
...
\`\`\`
\`適合使用在text或email格式\``,__vite_glob_0_127=Object.freeze(Object.defineProperty({__proto__:null,default:_20241216VModel___},Symbol.toStringTag,{value:"Module"})),_20241217VOn_____=`---
title: v-on使用者事件
date: 2024-12-17
tags: ["Vue3"]
---
...
\`\`\`
\`當按下按鈕時不放，出現"按下";鬆開滑鼠左鍵後，出現"放開"\``,__vite_glob_0_128=Object.freeze(Object.defineProperty({__proto__:null,default:_20241217VOn_____},Symbol.toStringTag,{value:"Module"})),_20241218VOn___=`---
title: v-on修飾符
date: 2024-12-18
tags: ["Vue3"]
---
...
\`\`\``,__vite_glob_0_129=Object.freeze(Object.defineProperty({__proto__:null,default:_20241218VOn___},Symbol.toStringTag,{value:"Module"})),_20241220__________=`---
title: 點擊商品加入購物車
date: 2024-12-20
tags: ["Vue3"]
---
...
\`\`\``,__vite_glob_0_130=Object.freeze(Object.defineProperty({__proto__:null,default:_20241220__________},Symbol.toStringTag,{value:"Module"})),_20241221__computed______=`---
...
\`\`\``,__vite_glob_0_131=Object.freeze(Object.defineProperty({__proto__:null,default:_20241221__computed______},Symbol.toStringTag,{value:"Module"})),_20241222__computed______=`---
...
\`\`\`
\`get會自動接收傳入的值進行計算，set會將值更新到data\``,__vite_glob_0_132=Object.freeze(Object.defineProperty({__proto__:null,default:_20241222__computed______},Symbol.toStringTag,{value:"Module"})),_20241223__watch__data__=`---
...
\`\`\`
\`handler(n,o){},deep: true是固定寫法\``,__vite_glob_0_133=Object.freeze(Object.defineProperty({__proto__:null,default:_20241223__watch__data__},Symbol.toStringTag,{value:"Module"})),_20241224Component__=`---
title: Component元件
date: 2024-12-24
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_134=Object.freeze(Object.defineProperty({__proto__:null,default:_20241224Component__},Symbol.toStringTag,{value:"Module"})),_20241225Template__=`---
title: Template模板
date: 2024-12-25
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_135=Object.freeze(Object.defineProperty({__proto__:null,default:_20241225Template__},Symbol.toStringTag,{value:"Module"})),_20241226Props______=`---
title: props資料由外傳內
date: 2024-12-26
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\`
\`props沒有傳值時，propsD會自動顯示預設值：300\``,__vite_glob_0_136=Object.freeze(Object.defineProperty({__proto__:null,default:_20241226Props______},Symbol.toStringTag,{value:"Module"})),_20241227Emit______=`---
title: emit資料由內傳外
date: 2024-12-27
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_137=Object.freeze(Object.defineProperty({__proto__:null,default:_20241227Emit______},Symbol.toStringTag,{value:"Module"})),_20241228___alert____=`---
title: 實作Alert彈跳視窗
date: 2024-12-28
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_138=Object.freeze(Object.defineProperty({__proto__:null,default:_20241228___alert____},Symbol.toStringTag,{value:"Module"})),_20241229Slot____=`---
title: slot元件插槽
date: 2024-12-29
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_139=Object.freeze(Object.defineProperty({__proto__:null,default:_20241229Slot____},Symbol.toStringTag,{value:"Module"})),_20241230Mitt______=`---
title: mitt跨元件傳資料
date: 2024-12-30
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_140=Object.freeze(Object.defineProperty({__proto__:null,default:_20241230Mitt______},Symbol.toStringTag,{value:"Module"})),_20250101Ref__DOM___copy=`---
title: ref操作DOM元素
date: 2025-01-01
tags: ["Vue3"]
---
...
app.mount("#app");
\`\`\``,__vite_glob_0_141=Object.freeze(Object.defineProperty({__proto__:null,default:_20250101Ref__DOM___copy},Symbol.toStringTag,{value:"Module"})),_20260117___vite_vue3_tailwind4_1__=`---
...
\`\`\`bash
$ npm run preview
\`\`\``,__vite_glob_0_142=Object.freeze(Object.defineProperty({__proto__:null,default:_20260117___vite_vue3_tailwind4_1__},Symbol.toStringTag,{value:"Module"})),_20260118___setup_defineProps__=`---
...
<\/script>
\`\`\``,__vite_glob_0_143=Object.freeze(Object.defineProperty({__proto__:null,default:_20260118___setup_defineProps__},Symbol.toStringTag,{value:"Module"})),_20260119Vue3_______github_pages='---\ntitle: 將網站部署到GitHub Pages\ndate: 2026-01-19\ntags: ["Vue3"]\n---\n## 在Github建立新的Repository\n1. 建立`repository`時，網址為`帳號`/`專案名稱`\n2. 若已經在`VSCode`，建立了`git`檔，可以選擇推送儲存庫\n### 推送儲存庫指令：\n```\ngit remote add origin https://github.com/帳號/vuetest.git\ngit branch -M main\ngit push -u origin main\n```\n3. 在專案中的終端機輸入以上指令，並且授權github允許存取vscode\n4. 回到github重整頁面，可以看到資料已上傳\n\n-----------------------------------------------\n## 將dist部署到GitHub Pages上\n1. 安裝`gh-pages`套件\n```\n$ npm i gh-pages\n```\n2. 新增`部署`指令，到`package.json`\n```js\n"scripts": {\n  "dev": "vite",\n  "build": "vite build",\n  "preview": "vite preview",\n  "deploy": "vite build && gh-pages -d dist"\n},\n```\n`gh-pages -d dist`指令表示將dist部署\n\n3. 此時若直接部署到`github`上，會因為網址不對而無法正常顯示，所以我們必須要再設定基本路徑：\n新增`base`讓名稱跟`帳號`/`vuetest`相同\n```js\n//vite.config.js\n\nexport default defineConfig({\n    base: \'/vuetest/\',\n});\n```',__vite_glob_0_144=Object.freeze(Object.defineProperty({__proto__:null,default:_20260119Vue3_______github_pages},Symbol.toStringTag,{value:"Module"})),_20260119__VSCode____________GitHub_Pages_='---\ntitle: 在VSCode輸入指令直接將網站部署到GitHub Pages上\ndate: 2026-01-19\ntags: ["Vue3"]\n---\n## 在Github建立新的Repository\n1. 建立`repository`時，網址為`帳號`/`專案名稱`\n2. 若已在`vscode`已經，建立了`git`檔，可以選擇推送儲存庫\n\n### 推送儲存庫指令：\n```markdown\ngit remote add origin https://github.com/帳號/vuetest.git\ngit branch -M main\ngit push -u origin main\n```\n3. 在專案中的終端機輸入以上指令，並且授權github允許存取vscode\n4. 回到github重整頁面，可以看到資料已上傳\n\n-----------------------------------------------\n## 將dist部署到GitHub Pages上\n\n1. 安裝`gh-pages`套件\n```bash\n$ npm i gh-pages\n```\n\n2. 新增`部署`指令，到`package.json`\n```js\n"scripts": {\n  "dev": "vite",\n  "build": "vite build",\n  "preview": "vite preview",\n  "deploy": "vite build && gh-pages -d dist"\n},\n```\n`gh-pages -d dist`指令表示將dist部署\n\n3. 此時若直接部署到`github`上，會因為網址不對而無法正常顯示，所以我們必須要再設定基本路徑：\n新增`base`讓名稱跟`帳號`/`vuetest`相同\n```js\n//vite.config.js\n\nexport default defineConfig({\n    base: \'/vuetest/\',\n});\n```',__vite_glob_0_145=Object.freeze(Object.defineProperty({__proto__:null,default:_20260119__VSCode____________GitHub_Pages_},Symbol.toStringTag,{value:"Module"})),_20260122Input_______=`---
title: input表單常用修飾符
date: 2026-01-22
tags: ["Vue3"]
---
...
const messageText = ref("");
<\/script>
\`\`\``,__vite_glob_0_146=Object.freeze(Object.defineProperty({__proto__:null,default:_20260122Input_______},Symbol.toStringTag,{value:"Module"})),_20260123Object____=`---
title: Object處理方法
date: 2026-01-23
tags: ["JavaScript"]
---
...
\`\`\``,__vite_glob_0_147=Object.freeze(Object.defineProperty({__proto__:null,default:_20260123Object____},Symbol.toStringTag,{value:"Module"})),_20260201____Route_Router______=`---
...
/>
\`\`\``,__vite_glob_0_148=Object.freeze(Object.defineProperty({__proto__:null,default:_20260201____Route_Router______},Symbol.toStringTag,{value:"Module"})),_20260202___Vue3______=`---
title: 製作Vue3音樂播放按鈕
date: 2026-02-02
tags: ["Vue"]
---
...
|播放速度|playbackRate=1.5;|1.5倍速|`,__vite_glob_0_149=Object.freeze(Object.defineProperty({__proto__:null,default:_20260202___Vue3______},Symbol.toStringTag,{value:"Module"})),_20260203Vue3_Swiper_______=`---
...
<\/script>
\`\`\``,__vite_glob_0_150=Object.freeze(Object.defineProperty({__proto__:null,default:_20260203Vue3_Swiper_______},Symbol.toStringTag,{value:"Module"})),_20260204JSON_Server____API=`---
...
\`\`\`bash
http://localhost:3000/todo2_16?Status=true
\`\`\``,__vite_glob_0_151=Object.freeze(Object.defineProperty({__proto__:null,default:_20260204JSON_Server____API},Symbol.toStringTag,{value:"Module"})),_20260205Vue3_Font_Awesome_7____=`---
